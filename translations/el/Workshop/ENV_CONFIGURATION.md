...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T23:03:32+00:00",
...
| `FOUNDRY_LOCAL_ENDPOINT` | (κενό) | Επικάλυψη του endpoint υπηρεσίας |
...
### Θερμοκρασία & Δειγματοληψία (Επικάλυψη στον Κώδικα)
...
### 4. Χρησιμοποιήστε Ρύθμιση Ειδική για το Περιβάλλον
