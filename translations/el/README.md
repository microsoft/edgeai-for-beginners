...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:56:59+00:00",
...
[![Συμμετέχοντες GitHub](https://img.shields.io/github/contributors/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/graphs/contributors)
...
[![Αιτήματα GitHub](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
1. **Κάντε Fork το Αποθετήριο**: Πατήστε [![Forks GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
Καλώς ήρθατε στο **EdgeAI για Αρχάριους** – το ολοκληρωμένο σας ταξίδι στον μεταμορφωτικό κόσμο της Τεχνητής Νοημοσύνης στο Edge. Αυτό το μάθημα γεφυρώνει το χάσμα μεταξύ ισχυρών δυνατοτήτων AI και πρακτικής, πραγματικής εφαρμογής σε συσκευές edge, δίνοντάς σας τη δυνατότητα να αξιοποιήσετε το δυναμικό της AI απευθείας εκεί όπου δημιουργούνται δεδομένα και πρέπει να ληφθούν αποφάσεις.
...
- **Εκτίμηση σε πραγματικό χρόνο** με δυνατότητες προστασίας της ιδιωτικότητας
...
Το Edge AI αναφέρεται στην εκτέλεση αλγορίθμων AI και μοντέλων γλώσσας τοπικά σε υλικό, κοντά στο σημείο όπου δημιουργούνται δεδομένα, χωρίς να βασίζεται σε πόρους cloud για εκτίμηση. Μειώνει την καθυστέρηση, ενισχύει την ιδιωτικότητα και επιτρέπει τη λήψη αποφάσεων σε πραγματικό χρόνο.

### Βασικές Αρχές:
- **Εκτίμηση στη συσκευή**: Τα μοντέλα AI εκτελούνται σε συσκευές edge (τηλέφωνα, δρομολογητές, μικροελεγκτές, βιομηχανικούς υπολογιστές)
...
- **Χαμηλότερη ζήτηση υπολογισμού**: Βελτιστοποιημένα για απόδοση CPU και edge GPU
...
| [📚 01](../../Module01) | [Βασικά του EdgeAI](./Module01/README.md) | Σύγκριση Cloud vs Edge AI | Βασικά του EdgeAI • Μελέτες Πραγματικών Περιπτώσεων • Οδηγός Υλοποίησης • Ανάπτυξη στο Edge | Αρχάριος | 3-4 ώρες |
...
| [🚀 03](../../Module03) | [Πρακτική Ανάπτυξη SLM](./Module03/README.md) | Τοπική & cloud ανάπτυξη | Προχωρημένη Μάθηση • Τοπικό Περιβάλλον • Ανάπτυξη στο Cloud | Ενδιάμεσο | 4-5 ώρες |
| [⚙️ 04](../../Module04) | [Εργαλειοθήκη Βελτιστοποίησης Μοντέλων](./Module04/README.md) | Βελτιστοποίηση σε διάφορες πλατφόρμες | Εισαγωγή • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Σύνθεση Ροής Εργασίας | Ενδιάμεσο | 5-6 ώρες |
...
| [🤖 06](../../Module06) | [Πράκτορες AI & Κλήση Λειτουργιών](./Module06/README.md) | Πλαίσια πρακτόρων & MCP | Εισαγωγή Πρακτόρων • Κλήση Λειτουργιών • Πρωτόκολλο Πλαισίου Μοντέλου | Προχωρημένο | 4-5 ώρες |
| [💻 07](../../Module07) | [Υλοποίηση Πλατφόρμας](./Module07/README.md) | Δείγματα δια-πλατφόρμας | Εργαλειοθήκη AI • Foundry Local • Ανάπτυξη Windows | Προχωρημένο | 3-4 ώρες |
| [🏭 08](../../Module08) | [Εργαλειοθήκη Foundry Local](./Module08/README.md) | Δείγματα έτοιμα για παραγωγή | Δείγματα εφαρμογών (δείτε λεπτομέρειες παρακάτω) | Ειδικός | 8-10 ώρες |
...
- [05: Ορχήστραση Πολλαπλών Πρακτόρων](./Module08/samples/05/README.md)
...
- **Οδηγοί Συνεδριών** - Λεπτομερείς οδηγοί σε μορφή markdown για κάθε συνεδρία εργαστηρίου
...
- Συστήματα ορχήστρωσης πολλ
- **Ανάπτυξη σε Πολλαπλές Πλατφόρμες**: Windows, κινητά, ενσωματωμένα συστήματα και υβριδικά συστήματα cloud-edge  
...
0. **📖 Εισαγωγή** ([Introduction.md](./introduction.md)): Βασικές αρχές EdgeAI + πλαίσιο βιομηχανίας + πλαίσιο μάθησης  
1. **📚 Βάσεις** (Ενότητες 01-02): Έννοιες EdgeAI + οικογένειες μοντέλων SLM  
...
**Το EdgeAI αντιπροσωπεύει το μέλλον της ανάπτυξης AI**: τοπικό, με σεβασμό στην ιδιωτικότητα και αποδοτικό. Μάθετε αυτές τις δεξιότητες για να δημιουργήσετε την επόμενη γενιά έξυπνων εφαρμογών.  
