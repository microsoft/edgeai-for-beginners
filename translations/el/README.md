...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T12:26:14+00:00",
...
Καλώς ήρθατε στο **EdgeAI για Αρχάριους** – το ολοκληρωμένο σας ταξίδι στον μετασχηματιστικό κόσμο της Τεχνητής Νοημοσύνης στην Άκρη (Edge). Αυτό το μάθημα γεφυρώνει το χάσμα μεταξύ ισχυρών δυνατοτήτων AI και πρακτικής, πραγματικής ανάπτυξης σε συσκευές άκρης, δίνοντάς σας τη δύναμη να αξιοποιήσετε το δυναμικό της AI απευθείας εκεί όπου παράγονται τα δεδομένα και πρέπει να λαμβάνονται αποφάσεις.
...
- **Πραγματικού χρόνου συμπεράσματα** με δυνατότητες διατήρησης απορρήτου
...
- **Επιδόσεις σε Πραγματικό Χρόνο**: Εξάλειψη καθυστερήσεων δικτύου για εφαρμογές κρίσιμες στον χρόνο
...
Η Edge AI αναφέρεται στην εκτέλεση αλγορίθμων AI και γλωσσικών μοντέλων τοπικά στο υλικό, κοντά στο σημείο παραγωγής των δεδομένων, χωρίς να βασίζεται σε πόρους cloud για συμπεράσματα. Μειώνει την καθυστέρηση, ενισχύει το απόρρητο και επιτρέπει τη λήψη αποφάσεων σε πραγματικό χρόνο.

### Βασικές Αρχές:
- **Συμπεράσματα στη συσκευή**: Τα μοντέλα AI εκτελούνται σε συσκευές άκρης (τηλέφωνα, δρομολογητές, μικροελεγκτές, βιομηχανικοί υπολογιστές)
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [Εισαγωγή στο EdgeAI](./introduction.md) | Βάση & Πλαίσιο | Επισκόπηση EdgeAI • Εφαρμογές στη Βιομηχανία • Εισαγωγή SLM • Στόχοι Μάθησης | Αρχάριος | 1-2 ώρες |
...
| [⚙️ 04](../../Module04) | [Εργαλειοθήκη Βελτιστοποίησης Μοντέλων](./Module04/README.md) | Βελτιστοποίηση πολλαπλών πλατφορμών | Εισαγωγή • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Σύνθεση Ροής Εργασίας | Ενδιάμεσο | 5-6 ώρες |
...
- **Jupyter Notebooks** (8 διαδραστικά) - Βήμα-βήμα μαθήματα με benchmarks και παρακολούθηση απόδοσης
...
### 🎯 Βασικές Δεξιότητες
- **Αρχιτεκτονική Edge AI**: Σχεδιάστε συστήματα AI με προτεραιότητα στην τοπική εκτέλεση και ενσωμάτωση cloud
...
- **Εργαλεία Διασταυρούμενης Πλατφόρμας**: Πρότυπα ενσωμάτωσης LangChain/Semantic Kernel  
...
2. **⚙️ Βελτιστοποίηση** (Ενότητες 03-04): Πλαίσια ανάπτυξης + ποσοτικοποίησης  
3. **🚀 Παραγωγή** (Ενότητες 05-06): SLMOps + πράκτορες AI + κλήσεις λειτουργιών  
4. **💻 Υλοποίηση** (Ενότητες 07-08): Παραδείγματα πλατφόρμας + εργαλεία Foundry Local  
...
**Έργα Portfolio**: Συστήματα πολλαπλών πρακτόρων • Παραγωγικές εφαρμογές RAG • Πολυπλατφορμική ανάπτυξη • Βελτιστοποίηση απόδοσης  
...
📖 **[Διαθέσιμος Οδηγός Μελέτης](STUDY_GUIDE.md)**: Δομημένη διαδρομή μάθησης 20 ωρών με καθοδήγηση χρόνου και εργαλεία αυτοαξιολόγησης.  
