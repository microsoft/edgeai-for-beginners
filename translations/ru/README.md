...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:42:50+00:00",
...
- **Надежность**: работа даже при сбоях сети
...
### Основные принципы:
- **Инференс на устройстве**: модели ИИ работают на устройствах (телефонах, роутерах, микроконтроллерах, промышленных ПК)
...
- **Суверенитет данных**: локальное хранение данных для повышения безопасности и соответствия требованиям
...
- **Снижения вычислительных требований**: оптимизация для работы на CPU и GPU устройств
...
- **Серверов на границе**: локальных вычислительных узлов с ограниченными ресурсами GPU
...
| [🏭 08](../../Module08) | [Инструментарий Foundry Local](./Module08/README.md) | Примеры, готовые к производству | Примеры приложений (см. детали ниже) | Эксперт | 8-10 часов |
...
- **Операции в производстве**: Мониторинг, масштабирование и поддержка периферийного ИИ в производственных условиях  
...
- **RAG-приложения**: Локальная обработка документов с использованием векторного поиска  
- **Маршрутизаторы моделей**: Интеллектуальный выбор между моделями на основе анализа задач  
- **API-фреймворки**: Клиенты, готовые к производству, с потоковой передачей данных и мониторингом состояния  
...
**Рекомендуемый учебный план** (всего 20-30 часов):  
...
**Технические роли**: Архитектор решений EdgeAI • ML-инженер (Edge) • Разработчик IoT AI • Разработчик мобильного ИИ  
...
**Проектное портфолио**: Мультиагентные системы • Производственные RAG-приложения • Кроссплатформенное развертывание • Оптимизация производительности  
...
✅ **Многоплатформенность**: Windows, мобильные устройства, встроенные системы, гибрид облако-периферия  
✅ **Готовность к производству**: Мониторинг, масштабирование, безопасность, соответствие требованиям  

📖 **[Доступно руководство по обучению](STUDY_GUIDE.md)**: Структурированный учебный план на 20 часов с рекомендациями по распределению времени и инструментами для самооценки.  

---

**EdgeAI представляет будущее развертывания ИИ**: локально-ориентированное, сохраняющее конфиденциальность и эффективное. Освойте эти навыки, чтобы создавать приложения следующего поколения.  
