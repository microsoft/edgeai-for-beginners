...
3. [**Присоединяйтесь к Azure AI Foundry Discord и общайтесь с экспертами и разработчиками**](https://discord.com/invite/ByRwuEEgH4)
...
- **Инструменты проверки** - Скрипты для проверки качества кода и запуска тестов
...
- **Оптимизация моделей**: Квантизация и сжатие моделей для развертывания на устройствах (ускорение на 85%, уменьшение размера на 75%)
- **Развертывание на разных платформах**: Windows, мобильные устройства, встроенные системы и гибридные облачно-краевые системы
- **Производственные операции**: Мониторинг, масштабирование и поддержка Edge AI в производственной среде
...
**Проекты для портфолио**: Мультиагентные системы • RAG-приложения для производства • Кроссплатформенное развертывание • Оптимизация производительности
...
✅ **Мультиплатформенность**: Windows, мобильные устройства, встроенные системы, гибриды облако-край  
...
**EdgeAI представляет будущее развертывания AI**: локально-ориентированное, сохраняющее конфиденциальность и эффективное. Освойте эти навыки, чтобы создавать приложения следующего поколения.
