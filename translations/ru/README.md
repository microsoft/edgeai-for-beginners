...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T14:29:15+00:00",
...
- **Оптимизацию с учетом аппаратного обеспечения** на различных платформах
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [Введение в EdgeAI](./introduction.md) | Основы и контекст | Обзор EdgeAI • Применение в индустрии • Введение в SLM • Цели обучения | Начинающий | 1-2 ч |
...
| [🔧 05](../../Module05) | [Производство SLMOps](./Module05/README.md) | Производственные операции | Введение в SLMOps • Дистилляция моделей • Тонкая настройка • Производственное развертывание | Продвинутый | 5-6 ч |
...
| [💻 07](../../Module07) | [Реализация платформы](./Module07/README.md) | Кроссплатформенные примеры | AI Toolkit • Foundry Local • Разработка под Windows | Продвинутый | 3-4 ч |
| [🏭 08](../../Module08) | [Foundry Local Toolkit](./Module08/README.md) | Примеры, готовые к производству | Примерные приложения (см. детали ниже) | Эксперт | 8-10 ч |
...
- **Руководства по сессиям** - Подробные markdown-гайды для каждой сессии мастерской
...
- **Архитектура Edge AI**: Проектирование локально-ориентированных AI систем с интеграцией в облако
- **Оптимизация моделей**: Квантование и сжатие моделей для развертывания на периферии (ускорение на 85%, уменьшение размера на 75%)
...
- **Кроссплатформенные инструменты**: Паттерны интеграции LangChain/Semantic Kernel
...
**Технические роли**: Архитектор решений EdgeAI • ML-инженер (Edge) • Разработчик AI для IoT • Разработчик мобильного AI

**Отраслевые сектора**: Производство 4.0 • Технологии здравоохранения • Автономные системы • FinTech • Потребительская электроника

**Проекты для портфолио**: Мультиагентные системы • Производственные RAG-приложения • Кроссплатформенное развертывание • Оптимизация производительности
...
✅ **Мультиплатформенность**: Windows, мобильные, встроенные, гибридные облачно-периферийные системы  
