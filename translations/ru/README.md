...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T11:22:05+00:00",
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [Введение в EdgeAI](./introduction.md) | Основы и контекст | Обзор EdgeAI • Промышленные применения • Введение в SLM • Цели обучения | Начинающий | 1-2 часа |
| [📚 01](../../Module01) | [Основы EdgeAI](./Module01/README.md) | Сравнение облака и Edge AI | Основы EdgeAI • Кейсы из реального мира • Руководство по реализации • Периферийное развертывание | Начинающий | 3-4 часа |
...
| [🔧 05](../../Module05) | [Производство SLMOps](./Module05/README.md) | Производственные операции | Введение в SLMOps • Дистилляция моделей • Тонкая настройка • Производственное развертывание | Продвинутый | 5-6 часов |
...
| [💻 07](../../Module07) | [Реализация платформы](./Module07/README.md) | Кроссплатформенные примеры | Набор инструментов AI • Foundry Local • Разработка для Windows | Продвинутый | 3-4 часа |
| [🏭 08](../../Module08) | [Набор инструментов Foundry Local](./Module08/README.md) | Готовые к производству примеры | Примерные приложения (см. детали ниже) | Эксперт | 8-10 часов |
...
**Отраслевые сектора**: Производство 4.0 • Технологии здравоохранения • Автономные системы • Финтех • Потребительская электроника
...
✅ **Мультиплатформенность**: Windows, мобильные, встроенные, гибридные облачно-периферийные решения  
