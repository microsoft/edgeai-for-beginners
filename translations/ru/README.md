...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T08:19:00+00:00",
...
Этот курс проведет вас от основных концепций до готовых к производству реализаций, охватывая:
...
- **Производительность в реальном времени**: Устранение задержек сети для приложений с критичными временными требованиями
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [Введение в EdgeAI](./introduction.md) | Основы и контекст | Обзор EdgeAI • Применение в индустрии • Введение в SLM • Цели обучения | Начинающий | 1-2 часа |
| [📚 01](../../Module01) | [Основы EdgeAI](./Module01/README.md) | Сравнение облака и Edge AI | Основы EdgeAI • Кейсы из реального мира • Руководство по реализации • Развертывание на периферии | Начинающий | 3-4 часа |
| [🧠 02](../../Module02) | [Основы моделей SLM](./Module02/README.md) | Семейства моделей и архитектура | Семейство Phi • Семейство Qwen • Семейство Gemma • BitNET • μModel • Phi-Silica | Начинающий | 4-5 часов |
...
| [⚙️ 04](../../Module04) | [Инструментарий оптимизации моделей](./Module04/README.md) | Кроссплатформенная оптимизация | Введение • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Синтез рабочих процессов | Средний | 5-6 часов |
| [🔧 05](../../Module05) | [Производственные операции SLMOps](./Module05/README.md) | Производственные операции | Введение в SLMOps • Дистилляция моделей • Тонкая настройка • Производственное развертывание | Продвинутый | 5-6 часов |
...
| [💻 07](../../Module07) | [Реализация платформы](./Module07/README.md) | Кроссплатформенные примеры | AI Toolkit • Foundry Local • Разработка под Windows | Продвинутый | 3-4 часа |
...
- **Архитектура Edge AI**: Проектирование локально-ориентированных AI систем с интеграцией облака
