...
स्थानिक आणि क्लाउड इनफरन्स परिस्थितीसाठी मोठ्या भाषा मॉडेल्स (LLMs) आणि लहान भाषा मॉडेल्स (SLMs) यांची तुलना करा. ONNX Runtime प्रवेग, WebGPU कार्यान्वयन, आणि हायब्रिड RAG अनुभवांचा उपयोग करून डिप्लॉयमेंट पॅटर्न शिकून घ्या. स्थानिक मॉडेलसह Chainlit RAG डेमो समाविष्ट आहे, तसेच OpenWebUI अन्वेषणाचा पर्याय देखील आहे. तुम्ही WebGPU इनफरन्स स्टार्टर अडॅप्ट कराल आणि Phi वि GPT-OSS-20B क्षमता आणि खर्च/प्रदर्शन व्यापार-offs चे मूल्यांकन कराल.

## शिकण्याची उद्दिष्टे

- **तुलना करा** SLM वि LLM विलंब, मेमरी, गुणवत्ता अक्षांवर
...
- **मूल्यांकन करा** हलकी गुणवत्ता + खर्च मोजण्याच्या पद्धतींचा वापर करून

## पूर्वतयारी

- सत्र १–३ पूर्ण केलेले असणे आवश्यक
- `chainlit` स्थापित केलेले (Module08 साठी `requirements.txt` मध्ये आधीच समाविष्ट)
- WebGPU-सक्षम ब्राउझर (Windows 11 वर Edge / Chrome नवीनतम)
- Foundry Local चालू (`foundry service status`)
...
GPU सक्षम केल्यानंतर व CPU-फक्त मोडमध्ये throughput बदल पहा.
...
डिलिव्हरेबल्स:
- प्लेसहोल्डर fetch लॉजिक प्रवाहित टोकन्ससह बदला (`stream=True` एंडपॉइंट व्हेरिएंट वापरा एकदा सक्षम झाल्यावर)
- विलंब चार्ट (क्लायंट-साइड) phi वि gpt-oss-20b टॉगलसाठी जोडा
- RAG संदर्भ इनलाइन एम्बेड करा (संदर्भ डॉकसाठी textarea)
...
| खर्च (स्थानिक) | कमी | जास्त (संसाधन) | ऊर्जा/वेळ व्यापार |
...
|-----------------|-----------|----------|-----------------------|
| `samples/session04/model_compare.py` / `notebooks/session04_model_compare.ipynb` | कार्यसंरचना टीम कार्यकारी सारांश जनरेटरसाठी SLM वि LLM चे मूल्यांकन करत आहे | विलंब + टोकन वापर डेल्टा मोजा | सिंगल `COMPARE_PROMPT` env var |
...
### परिस्थिती कथन
उत्पादन संघाला कार्यकारी ब्रीफिंग जनरेटर हवा आहे. हलके SLM (phi‑4‑mini) सारांश तयार करते; मोठे LLM (gpt‑oss‑20b) फक्त उच्च-प्राथमिकता अहवाल सुधारू शकते. सत्र स्क्रिप्ट्स अनुभवजन्य विलंब आणि टोकन मेट्रिक्स कॅप्चर करतात जेणेकरून हायब्रिड डिझाइनचे समर्थन करता येईल, तर Chainlit डेमो दर्शविते की ग्राउंडेड पुनर्प्राप्ती लहान मॉडेल उत्तरांना तथ्यात्मक ठेवते. WebGPU संकल्पना पृष्ठ ब्राउझर प्रवेग परिपक्व झाल्यावर पूर्णपणे क्लायंट-साइड प्रक्रिया करण्यासाठी व्हिजन पथ प्रदान करते.
...
### हायब्रिड ड्राफ्ट→रिफाइन फ्लो (छद्म)
```python
...
दोन्ही विलंब घटक ट्रॅक करा आणि मिश्रित सरासरी खर्चाचा अहवाल द्या.

### पर्यायी सुधारणा

| लक्ष केंद्रित | सुधारणा | का | अंमलबजावणी सूचक |
|--------------|---------|----|----------------|
| तुलनात्मक मेट्रिक्स | टोकन वापर + पहिल्या टोकन विलंब ट्रॅक करा | समग्र प्रदर्शन दृश्य | सुधारित बेंचमार्क स्क्रिप्ट वापरा (सत्र ३) `BENCH_STREAM=1` सह |
| हायब्रिड पाइपलाइन | SLM ड्राफ्ट → LLM सुधारणा | विलंब आणि खर्च कमी करा | phi-4-mini सह जनरेट करा, gpt-oss-20b सह सारांश सुधारित करा |
| प्रवाहित UI | Chainlit मध्ये चांगले UX | क्रमिक अभिप्राय | `stream=True` वापरा एकदा स्थानिक प्रवाह उघड झाल्यावर; तुकडे जमा करा |
| WebGPU कॅशिंग | जलद JS प्रारंभ | पुन्हा संकलन ओव्हरहेड कमी करा | संकलित शेडर वस्तू कॅश करा (भविष्यातील रनटाइम क्षमता) |
| निश्चित QA सेट | मॉडेल तुलना न्याय्य करा | फरक काढा | निश्चित प्रॉम्प्ट यादी + मूल्यांकन रनसाठी `temperature=0` |
| आउटपुट स्कोरिंग | संरचित गुणवत्ता दृष्टिकोन | अनुभवांपलीकडे जा | साधी मेट्रिक: सुसंगती / तथ्यात्मकता / संक्षिप्तता (१–५) |
| ऊर्जा / संसाधन नोट्स | वर्ग चर्चा | व्यापार-offs दर्शवा | OS मॉनिटर्स (Task Manager, `nvidia-smi`) + बेंचमार्क स्क्रिप्ट आउटपुट वापरा |
...
| RAG + LLM फॉलबॅक | गुणवत्ता सुरक्षा जाळे | कठीण प्रश्न सुधारित करा | जर SLM उत्तर लांबी < थ्रेशोल्ड किंवा कमी आत्मविश्वास → उन्नत करा |

#### उदाहरण हायब्रिड ड्राफ्ट/सुधारणा पॅटर्न
...
न्याय्य तुलना करण्यासाठी मॉडेल्समध्ये सातत्यपूर्ण मोजमाप संरचना वापरा.
