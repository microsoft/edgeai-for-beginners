...
Edge AI představuje paradigmatický posun, který řeší klíčové moderní výzvy:
...
- **Mobilní zařízení**: Smartphony a tablety s offline funkcemi
...
| [🤖 06](../../Module06) | [AI agenti a volání funkcí](./Module06/README.md) | Frameworky agentů a MCP | Úvod do agentů • Volání funkcí • Protokol kontextu modelu | Pokročilý | 4-5 hodin |
| [💻 07](../../Module07) | [Implementace platformy](./Module07/README.md) | Ukázky napříč platformami | AI Toolkit • Foundry Local • Vývoj pro Windows | Pokročilý | 3-4 hodiny |
