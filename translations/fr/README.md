...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:21:35+00:00",
...
Bienvenue dans **EdgeAI pour Débutants** – votre parcours complet dans le monde transformateur de l'Intelligence Artificielle en périphérie (Edge AI). Ce cours comble le fossé entre les puissantes capacités de l'IA et leur déploiement pratique dans le monde réel sur des appareils en périphérie, vous permettant d'exploiter le potentiel de l'IA directement là où les données sont générées et où les décisions doivent être prises.
...
- **Confidentialité et sécurité** : Traitez les données sensibles localement sans les exposer au cloud
- **Performance en temps réel** : Éliminez la latence réseau pour des applications critiques
...
- **Inférence sur l'appareil** : Les modèles d'IA s'exécutent sur des appareils en périphérie (téléphones, routeurs, microcontrôleurs, PC industriels)
...
- **Réduction de l'empreinte mémoire** : Utilisation efficace de la mémoire limitée des appareils en périphérie
- **Moins de demande en calcul** : Optimisés pour les performances des CPU et GPU en périphérie
- **Temps de démarrage plus rapides** : Initialisation rapide pour des applications réactives

Ils débloquent de puissantes capacités de traitement du langage naturel tout en respectant les contraintes de :
...
|--------|-------|-------------------|-------------|--------|-------|
| [📖 00 ](./introduction.md) | [Introduction à l'EdgeAI](./introduction.md) | Fondations & Contexte | Vue d'ensemble de l'EdgeAI • Applications industrielles • Introduction aux SLMs • Objectifs d'apprentissage | Débutant | 1-2 h |
| [📚 01](../../Module01) | [Fondamentaux de l'EdgeAI](./Module01/README.md) | Comparaison Cloud vs Edge AI | Fondamentaux de l'EdgeAI • Études de cas réels • Guide d'implémentation • Déploiement en périphérie | Débutant | 3-4 h |
...
| [⚙️ 04](../../Module04) | [Boîte à outils d'optimisation des modèles](./Module04/README.md) | Optimisation multiplateforme | Introduction • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Synthèse de flux de travail | Intermédiaire | 5-6 h |
| [🔧 05](../../Module05) | [SLMOps en production](./Module05/README.md) | Opérations en production | Introduction aux SLMOps • Distillation de modèles • Ajustement fin • Déploiement en production | Avancé | 5-6 h |
...
| [🏭 08](../../Module08) | [Boîte à outils Foundry Local](./Module08/README.md) | Échantillons prêts pour la production | Applications d'exemple (voir détails ci-dessous) | Expert | 8-10 h |
...
4. **💻 Mise en œuvre** (Modules 07-08) : Échantillons de plateforme + outils locaux Foundry
...
**Secteurs industriels** : Fabrication 4.0 • Technologie de santé • Systèmes autonomes • FinTech • Électronique grand public
