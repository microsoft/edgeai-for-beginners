...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:40:52+00:00",
...
1. **Forkez le Répertoire** : Cliquez sur [![Forks GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
- **Capacité hors ligne** : Fonctionne sans connectivité Internet permanente
...
- [10 : Framework d'outils Foundry](./Module08/samples/10/README.md)

### 🎓 **Atelier : Parcours d'apprentissage pratique**

Matériaux d'atelier pratiques complets avec des implémentations prêtes pour la production :
...
- **Optimisation des modèles** : Quantifier et compresser les modèles pour le déploiement en périphérie (augmentation de vitesse de 85 %, réduction de taille de 75 %)
- **Déploiement Multi-Plateforme** : Windows, mobile, systèmes embarqués et hybrides cloud-edge  
- **Opérations en Production** : Surveillance, mise à l'échelle et maintenance de l'IA edge en production  
...
4. **💻 Implémentation** (Modules 07-08) : Exemples de plateformes + outils locaux Foundry  
