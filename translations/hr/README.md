...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T12:58:52+00:00",
...
[![GitHub pull-zahtjevi](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
- **Male jezične modele (SLM)** optimizirane za edge primjenu
...
- **Performanse u stvarnom vremenu**: Eliminira mrežnu latenciju za aplikacije osjetljive na vrijeme
- **Učinkovitost troškova**: Smanjuje troškove propusnosti i računalstva u oblaku
...
Edge AI odnosi se na pokretanje AI algoritama i jezičnih modela lokalno na hardveru, blizu mjesta gdje se podaci generiraju, bez oslanjanja na oblačne resurse za inferenciju. Smanjuje latenciju, poboljšava privatnost i omogućuje donošenje odluka u stvarnom vremenu.
...
| [🚀 03](../../Module03) | [Praksa postavljanja SLM](./Module03/README.md) | Lokalno i oblačno postavljanje | Napredno učenje • Lokalno okruženje • Oblačno postavljanje | Srednja | 4-5 sati |
| [⚙️ 04](../../Module04) | [Alati za optimizaciju modela](./Module04/README.md) | Optimizacija na više platformi | Uvod • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Sinteza radnog toka | Srednja | 5-6 sati |
...
- **Višeplatformska implementacija**: Windows, mobilni uređaji, ugrađeni sustavi i hibridni cloud-edge sustavi  
...
- **Sustavi s više agenata**: Koordinator sa specijaliziranim agentima za složene radne tokove  
...
- **API okviri**: Klijenti spremni za produkciju s streamingom i praćenjem zdravlja  
...
2. **⚙️ Optimizacija** (Moduli 03-04): Okviri za implementaciju i kvantizaciju  
...
**Tehničke uloge**: Arhitekt rješenja za EdgeAI • ML inženjer (Edge) • IoT AI programer • Mobilni AI programer  

**Industrijski sektori**: Proizvodnja 4.0 • Tehnologija zdravstva • Autonomni sustavi • FinTech • Potrošačka elektronika  

**Portfolio projekti**: Sustavi s više agenata • Produkcijske RAG aplikacije • Višeplatformska implementacija • Optimizacija performansi  
...
✅ **Višeplatformski pristup**: Windows, mobilni uređaji, ugrađeni sustavi, cloud-edge hibrid  
✅ **Spremno za produkciju**: Praćenje, skaliranje, sigurnost, okviri usklađenosti  

📖 **[Dostupan vodič za učenje](STUDY_GUIDE.md)**: Strukturirani 20-satni put učenja s uputama za raspored vremena i alatima za samoocjenu.  

---  

**EdgeAI predstavlja budućnost AI implementacije**: lokalno-prvo, s očuvanjem privatnosti i učinkovito. Ovladajte ovim vještinama za izgradnju sljedeće generacije inteligentnih aplikacija.  
