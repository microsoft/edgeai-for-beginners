...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T18:11:09+00:00",
...
Dobrodošli u **EdgeAI za početnike** – vaš sveobuhvatan vodič u transformativni svijet Edge umjetne inteligencije. Ovaj tečaj povezuje moćne AI mogućnosti s praktičnom primjenom na edge uređajima, omogućujući vam da iskoristite potencijal AI-a tamo gdje se podaci generiraju i gdje su odluke potrebne.
...
- **Inferencija u stvarnom vremenu** s očuvanjem privatnosti
...
- **Performanse u stvarnom vremenu**: Uklanjanje mrežne latencije za vremenski kritične aplikacije
...
Edge AI odnosi se na pokretanje AI algoritama i jezičnih modela lokalno na hardveru, blizu mjesta gdje se podaci generiraju, bez oslanjanja na oblak za inferenciju. To smanjuje latenciju, poboljšava privatnost i omogućuje donošenje odluka u stvarnom vremenu.

### Temeljna načela:
- **Inferencija na uređaju**: AI modeli pokreću se na edge uređajima (telefoni, ruteri, mikrokontroleri, industrijska računala)
...
- **Suverenitet podataka**: Osjetljivi podaci ostaju lokalni, poboljšavajući sigurnost i usklađenost
...
- **Smanjenu memorijsku potrošnju**: Učinkovito korištenje ograničene memorije edge uređaja
- **Niže zahtjeve za računalnu snagu**: Optimizirani za performanse CPU-a i edge GPU-a
...
- **Mobilni uređaji**: Pametni telefoni i tableti s offline mogućnostima
...
| [📚 01](../../Module01) | [Osnove EdgeAI-a](./Module01/README.md) | Usporedba oblaka i Edge AI-a | Osnove EdgeAI-a • Studije slučaja • Vodič za implementaciju • Edge implementacija | Početnik | 3-4 sata |
...
| [⚙️ 04](../../Module04) | [Alati za optimizaciju modela](./Module04/README.md) | Optimizacija za više platformi | Uvod • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Sinteza tijeka rada | Srednji | 5-6 sati |
| [🔧 05](../../Module05) | [SLMOps u produkciji](./Module05/README.md) | Operacije u produkciji | Uvod u SLMOps • Destilacija modela • Fino podešavanje • Implementacija u produkciji | Napredni | 5-6 sati |
...
| [💻 07](../../Module07) | [Implementacija na platformama](./Module07/README.md) | Primjeri za više platformi | AI alati • Foundry Local • Razvoj za Windows | Napredni | 3-4 sata |
| [🏭 08](../../Module08) | [Foundry Local Toolkit](./Module08/README.md) | Primjeri spremni za produkciju | Primjeri aplikacija (vidi detalje ispod) | Stručnjak | 8-10 sati |

### 🏭 **Modul 08: Primjeri aplikacija**

- [01: REST Chat Quickstart](./Module08/samples/01/README.md)
- [02: Integracija OpenAI SDK-a](./Module08/samples/02/README.md)
- [03: Otkrivanje i benchmarking modela](./Module08/samples/03/README.md)
...
- RAG cjevovode s evaluacijom kvalitete (RAGAS)
...
- **Arhitektura Edge AI-a**: Dizajnirajte AI sustave s lokalnim prioritetom i integracijom oblaka
- **Optimizacija modela**: Kvantizirajte i komprimirajte modele za edge implementaciju (85% ubrzanje, 75% smanjenje veličine)
- **Implementacija na više platformi**: Windows, mobilni uređaji, ugrađeni sustavi i hibridni sustavi oblak-edge
- **Operacije u proizvodnji**: Praćenje, skaliranje i održavanje edge AI sustava u proizvodnji
...
- **API okviri**: Klijenti spremni za proizvodnju s mogućnostima streaminga i praćenja zdravlja sustava
...
**Tehničke uloge**: Arhitekt rješenja za EdgeAI • ML inženjer (Edge) • IoT AI programer • Programer mobilnih AI aplikacija

**Industrijski sektori**: Proizvodnja 4.0 • Tehnologija u zdravstvu • Autonomni sustavi • FinTech • Potrošačka elektronika

**Projekti za portfelj**: Sustavi s više agenata • RAG aplikacije u proizvodnji • Implementacija na više platformi • Optimizacija performansi
...
✅ **Progresivno učenje**: Teorija → Praksa → Implementacija u proizvodnji  
...
✅ **Spremno za proizvodnju**: Okviri za praćenje, skaliranje, sigurnost i usklađenost

📖 **[Dostupan vodič za učenje](STUDY_GUIDE.md)**: Strukturirani put učenja od 20 sati s vodičem za raspodjelu vremena i alatima za samoprocjenu.

---

**EdgeAI predstavlja budućnost implementacije AI-a**: lokalno orijentiran, čuva privatnost i učinkovit. Savladajte ove vještine kako biste izgradili sljedeću generaciju inteligentnih aplikacija.
