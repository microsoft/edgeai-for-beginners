...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:32:37+00:00",
...
歡迎來到 **初學者的邊緣人工智慧課程**，這是一個全面探索邊緣人工智慧世界的旅程。本課程將強大的 AI 能力與實際應用部署相結合，幫助您在數據生成和決策需要的地方直接發揮 AI 的潛力。

### 您將掌握的技能

本課程涵蓋從基礎概念到生產級實現的內容，包括：
...
邊緣人工智慧指的是在硬體上本地執行 AI 演算法和語言模型，靠近數據生成的地方，而不依賴雲端資源進行推論。它能降低延遲、增強隱私，並實現即時決策。

### 核心原則：
- **設備上的推論**：AI 模型在邊緣設備（手機、路由器、微控制器、工業電腦）上運行
- **離線能力**：無需持續的網路連接即可運作
- **低延遲**：即時響應，適合即時系統
- **數據主權**：將敏感數據保留在本地，提升安全性和法規遵從性

### 小型語言模型（SLMs）

像 Phi-4、Mistral-7B 和 Gemma 這樣的 SLMs 是大型 LLMs 的優化版本，經過訓練或蒸餾以：
- **減少記憶體佔用**：有效利用有限的邊緣設備記憶體
- **降低計算需求**：針對 CPU 和邊緣 GPU 性能進行優化
- **更快的啟動時間**：快速初始化，適合響應式應用

它們在滿足以下限制的同時，解鎖了強大的 NLP 功能：
- **嵌入式系統**：物聯網設備和工業控制器
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [邊緣人工智慧介紹](./introduction.md) | 基礎與背景 | 邊緣人工智慧概述 • 行業應用 • SLM 介紹 • 學習目標 | 初學者 | 1-2 小時 |
| [📚 01](../../Module01) | [邊緣人工智慧基礎](./Module01/README.md) | 雲端與邊緣 AI 比較 | 邊緣人工智慧基礎 • 真實案例研究 • 實施指南 • 邊緣部署 | 初學者 | 3-4 小時 |
...
| [⚙️ 04](../../Module04) | [模型優化工具包](./Module04/README.md) | 跨平台優化 | 介紹 • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • 工作流程合成 | 中級 | 5-6 小時 |
...
| [💻 07](../../Module07) | [平台實現](./Module07/README.md) | 跨平台範例 | AI 工具包 • Foundry Local • Windows 開發 | 高級 | 3-4 小時 |
...
- [06: 模型作為工具的路由器](./Module08/samples/06/README.md)
...
### 🎯 核心能力
- **邊緣人工智慧架構**：設計本地優先的 AI 系統，並整合雲端
- **模型優化**：量化和壓縮模型以進行邊緣部署（提升速度 85%，減少大小 75%）
- **多平台部署**：Windows、移動設備、嵌入式系統和雲端邊緣混合系統
...
**產業領域**：製造業 4.0 • 醫療科技 • 自動化系統 • 金融科技 • 消費電子  
...
✅ **實作範例**：超過 50 個範例，10 個完整 Foundry 本地示範  
✅ **性能專注**：提升速度 85%，減少大小 75%  
✅ **多平台支援**：Windows、行動裝置、嵌入式、雲端邊緣混合  
✅ **生產就緒**：監控、擴展、安全性、合規框架  
...
**邊緣 AI 代表 AI 部署的未來**：本地優先、隱私保護、高效能。掌握這些技能，打造下一代智能應用程式。
...
如果您遇到困難或有任何關於建構 AI 應用程式的問題，請加入：

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

如果您有產品回饋或在建構過程中遇到錯誤，請造訪：
