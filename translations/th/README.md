...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:57:45+00:00",
...
**หากคุณต้องการให้มีการแปลเพิ่มเติม สามารถดูภาษาที่รองรับได้ [ที่นี่](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**

## บทนำ

ยินดีต้อนรับสู่ **EdgeAI สำหรับผู้เริ่มต้น** – การเดินทางที่ครอบคลุมสู่โลกแห่ง Edge Artificial Intelligence ที่เปลี่ยนแปลงวงการ คอร์สนี้จะช่วยเชื่อมโยงความสามารถ AI อันทรงพลังกับการใช้งานจริงในโลกแห่งความเป็นจริงบนอุปกรณ์ Edge เพื่อให้คุณสามารถใช้ศักยภาพของ AI ได้โดยตรงในที่ที่ข้อมูลถูกสร้างขึ้นและการตัดสินใจต้องเกิดขึ้น
...
- **กลยุทธ์การใช้งานในระดับการผลิต** สำหรับแอปพลิเคชันองค์กร
...
- **ลดความต้องการในการประมวลผล**: ปรับแต่งเพื่อประสิทธิภาพของ CPU และ GPU บนอุปกรณ์ Edge
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [Introduction to EdgeAI](./introduction.md) | พื้นฐาน & บริบท | ภาพรวม EdgeAI • การใช้งานในอุตสาหกรรม • การแนะนำ SLM • วัตถุประสงค์การเรียนรู้ | ผู้เริ่มต้น | 1-2 ชม. |
| [📚 01](../../Module01) | [EdgeAI Fundamentals](./Module01/README.md) | การเปรียบเทียบ Cloud กับ Edge AI | พื้นฐาน EdgeAI • กรณีศึกษาในโลกจริง • คู่มือการใช้งาน • การใช้งาน Edge | ผู้เริ่มต้น | 3-4 ชม. |
| [🧠 02](../../Module02) | [SLM Model Foundations](./Module02/README.md) | ครอบครัวโมเดล & สถาปัตยกรรม | ครอบครัว Phi • ครอบครัว Qwen • ครอบครัว Gemma • BitNET • μModel • Phi-Silica | ผู้เริ่มต้น | 4-5 ชม. |
| [🚀 03](../../Module03) | [SLM Deployment Practice](./Module03/README.md) | การใช้งานในพื้นที่ & คลาวด์ | การเรียนรู้ขั้นสูง • สภาพแวดล้อมในพื้นที่ • การใช้งานบนคลาวด์ | ระดับกลาง | 4-5 ชม. |
| [⚙️ 04](../../Module04) | [Model Optimization Toolkit](./Module04/README.md) | การปรับแต่งข้ามแพลตฟอร์ม | บทนำ • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • การสังเคราะห์ Workflow | ระดับกลาง | 5-6 ชม. |
| [🔧 05](../../Module05) | [SLMOps Production](./Module05/README.md) | การดำเนินงานในระดับการผลิต | บทนำ SLMOps • การกลั่นโมเดล • การปรับแต่ง • การใช้งานในระดับการผลิต | ระดับสูง | 5-6 ชม. |
| [🤖 06](../../Module06) | [AI Agents & Function Calling](./Module06/README.md) | เฟรมเวิร์กตัวแทน & MCP | บทนำตัวแทน • การเรียกฟังก์ชัน • โปรโตคอลบริบทโมเดล | ระดับสูง | 4-5 ชม. |
| [💻 07](../../Module07) | [Platform Implementation](./Module07/README.md) | ตัวอย่างข้ามแพลตฟอร์ม | เครื่องมือ AI • Foundry Local • การพัฒนาบน Windows | ระดับสูง | 3-4 ชม. |
| [🏭 08](../../Module08) | [Foundry Local Toolkit](./Module08/README.md) | ตัวอย่างที่พร้อมสำหรับการผลิต | แอปพลิเคชันตัวอย่าง (ดูรายละเอียดด้านล่าง) | ระดับผู้เชี่ยวชาญ | 8-10 ชม. |

### 🏭 **Module 08: แอปพลิเคชันตัวอย่าง**
...
- **[Workshop Guide](./Workshop/Readme.md)** - วัตถุประสงค์การเรียนรู้ที่สมบูรณ์ ผลลัพธ์ และการนำทางทรัพยากร
...
- **Session Guides** - คู่มือ Markdown ที่ละเอียดสำหรับแต่ละเซสชันของ Workshop
- **Validation Tools** - สคริปต์เพื่อยืนยันคุณภาพโค้ดและทดสอบการทำงานเบื้องต้น
...
- **การปรับแต่งโมเดล**: ลดขนาดและเพิ่มความเร็วโมเดลสำหรับการใช้งานบนอุปกรณ์ Edge (เพิ่มความเร็ว 85%, ลดขนาด 75%)
- **การใช้งานข้ามแพลตฟอร์ม**: Windows, มือถือ, อุปกรณ์ฝังตัว และระบบไฮบริดคลาวด์-เอดจ์  
- **การดำเนินงานในสายการผลิต**: การตรวจสอบ, การปรับขนาด, และการดูแลรักษา AI บนเอดจ์ในสายการผลิต  

### 🏗️ โครงการเชิงปฏิบัติ  
- **Foundry Local Chat Apps**: แอปพลิเคชันเนทีฟบน Windows 11 พร้อมการสลับโมเดล  
- **ระบบหลายตัวแทน**: ตัวประสานงานร่วมกับตัวแทนเฉพาะทางสำหรับการทำงานที่ซับซ้อน  
...
- **กรอบงาน API**: ลูกค้าที่พร้อมใช้งานในสายการผลิตพร้อมการสตรีมและการตรวจสอบสุขภาพ  
...
2. **⚙️ การปรับแต่ง** (Modules 03-04): การใช้งาน + กรอบการลดขนาด  
...
แต่ละโมดูลประกอบด้วยทฤษฎี, การฝึกปฏิบัติ, และตัวอย่างโค้ดที่พร้อมใช้งานในสายการผลิต  
...
**โครงการพอร์ตโฟลิโอ**: ระบบหลายตัวแทน • แอปพลิเคชัน RAG ในสายการผลิต • การใช้งานข้ามแพลตฟอร์ม • การปรับปรุงประสิทธิภาพ  
...
✅ **การเรียนรู้แบบก้าวหน้า**: ทฤษฎี → การปฏิบัติ → การใช้งานในสายการผลิต  
✅ **กรณีศึกษาในชีวิตจริง**: Microsoft, Japan Airlines, การใช้งานในองค์กร  
...
✅ **ข้ามแพลตฟอร์ม**: Windows, มือถือ, อุปกรณ์ฝังตัว, ไฮบริดคลาวด์-เอดจ์  
✅ **พร้อมใช้งานในสายการผลิต**: กรอบการตรวจสอบ, การปรับขนาด, ความปลอดภัย, การปฏิบัติตามข้อกำหนด  
...
**EdgeAI คืออนาคตของการใช้งาน AI**: เน้นการใช้งานในพื้นที่, รักษาความเป็นส่วนตัว, และมีประสิทธิภาพ เรียนรู้ทักษะเหล่านี้เพื่อสร้างแอปพลิเคชันอัจฉริยะรุ่นต่อไป  
