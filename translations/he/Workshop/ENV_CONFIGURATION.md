...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T23:35:01+00:00",
...
**מתי להגדיר FOUNDRY_LOCAL_ENDPOINT:**
...
| משתנה | ברירת מחדל | מטרה |
|-------|------------|-------|
| `BENCH_MODELS` | `phi-4-mini,qwen2.5-0.5b` | מודלים לבדיקה |
...
| משתנה | ברירת מחדל | מטרה |
|-------|------------|-------|
| `AGENT_MODEL_PRIMARY` | `phi-4-mini` | מודל סוכן חוקר |
