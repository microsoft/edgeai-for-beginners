...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T18:10:07+00:00",
...
[![GitHub захтеви за измене](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
- **Ниско кашњење**: Одговори погодни за системе у реалном времену
...
Они откључавају моћне NLP могућности док испуњавају ограничења:
...
| [🧠 02](../../Module02) | [Основе модела SLM](./Module02/README.md) | Породице модела и архитектура | Phi породица • Qwen породица • Gemma породица • BitNET • μModel • Phi-Silica | Почетник | 4-5 сати |
...
### 🎓 **Радионица: Пут учења кроз практичне примере**
...
**Шта ћете изградити:**
- Локалне апликације за ћаскање са подршком за стриминг
...
- **Архитектура Edge AI**: Дизајнирајте AI системе који су локално оријентисани са интеграцијом облака
...
- **Производне операције**: Надгледање, скалирање и одржавање Edge AI у продукцији
...
- **RAG апликације**: Обрада локалних докумената са претрагом вектора
- **Рутери модела**: Интелигентан избор између модела на основу анализе задатка
- **API оквири**: Клијенти спремни за продукцију са стримингом и надгледањем здравља система
- **Мултиплатформски алати**: Шаблони интеграције LangChain/Semantic Kernel
...
4. **💻 Имплементација** (Модули 07-08): Примери платформи + Foundry локални алати
...
**Сектори индустрије**: Производња 4.0 • Технологије у здравству • Аутономни системи • FinTech • Потрошачка електроника
...
## Истакнуте карактеристике курса

✅ **Прогресивно учење**: Теорија → Практична примена → Деплојмент у продукцији  
✅ **Студије случаја из стварног света**: Microsoft, Japan Airlines, имплементације у предузећима  
✅ **Практични примери**: Преко 50 примера, 10 свеобухватних Foundry локалних демонстрација  
...
✅ **Спремно за продукцију**: Надгледање, скалирање, безбедност, оквири за усклађеност

📖 **[Доступан водич за учење](STUDY_GUIDE.md)**: Структурирани пут учења од 20 сати са смерницама за расподелу времена и алатима за самопроцену.

---

**EdgeAI представља будућност примене AI**: локално оријентисан, са очувањем приватности и ефикасан. Савладајте ове вештине како бисте изградили следећу генерацију интелигентних апликација.
