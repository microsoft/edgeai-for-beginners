...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-12T00:27:15+00:00",
...
Примери радионице користе променљиве окружења за конфигурацију, централизоване у `.env` датотеци на корену репозиторијума. Ово омогућава лаку прилагодбу без измене кода.
...
| `BENCH_ROUNDS` | `3` | Број итерација по моделу |
...
| `RETRY_BACKOFF` | `1.0` | Кашњење поновног покушаја (секунде) |
...
**Висок квалитет:**
- `qwen2.5-7b` - Најбољи квалитет, већа употреба ресурса
- `phi-4-mini` - Добар квалитет, мањи ресурси
...
- **API документација**: Проверите SDK репозиторијум за најновије
