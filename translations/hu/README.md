...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T12:41:59+00:00",
...
![Tanfolyam borítókép](../../translated_images/cover.eb18d1b9605d754b30973f4e17c6e11ea4f8473d9686ee378d6e7b44e3c70ac7.hu.png)
...
[![GitHub pull-kérelmek](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
1. **Forkolja a tárolót**: Kattintson ide [![GitHub forkok](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
2. **Klónozza a tárolót**:   `git clone https://github.com/microsoft/edgeai-for-beginners.git`
3. [**Csatlakozzon az Azure AI Foundry Discordhoz, és ismerkedjen meg szakértőkkel és fejlesztőtársakkal**](https://discord.com/invite/ByRwuEEgH4)
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [Bevezetés az EdgeAI-be](./introduction.md) | Alapok és kontextus | EdgeAI áttekintés • Iparági alkalmazások • SLM bevezetés • Tanulási célok | Kezdő | 1-2 óra |
...
| [🔧 05](../../Module05) | [SLMOps gyártásban](./Module05/README.md) | Gyártási műveletek | SLMOps bevezetés • Modell desztilláció • Finomhangolás • Gyártásra való telepítés | Haladó | 5-6 óra |
...
- [03: Modell felfedezés és benchmark](./Module08/samples/03/README.md)
...
- **Ülés útmutatók** - Részletes markdown útmutatók minden műhelyüléshez
...
- Intelligens modell útválasztás feladatalapú kiválasztással
...
- **API keretrendszerek**: Termelésre kész kliens streaminggel és állapotfigyeléssel  
...
Minden modul elméletet, gyakorlati feladatokat és termelésre kész kódmintákat tartalmaz.  

## Karrierhatás  

**Műszaki szerepkörök**: EdgeAI megoldásarchitekt • ML mérnök (Edge) • IoT AI fejlesztő • Mobil AI fejlesztő  

**Ipari szektorok**: Gyártás 4.0 • Egészségügyi technológia • Autonóm rendszerek • FinTech • Fogyasztói elektronika  

**Portfólió projektek**: Többügynökös rendszerek • Termelési RAG alkalmazások • Többplatformos telepítés • Teljesítményoptimalizálás  
