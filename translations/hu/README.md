...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T18:04:13+00:00",
...
- **Kis nyelvi modellek (SLM-ek)**, amelyek optimalizáltak az edge környezethez
...
Az SLM-ek, mint például a Phi-4, Mistral-7B és Gemma, nagyobb LLM-ek optimalizált verziói – tréningezve vagy desztillálva az alábbiakra:
...
- **Jupyter Notebooks** (8 interaktív) - Lépésről lépésre oktatóanyagok benchmarkokkal és teljesítményfigyeléssel
...
- **Foundry helyi chat alkalmazások**: Windows 11 natív alkalmazás modellváltási lehetőséggel
...
**Portfólió projektek**: Multi-ügynök rendszerek • Éles RAG alkalmazások • Keresztplatform telepítés • Teljesítményoptimalizálás
...
✅ **Teljesítmény fókusz**: 85%-os sebességnövekedés, 75%-os méretcsökkentés  
✅ **Többplatformos**: Windows, mobil, beágyazott, felhő-edge hibrid  
✅ **Éles környezetre kész**: Felügyeleti, skálázási, biztonsági, megfelelőségi keretrendszerek
