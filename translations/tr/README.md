...
1. **Depoyu Çatalla**: Tıklayın [![GitHub çatallar](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
2. **Depoyu Klonla**:   `git clone https://github.com/microsoft/edgeai-for-beginners.git`
...
Edge AI, AI algoritmalarını ve dil modellerini verinin üretildiği yere yakın donanımda, çıkarım için bulut kaynaklarına güvenmeden çalıştırmayı ifade eder. Gecikmeyi azaltır, gizliliği artırır ve gerçek zamanlı karar vermeyi mümkün kılar.

### Temel İlkeler:
- **Cihaz üzerinde çıkarım**: AI modelleri kenar cihazlarda (telefonlar, yönlendiriciler, mikrodenetleyiciler, endüstriyel PC'ler) çalışır
...
- **Kenar sunucular**: Sınırlı GPU kaynaklarına sahip yerel işlem birimleri
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [EdgeAI'ye Giriş](./introduction.md) | Temel & Bağlam | EdgeAI Genel Bakış • Sektör Uygulamaları • SLM Tanıtımı • Öğrenme Hedefleri | Yeni Başlayan | 1-2 saat |
| [📚 01](../../Module01) | [EdgeAI Temelleri](./Module01/README.md) | Bulut ve Kenar AI karşılaştırması | EdgeAI Temelleri • Gerçek Dünya Vaka Çalışmaları • Uygulama Rehberi • Kenar Dağıtımı | Yeni Başlayan | 3-4 saat |
...
- **Yeni Başlayan Yolu**: Modüller 01-02 (7-9 saat)  
