...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-28T17:27:13+00:00",
...
Трябва да видите подобен изход и идентични броячи на токени при второто изпълнение, което потвърждава детерминизма.
