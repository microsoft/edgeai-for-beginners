...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T13:06:06+00:00",
...
**Ако желаете да има допълнителни поддържани езици за превод, те са изброени [тук](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
## Въведение
...
- **Производителност в реално време**: Премахнете мрежовата латентност за приложения с критично време
