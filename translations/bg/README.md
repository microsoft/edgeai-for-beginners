...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T16:09:23+00:00",
...
| [⚙️ 04](../../Module04) | [Инструменти за оптимизация на модели](./Module04/README.md) | Оптимизация за различни платформи | Въведение • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Синтез на работния процес | Средно ниво | 5-6 ч |
...
- Системи за мултиагентна оркестрация
...
### 🎯 Основни компетенции
- **Архитектура на Edge AI**: Проектиране на локално-първи AI системи с интеграция в облака
