...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T18:08:47+00:00",
...
Добре дошли в **EdgeAI за начинаещи** – вашето пълно ръководство в трансформиращия свят на Edge изкуствения интелект. Този курс свързва мощните възможности на AI с практическото му приложение на edge устройства, позволявайки ви да използвате потенциала на AI директно там, където се генерират данни и трябва да се вземат решения.
...
- **Поверителност и сигурност**: Обработвайте чувствителни данни локално, без да ги излагате в облака
...
- **Ниско изискване за изчисления**: Оптимизирани за CPU и edge GPU производителност
...
| [🔧 05](../../Module05) | [SLMOps производство](./Module05/README.md) | Производствени операции | Въведение в SLMOps • Дистилация на модели • Фина настройка • Производствено внедряване | Напреднало | 5-6 часа |
...
- **[Ръководство за работилница](./Workshop/Readme.md)** - Пълни цели на обучението, резултати и навигация по ресурсите
...
- **Оптимизация на модели**: Квантифицирайте и компресирайте модели за edge внедряване (85% ускорение, 75% намаление на размера)
- **Многоплатформено внедряване**: Windows, мобилни, вградени и хибридни системи облак-edge
- **Производствени операции**: Наблюдение, мащабиране и поддръжка на Edge AI в продукция
...
- **Инструменти за различни платформи**: Модели на интеграция LangChain/Semantic Kernel
...
**Препоръчан учебен път** (общо 20-30 часа):
...
**Сектори в индустрията**: Производство 4.0 • Технологии за здравеопазване • Автономни системи • FinTech • Потребителска електроника

**Проекти за портфолио**: Мултиагентни системи • RAG приложения в продукция • Деплоймънт на различни платформи • Оптимизация на производителността
...
✅ **Мултиплатформеност**: Windows, мобилни устройства, вградени системи, хибрид облак-Edge  
...
### Серия за Copilot
[![Copilot за AI програмиране по двойки](https://img.shields.io/badge/Copilot%20за%20AI%20програмиране%20по%20двойки-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
