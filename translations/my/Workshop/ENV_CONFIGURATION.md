...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-12T00:42:00+00:00",
...
Workshop နမူနာများသည် `.env` ဖိုင်တွင် အခြေခံထားသော ပတ်ဝန်းကျင်အပြောင်းအလဲများကို အသုံးပြုသည်။ ၎င်းသည် ကုဒ်ကို ပြင်ဆင်ရန်မလိုဘဲ လွယ်ကူစွာ စိတ်ကြိုက်ပြင်ဆင်နိုင်စေသည်။
...
`.env` ဖိုင်ကို သင့်လျော်သော အခြေခံများဖြင့် ရှိပြီးသားဖြစ်သည်။ အသုံးပြုသူအများစုသည် ဘာမှ ပြောင်းလဲရန် မလိုအပ်ပါ။

**Optional**: ဆက်တင်များကို ပြန်လည်သုံးသပ်ပြီး စိတ်ကြိုက်ပြင်ဆင်ပါ:
```bash
# Edit .env file
notepad .env  # Windows
...
| `FOUNDRY_LOCAL_ENDPOINT` | (အလွတ်) | ဝန်ဆောင်မှု endpoint ကို override လုပ်ရန် |
...
| Variable | Default | Purpose |
|----------|---------|---------|
| `BENCH_MODELS` | `phi-4-mini,qwen2.5-0.5b` | Benchmark လုပ်ရန် မော်ဒယ်များ |
...
| `RETRY_BACKOFF` | `1.0` | ပြန်လည်ကြိုးစားမှုနှောင့်နှေးမှု (စက္ကန့်) |
...
**အမြန်တုံ့ပြန်မှုများ:**
- `qwen2.5-0.5b` - အလွန်မြန်ဆန်ပြီး classification အတွက်ကောင်းသည်
...
**ကုဒ်ထုတ်လုပ်မှု:**
- `deepseek-coder-1.3b` - ကုဒ်အတွက် အထူးပြုထားသည်
- `phi-4-mini` - အထွေထွေကုဒ်ရေးခြင်းအတွက်
...
### Temperature & Sampling (ကုဒ်တွင် override လုပ်ပါ)
...
**လက္ခဏာများ:**
- Scripts မှားသော မော်ဒယ်များကို အသုံးပြုသည်
- ချိတ်ဆက်မှုအမှားများ
- Variable များကို မသိရှိနိုင်ခြင်း
...
## ဖွဲ့စည်းမှုကို စမ်းသပ်ခြင်း

### ပတ်ဝန်းကျင်တင်ခြင်းကို စစ်ဆေးပါ
...
## လုံခြုံရေးအကောင်းဆုံးအလေ့အထ

### 1. လျှို့ဝှက်ချက်များကို မပါဝင်စေရန်
...
### 4. ပတ်ဝန်းကျင်အထူးပြုဖွဲ့စည်းမှုကို အသုံးပြုပါ
...
- **API Documentation**: SDK repository တွင် နောက်ဆုံးပေါ်ကို စစ်ဆေးပါ
...
**ဗားရှင်း**: 2.0  
**SDK**: Foundry Local Python SDK (နောက်ဆုံးပေါ်)
