...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:45:57+00:00",
...
1. **Zforkuj repozytorium**: Kliknij [![GitHub forks](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
- **Obniżenia wymagań obliczeniowych**: Optymalizacja pod kątem wydajności CPU i GPU na urządzeniach brzegowych
...
| [🤖 06](../../Module06) | [Agent AI i wywoływanie funkcji](./Module06/README.md) | Ramy agentów i MCP | Wprowadzenie do agentów • Wywoływanie funkcji • Protokół kontekstu modelu | Zaawansowany | 4-5 godz. |
...
**Co zbudujesz:**
- Lokalne aplikacje czatu AI ze wsparciem strumieniowym
- Pipeline RAG z oceną jakości (RAGAS)
- Narzędzia do benchmarkingu i porównania modeli wielomodelowych
...
**Role techniczne**: Architekt rozwiązań EdgeAI • Inżynier ML (Edge) • Programista IoT AI • Programista mobilny AI
