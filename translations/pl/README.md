...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:55:34+00:00",
...
- **Prywatność i bezpieczeństwo**: Przetwarzanie wrażliwych danych lokalnie, bez przesyłania ich do chmury
...
- **Zmniejszenia zapotrzebowania na pamięć**: Efektywne wykorzystanie ograniczonej pamięci urządzeń brzegowych
- **Obniżenia wymagań obliczeniowych**: Optymalizacja dla wydajności CPU i GPU na urządzeniach brzegowych
...
| [📚 01](../../Module01) | [Podstawy EdgeAI](./Module01/README.md) | Porównanie chmury i Edge AI | Podstawy EdgeAI • Przypadki użycia w rzeczywistości • Przewodnik wdrożeniowy • Wdrożenie na urządzeniach brzegowych | Początkujący | 3-4 godz. |
...
**Co zbudujesz:**
- Lokalne aplikacje czatu AI ze wsparciem strumieniowania
- RAG pipeline'y z oceną jakości (RAGAS)
...
- **Architektura Edge AI**: Projektowanie systemów AI z lokalnym priorytetem i integracją z chmurą
...
- **Wieloplatformowe wdrożenie**: Windows, urządzenia mobilne, systemy wbudowane oraz hybrydowe systemy chmurowo-brzegowe  
- **Operacje produkcyjne**: Monitorowanie, skalowanie i utrzymanie AI na brzegu w środowisku produkcyjnym  

### 🏗️ Praktyczne projekty  
- **Foundry Local Chat Apps**: Natywna aplikacja dla Windows 11 z możliwością przełączania modeli  
- **Systemy wieloagentowe**: Koordynator z wyspecjalizowanymi agentami do złożonych procesów  
...
- **Frameworki API**: Klienci gotowi do produkcji z funkcjami strumieniowania i monitorowania stanu  
...
✅ **Wieloplatformowość**: Windows, urządzenia mobilne, systemy wbudowane, hybrydowe chmura-brzeg  
✅ **Gotowość produkcyjna**: Monitorowanie, skalowanie, bezpieczeństwo, ramy zgodności  

📖 **[Dostępny przewodnik nauki](STUDY_GUIDE.md)**: Strukturalna ścieżka nauki na 20 godzin z wytycznymi dotyczącymi alokacji czasu i narzędziami samooceny.  
