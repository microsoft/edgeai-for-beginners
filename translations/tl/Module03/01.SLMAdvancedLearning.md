...
- 🔢 Maunawaan ang mga hangganan ng parameter at klasipikasyon ng Small Language Models.
- 🛠️ Tukuyin ang mga pangunahing teknik sa pag-optimize para sa deployment ng SLM sa edge devices.
- 🚀 Matutunan ang implementasyon ng advanced na quantization at compression strategies para sa SLMs.
...
- **🔬 Micro SLMs**: 100M - 1.4B na parameter (ultra-lightweight para sa mga mobile device)
- **📱 Small SLMs**: 1.5B - 13.9B na parameter (balanse sa performance at kahusayan)
- **⚖️ Medium SLMs**: 14B - 30B na parameter (malapit sa kakayahan ng LLM habang pinapanatili ang kahusayan)
