...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T17:04:51+00:00",
...
![Larawan ng cover ng kurso](../../translated_images/cover.eb18d1b9605d754b30973f4e17c6e11ea4f8473d9686ee378d6e7b44e3c70ac7.tl.png)
...
Maligayang pagdating sa **EdgeAI para sa mga Baguhan** – ang iyong komprehensibong paglalakbay sa makabagong mundo ng Edge Artificial Intelligence. Ang kursong ito ay nag-uugnay sa makapangyarihang kakayahan ng AI at praktikal na paggamit nito sa totoong mundo gamit ang mga edge device, na nagbibigay-daan sa iyo upang magamit ang potensyal ng AI direkta kung saan nalilikha ang data at kailangang gumawa ng mga desisyon.
...
- **Mga estratehiya sa production deployment** para sa mga aplikasyon ng negosyo

### Bakit Mahalaga ang EdgeAI

Ang Edge AI ay isang makabagong pagbabago na tumutugon sa mga kritikal na hamon sa modernong panahon:
- **Privacy at Seguridad**: Iproseso ang sensitibong data nang lokal nang hindi inilalantad sa cloud
- **Real-time na Performance**: Tanggalin ang network latency para sa mga aplikasyon na mahalaga ang oras
...
- **Mas mababang compute demand**: Na-optimize para sa performance ng CPU at edge GPU
...
- **Jupyter Notebooks** (8 interactive) - Step-by-step na tutorials na may benchmarks at performance monitoring
- **Session Guides** - Detalyadong markdown guides para sa bawat session ng workshop
- **Validation Tools** - Mga script para i-verify ang kalidad ng code at magpatakbo ng smoke tests
...
- **Model Optimization**: I-quantize at i-compress ang mga modelo para sa edge deployment (85% na pagbilis, 75% na pagbabawas ng laki)
...
0. **📖 Panimula** ([Introduction.md](./introduction.md)): EdgeAI foundation + konteksto ng industriya + framework ng pag-aaral  
1. **📚 Foundation** (Modules 01-02): Mga konsepto ng EdgeAI + mga pamilya ng modelo ng SLM  
...
4. **💻 Implementation** (Modules 07-08): Mga sample ng platform + Foundry Local toolkit  

Ang bawat module ay may kasamang teorya, mga hands-on na ehersisyo, at mga sample ng code na handa para sa produksyon.  
...
✅ **Mga Tunay na Kaso**: Microsoft, Japan Airlines, mga enterprise implementation  
✅ **Mga Hands-on na Sample**: 50+ na halimbawa, 10 komprehensibong Foundry Local demos  
✅ **Pagtuon sa Performance**: 85% na pagpapabilis, 75% na pagbabawas ng laki  
