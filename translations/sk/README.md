...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T13:01:11+00:00",
...
[![Žiadosti o zlúčenie na GitHub](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
1. **Vytvorte fork repozitára**: Kliknite na [![Forky na GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
Vitajte v **EdgeAI pre začiatočníkov** – vašej komplexnej ceste do transformačného sveta Edge umelej inteligencie. Tento kurz prekladá medzeru medzi výkonnými AI schopnosťami a praktickým, reálnym nasadením na edge zariadeniach, čím vám umožňuje využiť potenciál AI priamo tam, kde sa generujú dáta a kde je potrebné robiť rozhodnutia.

### Čo sa naučíte

Tento kurz vás prevedie od základných konceptov po implementácie pripravené na produkciu, pokrývajúc:
- **Malé jazykové modely (SLM)** optimalizované pre nasadenie na edge
- **Optimalizáciu s ohľadom na hardvér** naprieč rôznymi platformami
- **Reálny čas inferencie** s možnosťami ochrany súkromia
- **Stratégie produkčného nasadenia** pre podnikové aplikácie

### Prečo je EdgeAI dôležité

Edge AI predstavuje paradigmatický posun, ktorý rieši kritické moderné výzvy:
...
- **Súlad s reguláciami**: Splnenie požiadaviek na suverenitu dát

### Edge AI

Edge AI znamená spúšťanie AI algoritmov a jazykových modelov lokálne na hardvéri, blízko miesta generovania dát, bez závislosti na cloudových zdrojoch pre inferenciu. Znižuje latenciu, zvyšuje súkromie a umožňuje rozhodovanie v reálnom čase.
...
- **Suverenita dát**: Uchováva citlivé dáta lokálne, zlepšuje bezpečnosť a súlad
...
| [🧠 02](../../Module02) | [Základy SLM modelov](./Module02/README.md) | Rodiny modelov a architektúra | Rodina Phi • Rodina Qwen • Rodina Gemma • BitNET • μModel • Phi-Silica | Začiatočník | 4-5 hod |
...
| [⚙️ 04](../../Module04) | [Nástroje na optimalizáciu modelov](./Module04/README.md) | Optimalizácia naprieč platformami | Úvod • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Syntéza pracovného postupu | Stredne pokročilý | 5-6 hod |
...
| [🤖 06](../../Module06) | [AI agenti a volanie funkcií](./Module06/README.md) | Agentové rámce a MCP | Úvod do agentov • Volanie funkcií • Protokol kontextu modelu | Pokročilý | 4-5 hod |
| [💻 07](../../Module07) | [Implementácia platformy](./Module07/README.md) | Ukážky naprieč platformami | AI nástroje • Foundry Local • Vývoj pre Windows | Pokročilý | 3-4 hod |
| [🏭 08](../../Module08) | [Foundry Local Toolkit](./Module08/README.md) | Produkčné ukážky | Ukážkové aplikácie (viď nižšie) | Expert | 8-10 hod |
...
- [03: Objavovanie modelov a benchmarkovanie](./Module08/samples/03/README.md)
...
Komplexné materiály na praktický workshop s implementáciami pripravenými na produkciu:

- **[Sprievodca workshopom](./Workshop/Readme.md)** - Kompletné ciele učenia, výsledky a navigácia zdrojov
- **Python ukážky** (6 relácií) - Aktualizované s najlepšími praktikami, spracovaním chýb a komplexnou dokumentáciou
- **Jupyter notebooky** (8 interaktívnych) - Krok za krokom tutoriály s benchmarkmi a monitorovaním výkonu
- **Sprievodcovia reláciami** - Detailné markdown návody pre každú reláciu workshopu
...
- Inteligentné smerovanie modelov s výberom podľa úloh
...
### 🎯 Kľúčové kompetencie
- **Architektúra Edge AI**: Navrhnite lokálne prioritné AI systémy s integráciou cloudu
- **Optimalizácia modelu**: Kvantizácia a kompresia modelov pre nasadenie na okraji siete (85 % zrýchlenie, 75 % zmenšenie veľkosti)
- **Viacplatformové nasadenie**: Windows, mobilné zariadenia, embedded systémy a hybridné cloud-edge systémy
...
- **Routery modelov**: Inteligentný výber medzi modelmi na základe analýzy úlohy
- **API rámce**: Produkčne pripravení klienti so streamovaním a monitorovaním stavu
- **Nástroje pre viac platforiem**: Vzory integrácie LangChain/Semantic Kernel
...
**Odporúčaný učebný plán** (20-30 hodín celkovo):

0. **📖 Úvod** ([Introduction.md](./introduction.md)): Základy EdgeAI + kontext priemyslu + učebný rámec
...
**Priemyselné odvetvia**: Výroba 4.0 • Zdravotnícka technológia • Autonómne systémy • FinTech • Spotrebná elektronika

**Portfólio projektov**: Systémy s viacerými agentmi • Produkčné RAG aplikácie • Viacplatformové nasadenie • Optimalizácia výkonu
...
✅ **Reálne prípadové štúdie**: Microsoft, Japan Airlines, implementácie v podnikoch  
✅ **Praktické ukážky**: 50+ príkladov, 10 komplexných demo aplikácií Foundry Local  
✅ **Zameranie na výkon**: 85 % zlepšenie rýchlosti, 75 % zmenšenie veľkosti  
✅ **Viacplatfromové**: Windows, mobilné zariadenia, embedded, cloud-edge hybrid  
✅ **Produkčne pripravené**: Monitorovanie, škálovanie, bezpečnosť, rámce súladu

📖 **[Dostupný študijný sprievodca](STUDY_GUIDE.md)**: Štruktúrovaný 20-hodinový učebný plán s odporúčaním časového rozdelenia a nástrojmi na sebahodnotenie.

---

**EdgeAI predstavuje budúcnosť nasadenia AI**: lokálne, s ochranou súkromia a efektívne. Ovládnite tieto zručnosti a vytvorte ďalšiu generáciu inteligentných aplikácií.
