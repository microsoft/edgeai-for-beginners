...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:44:49+00:00",
...
- **پرائیویسی اور سیکیورٹی**: حساس ڈیٹا کو مقامی طور پر پراسیس کریں، بغیر کلاؤڈ کے
- **ریئل ٹائم پرفارمنس**: وقت کے حساس ایپلیکیشنز کے لیے نیٹ ورک لیٹنسی ختم کریں
...
ایج اے آئی کا مطلب ہے کہ اے آئی الگورتھمز اور زبان کے ماڈلز کو مقامی طور پر ہارڈویئر پر چلانا، جہاں ڈیٹا جنریٹ ہوتا ہے، بغیر کلاؤڈ وسائل پر انحصار کیے۔ یہ لیٹنسی کو کم کرتا ہے، پرائیویسی کو بہتر بناتا ہے، اور ریئل ٹائم فیصلے کرنے کی صلاحیت فراہم کرتا ہے۔
...
- **IoT ڈیوائسز**: سینسرز اور اسمارٹ ڈیوائسز کے ساتھ محدود وسائل
- **ایج سرورز**: مقامی پراسیسنگ یونٹس کے ساتھ محدود GPU وسائل
...
| [🚀 03](../../Module03) | [SLM ڈیپلائمنٹ پریکٹس](./Module03/README.md) | مقامی اور کلاؤڈ ڈیپلائمنٹ | اعلیٰ سیکھنا • مقامی ماحول • کلاؤڈ ڈیپلائمنٹ | درمیانی | 4-5 گھنٹے |
...
- **پائتھون نمونے** (6 سیشنز) - بہترین طریقوں، ایرر ہینڈلنگ، اور جامع دستاویزات کے ساتھ اپ ڈیٹ شدہ
- **Jupyter نوٹ بکس** (8 انٹرایکٹو) - مرحلہ وار ٹیوٹوریلز کے ساتھ بینچ مارکس اور پرفارمنس مانیٹرنگ
- **سیشن گائیڈز** - ہر ورکشاپ سیشن کے لیے تفصیلی مارک ڈاؤن گائیڈز
- **ویلیڈیشن ٹولز** - کوڈ کوالٹی کی تصدیق کرنے اور اسموک ٹیسٹ چلانے کے اسکرپٹس

**آپ کیا بنائیں گے:**
- مقامی AI چیٹ ایپلیکیشنز کے ساتھ اسٹریمنگ سپورٹ
- RAG پائپ لائنز کے ساتھ کوالٹی ایویلیوایشن (RAGAS)
- ملٹی ماڈل بینچ مارکنگ اور موازنہ ٹولز
- ملٹی ایجنٹ آرکیسٹریشن سسٹمز
- ذہین ماڈل روٹنگ کے ساتھ ٹاسک پر مبنی انتخاب
...
### 🎯 بنیادی صلاحیتیں
- **ایج اے آئی آرکیٹیکچر**: مقامی-پہلے AI سسٹمز کو کلاؤڈ انٹیگریشن کے ساتھ ڈیزائن کریں
...
### 🏗️ عملی منصوبے  
- **فاؤنڈری لوکل چیٹ ایپس**: ونڈوز 11 کے لیے نیٹو ایپلیکیشن، ماڈل سوئچنگ کے ساتھ  
- **ملٹی ایجنٹ سسٹمز**: کوآرڈینیٹر اور ماہر ایجنٹس کے ذریعے پیچیدہ ورک فلو  
- **RAG ایپلیکیشنز**: لوکل ڈاکیومنٹ پروسیسنگ، ویکٹر سرچ کے ساتھ  
...
✅ **ترقی پسند لرننگ**: تھیوری → عملی تجربہ → پروڈکشن ڈیپلائمنٹ  
...
✅ **پروڈکشن کے لیے تیار**: نگرانی، اسکیلنگ، سیکیورٹی، کمپلائنس فریم ورک  

📖 **[مطالعہ گائیڈ دستیاب ہے](STUDY_GUIDE.md)**: 20 گھنٹے کا منظم لرننگ پاتھ، وقت کی تقسیم کی رہنمائی اور خود تشخیصی ٹولز کے ساتھ۔  

---

**ایج AI مستقبل کی AI ڈیپلائمنٹ کی نمائندگی کرتا ہے**: لوکل فرسٹ، پرائیویسی کو محفوظ رکھنے والا، اور مؤثر۔ ان مہارتوں کو سیکھیں تاکہ اگلی نسل کی ذہین ایپلیکیشنز بنائی جا سکیں۔  
...
اگر آپ کو کسی مسئلے کا سامنا ہو یا AI ایپلیکیشنز بنانے کے بارے میں سوالات ہوں، تو شامل ہوں:  

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)  

اگر آپ کو پروڈکٹ کے بارے میں فیڈبیک دینا ہو یا بلڈنگ کے دوران کوئی غلطی ہو تو وزٹ کریں:  
