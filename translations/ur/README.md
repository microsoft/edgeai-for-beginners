...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T08:26:45+00:00",
...
ایج AI ایک نیا نظریہ ہے جو جدید چیلنجز کو حل کرتا ہے:
- **رازداری اور سیکیورٹی**: حساس ڈیٹا کو مقامی طور پر بغیر کلاؤڈ کے افشاء کے پروسیس کریں
...
### بنیادی اصول:
- **ڈیوائس پر انفرنس**: AI ماڈلز ایج ڈیوائسز (فونز، راؤٹرز، مائیکرو کنٹرولرز، صنعتی پی سیز) پر چلتے ہیں
...
SLMs جیسے Phi-4، Mistral-7B، اور Gemma بڑے LLMs کے بہتر کیے گئے ورژن ہیں—جو تربیت یافتہ یا مختصر کیے گئے ہیں تاکہ:
- **کم میموری کا استعمال**: محدود ایج ڈیوائس میموری کا مؤثر استعمال
- **کم کمپیوٹ کی ضرورت**: CPU اور ایج GPU کی کارکردگی کے لیے بہتر
- **تیز آغاز کے اوقات**: فوری شروعات برائے جوابدہ ایپلیکیشنز

یہ طاقتور NLP صلاحیتوں کو کھولتے ہیں جبکہ درج ذیل پابندیوں کو پورا کرتے ہیں:
- **ایمبیڈڈ سسٹمز**: IoT ڈیوائسز اور صنعتی کنٹرولرز
- **موبائل ڈیوائسز**: اسمارٹ فونز اور ٹیبلیٹس جن میں آف لائن صلاحیتیں ہیں
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [ایج اے آئی کا تعارف](./introduction.md) | بنیاد اور سیاق و سباق | ایج اے آئی کا جائزہ • صنعتی ایپلیکیشنز • SLM تعارف • سیکھنے کے مقاصد | ابتدائی | 1-2 گھنٹے |
| [📚 01](../../Module01) | [ایج اے آئی کے بنیادی اصول](./Module01/README.md) | کلاؤڈ بمقابلہ ایج AI موازنہ | ایج اے آئی کے بنیادی اصول • حقیقی دنیا کے کیس اسٹڈیز • نفاذ کی رہنمائی • ایج تعیناتی | ابتدائی | 3-4 گھنٹے |
| [🧠 02](../../Module02) | [SLM ماڈل کی بنیادیں](./Module02/README.md) | ماڈل خاندان اور فن تعمیر | فی خاندان • کوین خاندان • جیما خاندان • بٹ نیٹ • μماڈل • فی-سیلیکا | ابتدائی | 4-5 گھنٹے |
...
- ملٹی ماڈل بینچ مارکنگ اور موازنہ کے اوزار
...
- **اعلی راستہ**: ماڈیولز 05-07 (12-15 گھنٹے)
- **ماہر راستہ**: ماڈیول 08 (8-10 گھنٹے)

## آپ کیا بنائیں گے

### 🎯 بنیادی مہارتیں
- **ایج AI فن تعمیر**: کلاؤڈ انٹیگریشن کے ساتھ مقامی اولین AI نظام ڈیزائن کریں
