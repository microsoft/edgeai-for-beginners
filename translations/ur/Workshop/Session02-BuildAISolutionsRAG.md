...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-17T18:34:40+00:00",
...
- **لوکل سے کلاؤڈ تک پل بنائیں**: Foundry Local سے Azure AI Foundry تک منتقلی کے راستے کو سمجھیں
...
1. **سیشن 3 کو دریافت کریں**: Foundry Local میں اوپن سورس ماڈلز
...
5. **RAG معیار کا جائزہ لیں**: `cd Workshop/samples;python -m session02.rag_eval_ragas` چلائیں تاکہ ragas کا استعمال کرتے ہوئے جواب کی مطابقت، وفاداری، اور سیاق و سباق کی درستگی کی پیمائش کی جا سکے

### اختیاری بہتریاں

| زمرہ | بہتری | وجہ | سمت |
|----------|-------------|-----------|-----------|
| بازیافت | TF-IDF کو ویکٹر اسٹور (FAISS / Chroma) سے تبدیل کریں | بہتر معنوی یادداشت اور توسیع پذیری | دستاویزات کو چنک کریں (500–800 حروف)، ایمبیڈ کریں، انڈیکس کو محفوظ کریں |
| ہائبرڈ انڈیکس | دوہری معنوی + کلیدی لفظ فلٹرنگ | عددی / کوڈ سوالات پر درستگی کو بہتر بناتا ہے | کلیدی لفظ کے ذریعے فلٹر کریں پھر کوسائن مماثلت کے ذریعے رینک کریں |
...
| مانیٹرنگ | تشخیصی رن کی تاریخ کو محفوظ کریں | رجریشن کا پتہ لگانا | JSON لائنز کو ٹائم اسٹیمپ + میٹرک ڈیلٹاس کے ساتھ شامل کریں |
...
4. رجحان کے تجزیے کے لیے میٹرکس (CSV/JSON) کو محفوظ کریں۔
...
| ورکشاپ اسکرپٹ / نوٹ بک | منظرنامہ | مقصد | بنیادی ڈیٹاسیٹ / ذریعہ | مثال سوال |
|----------------------------|----------|------|-----------------------|------------------|
...
| `csv_qa_system.py` | سیلز آپریشنز جو ایکسپورٹس پر انٹرایکٹو تجزیات کو تلاش کر رہا ہے | چھوٹے سیلز سلائس کا خلاصہ اور سوال کریں | تیار کردہ `sample_sales_data.csv` (10 قطاریں) | کون سا پروڈکٹ سب سے زیادہ اوسط سیلز رقم رکھتا ہے؟ |
...
| `migration_guide.py` | آرکیٹیکٹ جو کلاؤڈ منتقلی کا منصوبہ تیار کر رہا ہے | لوکل→Azure API parity کو ظاہر کریں | جامد ٹیسٹ پرامپٹس | Edge AI کے فوائد کو 2–3 جملوں میں بیان کریں۔ |

### ڈیٹاسیٹ کے اقتباسات
Inline RAG پائپ لائن ڈاک فہرست:
```python
DOCS = [
