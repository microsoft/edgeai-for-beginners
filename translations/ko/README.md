...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:49:04+00:00",
...
**EdgeAI for Beginners**에 오신 것을 환영합니다. 이 과정은 강력한 AI 기능과 엣지 디바이스에서의 실질적인 배포를 연결하여 데이터를 생성하고 결정을 내려야 하는 곳에서 AI의 잠재력을 활용할 수 있도록 돕는 포괄적인 여정을 제공합니다.

### 학습 목표

이 과정은 기초 개념부터 실무 구현까지 다루며 다음을 포함합니다:
...
| [📚 01](../../Module01) | [EdgeAI 기본](./Module01/README.md) | 클라우드와 엣지 AI 비교 | EdgeAI 기본 • 실제 사례 연구 • 구현 가이드 • 엣지 배포 | 초급 | 3-4 시간 |
...
| [🏭 08](../../Module08) | [Foundry Local Toolkit](./Module08/README.md) | 생산 준비 샘플 | 샘플 애플리케이션 (아래 세부 정보 참조) | 전문가 | 8-10 시간 |
...
- **멀티 플랫폼 배포**: Windows, 모바일, 임베디드, 클라우드-엣지 하이브리드 시스템
- **프로덕션 운영**: 프로덕션 환경에서 엣지 AI의 모니터링, 확장 및 유지 관리

### 🏗️ 실습 프로젝트
- **Foundry 로컬 채팅 앱**: Windows 11 네이티브 애플리케이션, 모델 전환 기능 포함
- **멀티 에이전트 시스템**: 복잡한 워크플로를 위한 전문 에이전트와 조정자
- **RAG 애플리케이션**: 벡터 검색을 활용한 로컬 문서 처리
- **모델 라우터**: 작업 분석을 기반으로 한 모델 지능형 선택
...
**기술 직군**: 엣지 AI 솔루션 아키텍트 • ML 엔지니어 (엣지) • IoT AI 개발자 • 모바일 AI 개발자
...
✅ **실제 사례 연구**: Microsoft, 일본항공, 기업 구현 사례  
✅ **핸즈온 샘플**: 50개 이상의 예제, 10개의 포괄적인 Foundry Local 데모  
...
AI 애플리케이션 구축 중 어려움이 있거나 질문이 있다면 다음을 방문하세요:
