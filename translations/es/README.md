...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:30:53+00:00",
...
1. **Haz un Fork del Repositorio**: Haz clic en [![Forks de GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
Bienvenido a **EdgeAI para Principiantes** – tu viaje completo hacia el mundo transformador de la Inteligencia Artificial en el Borde. Este curso cierra la brecha entre las poderosas capacidades de IA y el despliegue práctico en dispositivos edge, permitiéndote aprovechar el potencial de la IA directamente donde se generan los datos y se deben tomar decisiones.
