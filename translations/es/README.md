...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T14:24:48+00:00",
...
[![Incidencias de GitHub](https://img.shields.io/github/issues/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/issues)
[![Solicitudes de extracción de GitHub](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
1. **Haz un fork del repositorio**: Haz clic en [![Bifurcaciones de GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
Bienvenido a **EdgeAI para Principiantes** – tu viaje completo hacia el mundo transformador de la Inteligencia Artificial en el borde. Este curso cierra la brecha entre las potentes capacidades de IA y el despliegue práctico en dispositivos edge, permitiéndote aprovechar el potencial de la IA directamente donde se generan los datos y se deben tomar decisiones.
...
| [🤖 06](../../Module06) | [Agentes de IA y Llamadas a Funciones](./Module06/README.md) | Marcos de agentes y MCP | Introducción a agentes • Llamadas a funciones • Protocolo de contexto de modelo | Avanzado | 4-5 hrs |
...
- [01: Inicio rápido de chat REST](./Module08/samples/01/README.md)
...
- [08: Aplicación de Chat Windows 11](./Module08/samples/08/README.md)
...
- **Herramientas de Validación** - Scripts para verificar calidad de código y ejecutar pruebas básicas
...
- **Ruta experto**: Módulo 08 (8-10 horas)

## Lo que construirás

### 🎯 Competencias clave
- **Arquitectura Edge AI**: Diseña sistemas de IA con enfoque local y con integración en la nube
- **Optimización de Modelos**: Cuantización y compresión de modelos para despliegue en el borde (85% de aumento de velocidad, 75% de reducción de tamaño)  
- **Despliegue Multiplataforma**: Windows, móvil, sistemas embebidos e híbridos nube-borde  
- **Operaciones en Producción**: Monitoreo, escalado y mantenimiento de IA en el borde en producción  

### 🏗️ Proyectos Prácticos  
- **Aplicaciones de Chat Local Foundry**: Aplicación nativa para Windows 11 con cambio de modelos  
- **Sistemas Multi-Agente**: Coordinador con agentes especialistas para flujos de trabajo complejos  
...
4. **💻 Implementación** (Módulos 07-08): Ejemplos de plataforma + kit de herramientas Foundry Local  
...
📖 **[Guía de Estudio Disponible](STUDY_GUIDE.md)**: Ruta de aprendizaje estructurada de 20 horas con guía de asignación de tiempo y herramientas de autoevaluación.  
