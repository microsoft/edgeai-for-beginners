...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-12T00:49:51+00:00",
...
| 06 | `models_router.py` | Маршрутизація намірів | ~45с |
...
1. **Кешуйте клієнтів**: `workshop_utils` автоматично кешує для вас
...
**Швидка допомога**: Запустіть будь-який зразок з `--help` у каталозі `samples` або перегляньте docstring:
```bash
