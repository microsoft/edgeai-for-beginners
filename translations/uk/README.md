...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:00:12+00:00",
...
- **Меншого обчислювального навантаження**: оптимізовані для продуктивності CPU та периферійних GPU
...
### 🎓 **Майстер-клас: Практичний шлях навчання**

Всебічні матеріали майстер-класу з готовими до виробництва реалізаціями:

- **[Посібник майстер-класу](./Workshop/Readme.md)** - Повні цілі навчання, результати та навігація ресурсами
...
- **Посібники сесій** - Детальні markdown посібники для кожної сесії майстер-класу
...
- **Рівень експерта**: Модуль 08 (8-10 год)

## Що ви створите

### 🎯 Основні компетенції
- **Архітектура Edge AI**: Проєктування локально-орієнтованих AI систем з інтеграцією хмари
...
📖 **[Доступний навчальний посібник](STUDY_GUIDE.md)**: Структурований 20-годинний навчальний шлях з рекомендаціями по часу та інструментами самооцінки.
