...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T18:14:52+00:00",
...
[![Запити на витяг GitHub](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
Ласкаво просимо до **EdgeAI для початківців** – вашої комплексної подорожі у трансформаційний світ Edge Artificial Intelligence. Цей курс об'єднує потужні можливості штучного інтелекту з практичним впровадженням у реальному світі на пристроях, дозволяючи використовувати потенціал ШІ безпосередньо там, де генерується дані та приймаються рішення.

### Чого ви навчитеся

Цей курс охоплює шлях від базових концепцій до готових до виробництва реалізацій, включаючи:
...
- **Реальний час інференції** з можливостями збереження конфіденційності
...
- **Стійкість роботи**: Збереження функціональності під час відключень мережі
- **Відповідність регуляторним вимогам**: Дотримання вимог щодо суверенітету даних

### Edge AI

Edge AI означає виконання алгоритмів ШІ та мовних моделей локально на апаратному забезпеченні, близько до місця, де генеруються дані, без залежності від хмарних ресурсів для інференції. Це зменшує затримки, покращує конфіденційність і дозволяє приймати рішення в реальному часі.

### Основні принципи:
- **Інференція на пристрої**: Моделі ШІ працюють на пристроях (телефонах, маршрутизаторах, мікроконтролерах, промислових ПК)
- **Офлайн-можливості**: Функціонує без постійного підключення до інтернету
...
SLMs, такі як Phi-4, Mistral-7B і Gemma, є оптимізованими версіями більших LLMs, навченими або дистильованими для:
- **Зменшеного обсягу пам'яті**: Ефективне використання обмеженої пам'яті пристроїв
- **Менших вимог до обчислень**: Оптимізовані для продуктивності CPU та edge GPU
...
- **Edge-серверів**: Локальних обчислювальних блоків з обмеженими GPU-ресурсами
...
| [📚 01](../../Module01) | [Основи EdgeAI](./Module01/README.md) | Порівняння хмари та Edge AI | Основи EdgeAI • Реальні кейси • Посібник з реалізації • Розгортання на пристроях | Початковий | 3-4 год |
...
| [💻 07](../../Module07) | [Реалізація на платформах](./Module07/README.md) | Кросплатформні приклади | Інструментарій AI • Foundry Local • Розробка для Windows | Просунутий | 3-4 год |
| [🏭 08](../../Module08) | [Інструментарій Foundry Local](./Module08/README.md) | Готові до виробництва приклади | Зразки застосувань (див. деталі нижче) | Експерт | 8-10 год |

### 🏭 **Модуль 08: Зразки застосувань**
...
Комплексні матеріали для практичного воркшопу з готовими до виробництва реалізаціями:

- **[Посібник з воркшопу](./Workshop/Readme.md)** - Повні навчальні цілі, результати та навігація по ресурсах
- **Зразки Python** (6 сесій) - Оновлені з найкращими практиками, обробкою помилок та повною документацією
- **Jupyter Notebooks** (8 інтерактивних) - Покрокові підручники з бенчмарками та моніторингом продуктивності
- **Посібники для сесій** - Детальні посібники у форматі markdown для кожної сесії воркшопу
- **Інструменти валідації** - Скрипти для перевірки якості коду та тестування

**Що ви створите:**
- Локальні чат-додатки зі стрімінговою підтримкою
...
### 🎯 Основні компетенції
- **Архітектура Edge AI**: Проектування локальних систем ШІ з інтеграцією хмари
- **Оптимізація моделей**: Квантизація та стиснення моделей для розгортання на пристроях (прискорення на 85%, зменшення розміру на 75%)
- **Кросплатформне розгортання**: Windows, мобільні пристрої, вбудовані системи та гібридні хмарно-пристрій системи
- **Операції у виробництві**: Моніторинг, масштабування та підтримка Edge AI у виробничих середовищах
...
- **API-фреймворки**: Клієнти, готові до виробництва, зі стрімінгом і моніторингом стану
