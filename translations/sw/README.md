...
#### Inayoungwa mkono kupitia Hatua ya GitHub (Imejiendesha & Inasasishwa Kila Wakati)
...
**Ikiwa ungependa lugha za ziada za tafsiri, lugha zinazoungwa mkono zimeorodheshwa [hapa](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**

## Utangulizi

Karibu kwenye **EdgeAI kwa Kompyuta** – safari yako ya kina katika ulimwengu wa mabadiliko wa Akili Bandia ya Edge. Kozi hii inajenga daraja kati ya uwezo wa AI wenye nguvu na utekelezaji wa vitendo wa ulimwengu halisi kwenye vifaa vya edge, ikikuwezesha kutumia uwezo wa AI moja kwa moja pale data inapotengenezwa na maamuzi yanapohitajika kufanywa.
...
SLMs kama Phi-4, Mistral-7B, na Gemma ni matoleo yaliyoboreshwa ya LLMs kubwa—yaliyofundishwa au kupunguzwa kwa:
...
| [⚙️ 04](../../Module04) | [Zana ya Uboreshaji wa Mfano](./Module04/README.md) | Uboreshaji wa majukwaa mbalimbali | Utangulizi • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Muundo wa Kazi | Kati | 5-6 hrs |
...
| [💻 07](../../Module07) | [Utekelezaji wa Jukwaa](./Module07/README.md) | Sampuli za majukwaa mbalimbali | Zana za AI • Foundry Local • Maendeleo ya Windows | Juu | 3-4 hrs |
| [🏭 08](../../Module08) | [Zana ya Foundry Local](./Module08/README.md) | Sampuli tayari kwa uzalishaji | Programu za sampuli (angalia maelezo hapa chini) | Mtaalamu | 8-10 hrs |

### 🏭 **Moduli 08: Programu za Sampuli**

- [01: Mwanzo wa Haraka wa REST Chat](./Module08/samples/01/README.md)
- [02: Ujumuishaji wa SDK ya OpenAI](./Module08/samples/02/README.md)
...
- **Sampuli za Python** (vikao 6) - Zimesasishwa na mbinu bora, utunzaji wa makosa, na nyaraka za kina
- **Notebooks za Jupyter** (8 za maingiliano) - Mafunzo ya hatua kwa hatua na upimaji wa utendaji
...
- **Utekelezaji wa Majukwaa Mengi**: Windows, rununu, vifaa vilivyojengwa, na mifumo ya mseto ya wingu-edge
...
**Utengenezaji** • **Huduma za Afya** • **Magari ya Kujitegemea** • **Miji Mahiri** • **Programu za Simu**

## Kuanza Haraka

**Njia ya Kujifunza Iliyopendekezwa** (jumla ya saa 20-30):
...
**Miradi ya Portfolio**: Mfumo wa mawakala wengi • Programu za RAG za uzalishaji • Uwekaji wa msalaba-jukwaa • Uboreshaji wa utendaji
...
✅ **Kuzingatia Utendaji**: Uboreshaji wa kasi wa 85%, upunguzaji wa ukubwa wa 75%  
✅ **Msalaba-Jukwaa**: Windows, simu, vifaa vilivyowekwa, mseto wa ukingo wa wingu  
✅ **Tayari kwa Uzalishaji**: Ufuatiliaji, upanuzi, mifumo ya usalama, na uzingatiaji
...
**EdgeAI inawakilisha mustakabali wa uwekaji wa AI**: wa ndani kwanza, unaohifadhi faragha, na wenye ufanisi. Jifunze ujuzi huu ili kujenga kizazi kijacho cha programu za akili.
...
[![Sayansi ya Data kwa Kompyuta](https://img.shields.io/badge/Sayansi%20ya%20Data%20kwa%20Kompyuta-84CC16?style=for-the-badge&labelColor=E5E7EB&color=84CC16)](https://aka.ms/datascience-beginners?WT.mc_id=academic-105485-koreyst)
