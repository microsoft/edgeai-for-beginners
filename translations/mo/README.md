...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:30:25+00:00",
...
歡迎來到 **初學者的邊緣人工智能課程**——這是一個全面的旅程，帶您進入邊緣人工智能的變革世界。本課程將強大的人工智能能力與實際的邊緣設備部署相結合，幫助您直接在數據生成和需要決策的地方發揮人工智能的潛力。
...
邊緣人工智能指的是在硬件上本地運行人工智能算法和語言模型，靠近數據生成的地方，而不依賴雲端資源進行推理。它減少了延遲，增強了隱私，並支持實時決策。

### 核心原則：
- **設備上的推理**：人工智能模型在邊緣設備（手機、路由器、微控制器、工業電腦）上運行
- **離線能力**：無需持續的互聯網連接即可運行
- **低延遲**：即時響應，適合實時系統
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [邊緣人工智能簡介](./introduction.md) | 基礎與背景 | 邊緣人工智能概述 • 行業應用 • SLM 簡介 • 學習目標 | 初學者 | 1-2 小時 |
| [📚 01](../../Module01) | [邊緣人工智能基礎](./Module01/README.md) | 雲端與邊緣人工智能比較 | 邊緣人工智能基礎 • 真實案例研究 • 實施指南 • 邊緣部署 | 初學者 | 3-4 小時 |
...
| [🤖 06](../../Module06) | [人工智能代理與功能調用](./Module06/README.md) | 代理框架與 MCP | 代理簡介 • 功能調用 • 模型上下文協議 | 高級 | 4-5 小時 |
| [💻 07](../../Module07) | [平台實施](./Module07/README.md) | 跨平台示例 | 人工智能工具包 • Foundry Local • Windows 開發 | 高級 | 3-4 小時 |
...
- **RAG 應用程式**：本地文件處理與向量搜索  
- **模型路由器**：基於任務分析的智能模型選擇  
- **API 框架**：具備流式傳輸與健康監控的生產就緒客戶端  
...
4. **💻 實施**（模組07-08）：平台範例 + Foundry 本地工具包  

每個模組包含理論、實操練習及生產就緒的代碼範例。

## 職業影響

**技術角色**：邊緣AI解決方案架構師 • 機器學習工程師（邊緣） • 物聯網AI開發者 • 移動AI開發者  

**行業領域**：製造業4.0 • 醫療科技 • 自主系統 • 金融科技 • 消費電子  

**作品集項目**：多代理系統 • 生產RAG應用程式 • 跨平台部署 • 性能優化  
...
**邊緣AI代表了AI部署的未來**：本地優先、保護隱私、高效能。掌握這些技能，打造下一代智能應用程式。
