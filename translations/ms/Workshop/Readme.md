...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T23:50:28+00:00",
...
4. **Optimalkan Prestasi Model**
   ...
   - Pilih model optimum berdasarkan kompromi kelajuan/kualiti
...
5. **Orkestrasi Sistem Multi-Agent**
   ...
   - Laluan permintaan secara pintar merentasi pelbagai model
...
| **Pertengahan** | ✅ Ulasan pantas | ✅ Pembelajaran teras | ⚠️ Matlamat regangan |
| **Maju** | ✅ Mudah dilalui | ✅ Penapisan | ✅ Corak pengeluaran |
...
- Aplikasi mudah alih yang berorientasi offline
...
#### 2. Clone Repository & Pasang Kebergantungan
...
| 5 | [`session05_agents_orchestrator.ipynb`](./notebooks/session05_agents_orchestrator.ipynb) | Orkestrasi agen | ⭐⭐⭐ Maju |
| 6 | [`session06_models_router.ipynb`](./notebooks/session06_models_router.ipynb) | Laluan niat | ⭐⭐⭐ Maju |
| 6 | [`session06_models_pipeline.ipynb`](./notebooks/session06_models_pipeline.ipynb) | Orkestrasi pipeline | ⭐⭐⭐ Maju |
...
| [QUICK_REFERENCE.md](./QUICK_REFERENCE.md) | Lembaran rujukan arahan & API | Perlukan jawapan pantas |
...
### Untuk Pengamal Maju (2-3 jam)
1. ⚡ Sesi 1-3: Ulasan dan pengesahan pantas
2. ✅ Sesi 4: Pengoptimuman mendalam
3. ✅ Sesi 5: Seni bina multi-agent
4. ✅ Sesi 6: Corak pengeluaran dan skalabiliti
5. 🚀 Lanjutkan: Bina logik laluan tersuai dan pelancaran hibrid
...
| 2 | [Session02-BuildAISolutionsRAG](./Session02-BuildAISolutionsRAG.md) | Kejuruteraan prompt, corak RAG, CSV & dokumen asas, migrasi |
...
| 6 | [Session06-ModelsAsTools](./Session06-ModelsAsTools.md) | Penghalaan, penggabungan, skala laluan ke Azure |
...
| `RETRY_BACKOFF` | Saat untuk menunggu sebelum mencuba semula | `1.0` |
...
Jangka penggunaan token yang stabil merentasi input yang sama berulang.
...
| Perkhidmatan | `foundry service status` | Tunjukkan status perkhidmatan |
...
- Penggunaan sumber: pemantau OS (Task Manager, Activity Monitor, `nvidia-smi`).

Apabila perintah telemetri CLI baru stabil, ia boleh dimasukkan dengan pengeditan minimum pada markdown sesi.
...
| Senaraikan katalog | `foundry model list` | `# gunakan pengurus untuk setiap alias atau mengekalkan senarai yang diketahui` | CLI mengagregat; SDK kini per-alias inisialisasi |
...
| Ukur kependaman | `python -m session03.benchmark_oss_models` | `import benchmark_oss_models` (atau skrip pengeksport baru) | Lebih suka skrip untuk metrik yang konsisten |
...
| `benchmark_report.json` | Susunan metrik mentah (untuk perbezaan / penjejakan trend) |
