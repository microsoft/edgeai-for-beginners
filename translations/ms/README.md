...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T15:50:55+00:00",
...
Kursus ini membawa anda dari konsep asas ke pelaksanaan sedia produksi, merangkumi:
- **Model Bahasa Kecil (SLMs)** yang dioptimumkan untuk pelaksanaan edge
- **Pengoptimuman sedar perkakasan** merentasi pelbagai platform
...
- [06: Penghala Model-sebagai-Alat](./Module08/samples/06/README.md)
...
- **Pengoptimuman Model**: Kuantisasi dan mampatan model untuk penghantaran tepi (peningkatan kelajuan 85%, pengurangan saiz 75%)
- **Penghantaran Pelbagai Platform**: Windows, mudah alih, terbenam, dan sistem hibrid awan-tepi
...
2. **⚙️ Pengoptimuman** (Modul 03-04): Penghantaran + rangka kerja kuantisasi  
...
**Projek Portfolio**: Sistem multi-ejen • Aplikasi RAG pengeluaran • Penghantaran rentas platform • Pengoptimuman prestasi
...
✅ **Pembelajaran Progresif**: Teori → Amalan → Penghantaran pengeluaran  
...
📖 **[Panduan Belajar Tersedia](STUDY_GUIDE.md)**: Laluan pembelajaran 20 jam berstruktur dengan panduan pembahagian masa dan alat penilaian kendiri.

---

**EdgeAI mewakili masa depan penghantaran AI**: keutamaan tempatan, pemeliharaan privasi, dan cekap. Kuasai kemahiran ini untuk membina generasi seterusnya aplikasi pintar.
