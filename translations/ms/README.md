...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-25T00:39:20+00:00",
...
[![Permintaan Tarikan GitHub](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
1. **Fork Repositori**: Click [![Fork GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
**Jika anda ingin menyokong bahasa terjemahan tambahan, bahasa yang disokong disenaraikan [di sini](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
## Pengenalan

Selamat datang ke **EdgeAI for Beginners** – perjalanan komprehensif anda ke dalam dunia transformatif Kecerdasan Buatan Edge. Kursus ini merapatkan jurang antara kebolehan AI yang berkuasa dan penyebaran praktikal dalam dunia sebenar pada peranti edge, membolehkan anda memanfaatkan potensi AI terus di tempat data dihasilkan dan keputusan perlu dibuat.

### Apa yang Akan Anda Kuasai

Kursus ini membawa anda dari konsep asas ke pelaksanaan sedia untuk pengeluaran, meliputi:
- **Model Bahasa Kecil (SLMs)** yang dioptimumkan untuk penyebaran di edge
- **Pengoptimuman mengikut perkakasan** merentasi pelbagai platform
- **Inferens masa nyata** dengan keupayaan pemeliharaan privasi
- **Strategi penyebaran pengeluaran** untuk aplikasi perusahaan
...
- **Operasi Tahan Banting**: Mengekalkan fungsi semasa gangguan rangkaian
- **Pematuhan Peraturan**: Memenuhi keperluan kedaulatan data

### Edge AI

Edge AI merujuk kepada menjalankan algoritma AI dan model bahasa secara tempatan pada perkakasan, berhampiran tempat data dihasilkan tanpa bergantung pada sumber awan untuk inferens. Ia mengurangkan kelewatan, meningkatkan privasi, dan membolehkan pembuatan keputusan masa nyata.

### Prinsip Teras:
- **Inferens pada peranti**: Model AI dijalankan pada peranti edge (telefon, router, mikropengawal, PC industri)
...
SLMs seperti Phi-4, Mistral-7B, dan Gemma adalah versi dioptimumkan bagi LLM yang lebih besar—dilatih atau didistilasi untuk:
- **Jejak memori yang dikurangkan**: Penggunaan memori peranti edge yang terhad dengan cekap
- **Permintaan pengiraan yang lebih rendah**: Dioptimumkan untuk prestasi CPU dan GPU edge
- **Masa permulaan lebih pantas**: Inisialisasi cepat untuk aplikasi yang responsif

Mereka membuka kebolehan NLP yang berkuasa sambil memenuhi kekangan:
...
- **Komputer Peribadi**: Senario penyebaran desktop dan komputer riba

## Modul Kursus & Navigasi

| Modul | Topik | Bidang Fokus | Kandungan Utama | Tahap | Tempoh |
|--------|-------|------------|-------------|--------|----------|
...
| [📚 01](../../Module01) | [Asas EdgeAI](./Module01/README.md) | Perbandingan Awan vs Edge AI | Asas EdgeAI • Kajian Kes Dunia Sebenar • Panduan Pelaksanaan • Penyebaran Edge | Pemula | 3-4 jam |
| [🧠 02](../../Module02) | [Asas Model SLM](./Module02/README.md) | Keluarga model & seni bina | Phi Family • Qwen Family • Gemma Family • BitNET • μModel • Phi-Silica | Pemula | 4-5 jam |
| [🚀 03](../../Module03) | [Amali Penyebaran SLM](./Module03/README.md) | Penyebaran tempatan & awan | Pembelajaran Lanjutan • Persekitaran Tempatan • Penyebaran Awan | Pertengahan | 4-5 jam |
| [⚙️ 04](../../Module04) | [Set Alat Pengoptimuman Model](./Module04/README.md) | Pengoptimuman rentas-platform | Pengenalan • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Sintesis Aliran Kerja | Pertengahan | 5-6 jam |
| [🔧 05](../../Module05) | [Pengeluaran SLMOps](./Module05/README.md) | Operasi pengeluaran | Pengenalan SLMOps • Distilasi Model • Penalaan Halus • Penyebaran Pengeluaran | Lanjutan | 5-6 jam |
...
| [💻 07](../../Module07) | [Pelaksanaan Platform](./Module07/README.md) | Contoh rentas-platform | Kit Alat AI • Foundry Tempatan • Pembangunan Windows | Lanjutan | 3-4 jam |
| [🏭 08](../../Module08) | [Set Alat Foundry Tempatan](./Module08/README.md) | Contoh sedia-pengeluaran | Aplikasi contoh (lihat butiran di bawah) | Pakar | 8-10 jam |

### 🏭 **Modul 08: Aplikasi Contoh**

- [01: Permulaan Pantas Chat REST](./Module08/samples/01/README.md)
...
- [06: Perute Model-sebagai-Alat](./Module08/samples/06/README.md)
- [07: Pelanggan API Langsung](./Module08/samples/07/README.md)
- [08: Aplikasi Sembang Windows 11](./Module08/samples/08/README.md)
- [09: Sistem Multi-Ejen Lanjutan](./Module08/samples/09/README.md)
- [10: Rangka Kerja Alat Foundry](./Module08/samples/10/README.md)

### 🎓 **Bengkel: Laluan Pembelajaran Amali**

Bahan bengkel amali yang komprehensif dengan pelaksanaan sedia-pengeluaran:
...
- Perutean model pintar dengan pemilihan berasaskan tugas
...
- **Pengoptimuman Model**: Kuantisasi dan mampatkan model untuk penyebaran tepi (peningkatan kelajuan 85%, pengurangan saiz 75%)
...
- **Sistem Pelbagai Ejen**: Penyelarasan dengan ejen pakar untuk aliran kerja yang kompleks  
- **Aplikasi RAG**: Pemprosesan dokumen setempat dengan carian vektor
- **Perute Model**: Pemilihan pintar antara model berdasarkan analisis tugasan
- **Rangka Kerja API**: Klien sedia untuk pengeluaran dengan penstriman dan pemantauan kesihatan
...
**Jalur Pembelajaran yang Disyorkan** (20-30 jam jumlah):

0. **📖 Introduction** ([Introduction.md](./introduction.md)): Asas EdgeAI + konteks industri + rangka pembelajaran
1. **📚 Asas** (Modules 01-02): Konsep EdgeAI + keluarga model SLM
2. **⚙️ Pengoptimuman** (Modules 03-04): Penyebaran + rangka kerja kuantisasi  
3. **🚀 Pengeluaran** (Modules 05-06): SLMOps + ejen AI + pemanggilan fungsi
4. **💻 Pelaksanaan** (Modules 07-08): Contoh platform + kit alat Foundry Local

Setiap modul merangkumi teori, latihan praktikal, dan contoh kod sedia pengeluaran.
...
**Projek Portfolio**: Sistem pelbagai ejen • Aplikasi RAG pengeluaran • Penyebaran rentas platform • Pengoptimuman prestasi
...
✅ **Pelbagai Platform**: Windows, mudah alih, terbenam, hibrid awan-tepi  
✅ **Sedia untuk Pengeluaran**: Rangka kerja pemantauan, penskalaan, keselamatan, pematuhan

📖 **[Panduan Pengajian Tersedia](STUDY_GUIDE.md)**: Laluan pembelajaran 20 jam yang tersusun dengan panduan pengagihan masa dan alat penilaian kendiri.

---

**EdgeAI mewakili masa depan penyebaran AI**: keutamaan setempat, memelihara privasi, dan cekap. Kuasai kemahiran ini untuk membina generasi seterusnya aplikasi pintar.
