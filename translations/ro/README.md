...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T17:08:37+00:00",
...
1. **Fork Repository**: Click [![GitHub forks](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
Bine ați venit la **EdgeAI pentru Începători** – o călătorie completă în lumea transformatoare a Inteligenței Artificiale la margine. Acest curs face legătura între capacitățile puternice ale AI și implementarea practică, în lumea reală, pe dispozitive edge, oferindu-vă posibilitatea de a valorifica potențialul AI direct acolo unde se generează datele și unde trebuie luate deciziile.

### Ce veți învăța

Acest curs vă duce de la concepte fundamentale la implementări gata de producție, acoperind:
- **Modele de limbaj mici (SLM)** optimizate pentru implementarea pe dispozitive edge
- **Optimizare în funcție de hardware** pe diverse platforme
...
- **Eficiență economică**: Reduceți costurile de lățime de bandă și de calcul în cloud
...
Edge AI se referă la rularea algoritmilor AI și a modelelor de limbaj local pe hardware, aproape de locul unde se generează datele, fără a se baza pe resursele cloud pentru inferență. Reduce latența, îmbunătățește confidențialitatea și permite luarea deciziilor în timp real.

### Principii de bază:
- **Inferență pe dispozitiv**: Modelele AI rulează pe dispozitive edge (telefoane, routere, microcontrolere, PC-uri industriale)
- **Capacitate offline**: Funcționează fără conectivitate permanentă la internet
...
- **Cerere redusă de procesare**: Optimizate pentru performanța CPU și GPU edge
...
| [📚 01](../../Module01) | [Fundamentele EdgeAI](./Module01/README.md) | Comparație Cloud vs Edge AI | Fundamentele EdgeAI • Studii de caz reale • Ghid de implementare • Implementare Edge | Începător | 3-4 ore |
...
| [🏭 08](../../Module08) | [Toolkit Foundry Local](./Module08/README.md) | Exemple gata de producție | Aplicații exemplu (vezi detalii mai jos) | Expert | 8-10 ore |
...
- **Exemple Python** (6 sesiuni) - Actualizate cu cele mai bune practici, gestionarea erorilor și documentație completă
...
- **Instrumente de validare** - Scripturi pentru verificarea calității codului și rularea testelor rapide
...
- **Optimizarea modelelor**: Quantizați și comprimați modelele pentru implementarea pe dispozitive edge (creștere de 85% a vitezei, reducere de 75% a dimensiunii)
- **Implementare Multi-Platformă**: Windows, mobile, sisteme integrate și sisteme hibride cloud-edge  
- **Operațiuni de Producție**: Monitorizare, scalare și întreținere a AI-ului edge în producție  

### 🏗️ Proiecte Practice  
- **Aplicații de Chat Local Foundry**: Aplicație nativă Windows 11 cu comutare de modele  
...
- **Framework-uri API**: Clienți gata de producție cu streaming și monitorizare a sănătății  
- **Instrumente Cross-Platformă**: Modele de integrare LangChain/Semantic Kernel  
...
4. **💻 Implementare** (Modulele 07-08): Exemple de platformă + trusa de instrumente Foundry Local  
...
**Sectoare Industriale**: Producție 4.0 • Tehnologie Medicală • Sisteme Autonome • FinTech • Electronice de Consum  

**Proiecte pentru Portofoliu**: Sisteme multi-agent • Aplicații RAG de producție • Implementare cross-platformă • Optimizare a performanței  
...
✅ **Multi-Platformă**: Windows, mobile, sisteme integrate, hibride cloud-edge  
✅ **Gata de Producție**: Monitorizare, scalare, securitate, cadre de conformitate  

📖 **[Ghid de Studiu Disponibil](STUDY_GUIDE.md)**: Cale de învățare structurată de 20 de ore cu ghidare pentru alocarea timpului și instrumente de autoevaluare.  
...
[![Forum Dezvoltatori Azure AI Foundry](https://img.shields.io/badge/GitHub-Forumul_Dezvoltatorilor_Azure_AI_Foundry-blue?style=for-the-badge&logo=github&color=000000&logoColor=fff)](https://aka.ms/foundry/forum)  
