...
Bine ați venit la **EdgeAI pentru Începători** – călătoria dvs. completă în lumea transformatoare a Inteligenței Artificiale la margine. Acest curs face legătura între capacitățile puternice ale AI și implementarea practică, în lumea reală, pe dispozitive edge, oferindu-vă puterea de a valorifica potențialul AI direct acolo unde datele sunt generate și deciziile trebuie luate.
...
- **Amprentă redusă de memorie**: Utilizare eficientă a memoriei limitate a dispozitivelor edge
...
Ele deblochează capabilități puternice NLP respectând constrângerile:
...
| [📚 01](../../Module01) | [Fundamente EdgeAI](./Module01/README.md) | Comparație Cloud vs Edge AI | Fundamente EdgeAI • Studii de caz din lumea reală • Ghid de implementare • Implementare Edge | Începător | 3-4 ore |
...
### 🏗️ Proiecte practice
- **Aplicații locale Foundry Chat**: Aplicație nativă Windows 11 cu comutare între modele
...
**Cale recomandată de învățare** (20-30 ore în total):
...
2. **⚙️ Optimizare** (Modulele 03-04): Implementare + cadre de cuantificare  
3. **🚀 Producție** (Modulele 05-06): SLMOps + agenți AI + apelare funcții
4. **💻 Implementare** (Modulele 07-08): Exemple de platformă + kit de unelte Foundry Local
...
✅ **Exemple practice**: Peste 50 de exemple, 10 demo-uri complete Foundry Local  
✅ **Focalizare pe performanță**: Îmbunătățiri de viteză de 85%, reduceri de dimensiune de 75%  
✅ **Multiplatformă**: Windows, mobil, încorporat, hibrid cloud-edge  
✅ **Pregătit pentru producție**: Monitorizare, scalare, securitate, cadre de conformitate

📖 **[Ghid de studiu disponibil](STUDY_GUIDE.md)**: Cale de învățare structurată de 20 de ore cu ghidaj pentru alocarea timpului și instrumente de autoevaluare.

---

**EdgeAI reprezintă viitorul implementării AI**: local-first, care respectă confidențialitatea și eficient. Stăpânește aceste abilități pentru a construi următoarea generație de aplicații inteligente.
