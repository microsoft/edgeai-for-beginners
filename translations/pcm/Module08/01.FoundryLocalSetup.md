...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T17:59:08+00:00",
...
Microsoft Foundry Local dey bring Azure AI Foundry power come your Windows 11 development environment, so you fit do AI work wey dey fast and private, with tools wey be enterprise level. This session go show you how to install, set up, and use popular models like phi, qwen, deepseek, and GPT-OSS-20B.

## Learning Objectives

By the end of this session, you go sabi:
- Install and set up Foundry Local for Windows 11
- Use CLI commands and configuration options well
- Understand how model caching dey work to make performance better
- Run phi, qwen, deepseek, and GPT-OSS-20B models successfully
- Build your first AI app with Foundry Local

## Prerequisites

### System Requirements
- **Windows 11**: Version 22H2 or later
- **RAM**: At least 16GB, but 32GB dey better
- **Storage**: 50GB free space for models and cache
- **Hardware**: Device wey get NPU or GPU (like Copilot+ PC or NVIDIA GPU) go work better
- **Network**: Fast internet to download models
...
Use Winget or download the installer from GitHub to install Foundry Local:
...
Foundry Local dey use smart model caching to make performance and storage better:
...
Build one chat app wey fit work for production using OpenAI SDK with Foundry Local, follow the pattern for Sample 01.
...
- **Use OpenAI SDK**: Make sure say you use OpenAI SDK instead of raw HTTP requests for better maintenance
- **FoundryLocalManager**: Use the official SDK to manage services if e dey available
- **Error Handling**: Add fallback plans for production apps
- **Upgrade Regularly**: Update Foundry Local often to get new models and fixes
- **Start Small**: Begin with smaller models (Phi mini, Qwen 7B) before you go bigger
- **Monitor Resources**: Check CPU/GPU/memory when you dey adjust prompts and settings
