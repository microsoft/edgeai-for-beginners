...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T17:44:07+00:00",
...
> **Interactive Jupyter Notebooks wey go help you learn Edge AI wit hands-on**
>
> Tutorials wey dey progressive and self-paced, wey go start from basic chat completions go reach advanced multi-agent systems using Microsoft Foundry Local and Small Language Models.

---

## 📖 Introduction

Welcome to di **EdgeAI for Beginners Workshop Notebooks** collection. Dis Jupyter notebooks go give you chance to learn Edge AI by writing, running, and testing code for real-time.

### Why Jupyter Notebooks?

Unlike di normal tutorials, dis notebooks dey offer:

- **Interactive Learning**: You fit run code cells and see di result sharp sharp  
- **Experimentation**: Change parameters and see how e go affect di code  
- **Documentation**: Markdown cells and explanations dey guide you step by step  
- **Reproducibility**: Complete examples wey you fit use again  
- **Visualization**: See performance metrics, embeddings, and results directly inside di notebook  

### Wetin Make Dis Notebooks Special?

Each notebook dey follow **production-ready best practices**:

✅ **Comprehensive Error Handling** - E dey handle errors well and dey give clear error messages  
✅ **Type Hints & Documentation** - Functions dey clear with proper docstrings  
✅ **Performance Monitoring** - E dey track token usage and measure latency  
✅ **Modular Design** - Patterns wey you fit reuse for your own projects  
✅ **Progressive Complexity** - E dey build on top di previous sessions step by step  

---

## 🎯 Learning Objectives

### Core Skills You Go Learn

As you dey work through di notebooks, you go sabi:

1. **Local AI Service Management**
   - How to configure and manage Microsoft Foundry Local services  
   - Select and load di correct models for your hardware  
   - Monitor resource usage and make performance better  
...
2. **AI Application Development**
   ...
   - Build streaming interfaces wey go make user experience better  
   - Design prompts wey dey effective for Small Language Models  
   - Integrate local models into applications  

3. **Retrieval Augmented Generation (RAG)**
   - Create semantic search using vector embeddings  
   - Make LLM responses dey grounded in domain-specific documents  
   - Use RAGAS metrics to evaluate RAG quality  
   - Scale from prototype to production  

4. **Performance Optimization**
   - Benchmark different models systematically  
   - Measure latency, throughput, and first-token time  
   - Compare Small Language Models vs Large Language Models  
   - Choose di best models based on performance and quality  

5. **Multi-Agent Orchestration**
   - Design agents wey dey specialize for different tasks  
   - Implement agent memory and context management  
   - Coordinate multiple agents for complex workflows  
   - Build coordinator patterns wey go make agents work together  

6. **Intelligent Model Routing**
   - Implement intent detection and pattern matching  
   - Route queries to di correct models automatically  
...
| Notebook | Deliverable | Skills You Go Show | Difficulty |
|----------|-------------|---------------------|------------|
| **Session 01** | Chat app wey dey stream | Service setup, basic completions, streaming UX | ⭐ Beginner |
| **Session 02 (RAG)** | RAG pipeline wit evaluation | Embeddings, semantic search, quality metrics | ⭐⭐ Intermediate |
...
**Output**: Attendees go leave wit 6 working Edge AI applications and production-ready code patterns.
...
- Implement basic chat completions wit OpenAI-compatible API  
- Build streaming responses wey go make user experience better  
- Handle errors and service unavailability well  

**Key Concepts**: Service management, chat completions, streaming, error handling  

**You Go Build**: Interactive chat application wit streaming support  
...
- Create vector embeddings wit sentence-transformers  
- Build semantic search wit cosine similarity  
- Ground LLM responses in domain documents  
- Handle optional dependencies wit import guards  

**Key Concepts**: RAG architecture, embeddings, semantic search, vector similarity  

**You Go Build**: Document-grounded question-answering system  

---

### 📗 Session 02: RAG Evaluation wit RAGAS
...
**Wetin You Go Learn**:
- Evaluate RAG quality wit industry-standard metrics  
...
**You Go Build**: RAG quality evaluation framework  
...
**You Go Build**: Multi-model benchmarking suite  
...
**You Go Build**: SLM vs LLM comparison framework  
...
**You Go Build**: Multi-agent system wit coordinator and specialists  
...
**You Go Build**: Intelligent model routing system  
...
**You Go Build**: Multi-step intelligent pipeline wey go fit route
...
- **Hardware**: CPU wey get AVX2; GPU (CUDA, Qualcomm NPU) na optional

**Software Requirements**:
- **Python 3.8+** wey get pip
- **Jupyter Notebook** or **VS Code** wey get Jupyter extension
- **Microsoft Foundry Local** wey don dey install and configure
...
Run this one for Python cell to confirm setup:
...
**Wetin You Go See**: Greeting response from the local model.
...
**Before Workshop**:
- ✅ Send installation instructions one week before
- ✅ Test all notebooks for the hardware wey you go use
- ✅ Prepare troubleshooting guide for wahala wey fit happen
- ✅ Get backup models ready (phi-3.5-mini if phi-4-mini no work)
- ✅ Arrange shared chat channel for questions

**During Workshop**:
- ✅ Start with quick environment check (5 minutes)
- ✅ Share troubleshooting resources quick quick
- ✅ Make learners try experiment and change things
- ✅ Use break time well (after every 2 sessions)
- ✅ Get TAs wey go help learners one-on-one

**After Workshop**:
- ✅ Share all the working notebooks and solutions
- ✅ Give links to extra resources
- ✅ Create feedback survey to improve
- ✅ Arrange office hours for follow-up questions

### For Learners

**How You Go Learn Well**:
- ✅ Finish setup before workshop start
- ✅ Run all code cells by yourself (no just dey read am)
- ✅ Try change parameters and prompts
- ✅ Write down wetin you learn and any wahala you see
- ✅ Ask questions if you no understand (others fit get same question)

**Wahala Weh You Fit Avoid**:
- ❌ No skip the order wey you go run cells (run am one by one)
- ❌ No ignore error messages, read am well
- ❌ No rush, try understand wetin you dey do
- ❌ No ignore markdown explanations
- ❌ No forget to save your modified notebooks

**Debugging Tips**:
1. **Service No Start**: Check `foundry service status`
2. **Import Errors**: Confirm say virtual environment dey active
3. **Model No Dey**: Run `foundry model ls` to see loaded models
4. **Slow Performance**: Check RAM usage, close other apps
...
- **[Workshop Main Guide](../Readme.md)** - Overview, wetin you go learn, career benefits
- **[Python Samples](../../../../Workshop/samples)** - Python scripts for each session
- **[Session Guides](../../../../Workshop)** - Detailed markdown guides (Session01-06)
- **[Scripts](../../../../Workshop/scripts)** - Validation and testing tools
- **[Troubleshooting](./TROUBLESHOOTING.md)** - Common wahala and solutions
- **[Quick Start](./quickstart.md)** - Fast-track guide to start
...
1. Finish Beginner Track (Sessions 01-03)
2. Choose ONE advanced session based on wetin you wan achieve:
...
Track wetin you don achieve with these milestones:

- [ ] **Setup Complete** - Foundry Local dey run, all dependencies don install
- [ ] **First Chat** - Session 01 don finish, streaming chat dey work
- [ ] **RAG Built** - Session 02 don finish, document QA system dey functional
- [ ] **Models Benchmarked** - Session 03 don finish, performance data don collect
- [ ] **Trade-offs Analyzed** - Session 04 don finish, model selection criteria don document
- [ ] **Agents Orchestrated** - Session 05 don finish, multi-agent system dey work
- [ ] **Routing Implemented** - Session 06 don finish, intelligent model selection dey functional
- [ ] **Custom Project** - You don use workshop patterns for your own project

---

## 🤝 Contributing

You see wahala or get suggestion? We dey welcome contributions!
...
This workshop dey part of [EdgeAI for Beginners](https://github.com/microsoft/edgeai-for-beginners) repository and e dey under [MIT License](../../../../LICENSE).
