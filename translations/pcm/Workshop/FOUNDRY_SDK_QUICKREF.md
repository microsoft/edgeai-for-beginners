...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T17:41:16+00:00",
...
1. **Cache Clients**: Make sure say you dey reuse `FoundryLocalManager` instances
2. **Batch Requests**: Process plenty prompts one by one
3. **Adjust max_tokens**: If e low, response go quick
4. **Pre-load Models**: Download am before you use am for production
5. **Monitor Usage**: Use `SHOW_USAGE=1` to track tokens
