...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:23:39+00:00",
...
- **Regulatorische Konformität**: Einhaltung von Datenschutzanforderungen
...
| [📚 01](../../Module01) | [Grundlagen von EdgeAI](./Module01/README.md) | Vergleich Cloud vs. Edge AI | Grundlagen von EdgeAI • Praxisbeispiele • Implementierungsleitfaden • Edge-Bereitstellung | Anfänger | 3-4 Std. |
...
✅ **Plattformübergreifend**: Windows, Mobile, Embedded, Cloud-Edge-Hybrid  
...
Falls Sie nicht weiterkommen oder Fragen zum Aufbau von KI-Anwendungen haben, treten Sie bei:

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

Falls Sie Produktfeedback geben oder Fehler beim Aufbau melden möchten, besuchen Sie:
