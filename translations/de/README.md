...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T08:55:17+00:00",
...
[![GitHub-Beitragende](https://img.shields.io/github/contributors/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/graphs/contributors)
...
3. [**Treten Sie dem Azure AI Foundry Discord bei und treffen Sie Experten und Entwickler**](https://discord.com/invite/ByRwuEEgH4)
...
Willkommen zu **EdgeAI für Einsteiger** – Ihre umfassende Reise in die transformative Welt der Edge-Künstlichen Intelligenz. Dieser Kurs überbrückt die Lücke zwischen leistungsstarken KI-Fähigkeiten und praktischer, realer Bereitstellung auf Edge-Geräten und befähigt Sie dazu, das Potenzial der KI direkt dort zu nutzen, wo Daten erzeugt und Entscheidungen getroffen werden müssen.

### Was Sie meistern werden

Dieser Kurs führt Sie von den grundlegenden Konzepten zu produktionsreifen Implementierungen und behandelt:
- **Kleine Sprachmodelle (SLMs)**, optimiert für die Edge-Bereitstellung
- **Hardwarebewusste Optimierung** auf verschiedenen Plattformen
- **Echtzeit-Inferenz** mit datenschutzfreundlichen Fähigkeiten
...
- **Echtzeit-Leistung**: Beseitigung von Netzwerklatenz bei zeitkritischen Anwendungen
- **Kosteneffizienz**: Reduzierung von Bandbreiten- und Cloud-Computing-Kosten
- **Robuste Abläufe**: Erhalt der Funktionalität während Netzwerkausfällen
- **Regulatorische Compliance**: Einhaltung von Datenhoheits-Anforderungen

### Edge AI

Edge AI bezeichnet das Ausführen von KI-Algorithmen und Sprachmodellen lokal auf der Hardware, nahe dem Ort der Datenerzeugung, ohne für die Inferenz auf Cloud-Ressourcen angewiesen zu sein. Es reduziert Latenz, verbessert den Datenschutz und ermöglicht Echtzeit-Entscheidungen.
...
- **Reduzierten Speicherbedarf**: Effiziente Nutzung begrenzter Edge-Gerätespeicher
...
- **Eingebetteten Systemen**: IoT-Geräte und Industrie-Steuerungen
...
| Modul | Thema | Schwerpunkt | Schlüsselinhalte | Niveau | Dauer |
|--------|-------|------------|-------------|--------|----------|
...
| [🧠 02](../../Module02) | [SLM Modellgrundlagen](./Module02/README.md) | Modellfamilien & Architektur | Phi Family • Qwen Family • Gemma Family • BitNET • μModel • Phi-Silica | Anfänger | 4-5 Std |
...
| [🔧 05](../../Module05) | [SLMOps Produktion](./Module05/README.md) | Produktionsbetrieb | SLMOps Einführung • Modell-Destillation • Feinabstimmung • Produktions-Einsatz | Fortgeschritten | 5-6 Std |
...
| [💻 07](../../Module07) | [Plattformimplementierung](./Module07/README.md) | Plattformübergreifende Beispiele | KI-Toolkit • Foundry Lokal • Windows Entwicklung | Fortgeschritten | 3-4 Std |
...
- [03: Modell-Erkennung & Benchmarking](./Module08/samples/03/README.md)
- [04: Chainlit RAG Anwendung](./Module08/samples/04/README.md)
- [05: Multi-Agenten Orchestrierung](./Module08/samples/05/README.md)
- [06: Modelle-als-Werkzeuge Router](./Module08/samples/06/README.md)
...
- **Sitzungsanleitungen** - Detaillierte Markdown-Leitfäden für jede Workshop-Sitzung
- **Validierungs-Tools** - Skripte zur Überprüfung der Codequalität und für einfache Tests
...
- Intelligentes Modellrouting mit aufgabenbasierter Auswahl

### 🎙️ **Workshop für Agentic: Hands-On - Das AI Podcast Studio**

Bauen Sie eine KI-gestützte Podcast-Produktionspipeline von Grund auf! Dieser ausführliche Workshop lehrt Sie, ein vollständiges Multi-Agenten-System zu erstellen, das Ideen in professionelle Podcast-Episoden verwandelt.
...
- **🎤 Text-zu-Sprache-Integration** – Verwandle Skripte in natürlich klingende Gespräche mit mehreren Sprechern
- **✋ Mensch-in-der-Schleife-Workflows** – Freigabeschleifen sichern Qualität bei vollständiger Automatisierung

**Dreiteilige Lernreise:**

| Akt | Fokus | Schlüsselfähigkeiten | Dauer |
|-----|-------|----------------------|-------|
| **[Akt 1: Lerne deine KI-Assistenten kennen](./WorkshopForAgentic/md/01.BuildAIAgentWithSLM.md)** | Baue deinen ersten KI-Agenten | Werkzeugintegration • Websuche • Problemlösung • Agentische Logik | 2-3 Std. |
| **[Akt 2: Stelle dein Produktionsteam zusammen](./WorkshopForAgentic/md/02.AIAgentOrchestrationAndWorkflows.md)** | Orchestriere mehrere Agenten | Teamkoordination • Freigabeworkflows • DevUI-Interface • Menschliche Überwachung | 3-4 Std. |
| **[Akt 3: Erwecke deinen Podcast zum Leben](./WorkshopForAgentic/md/03.Multi-SpeakerPodcastGenerationWithVibeVoice.md)** | Erzeuge Podcast-Audio | Text-zu-Sprache • Mehrsprecher-Synthese • Langform-Audio • Vollautomatisierung | 2-3 Std. |
...
- ✅ **CPU-Modus** – Funktioniert auf jedem modernen Computer (8GB+ RAM empfohlen)
- 🚀 **GPU-Beschleunigung** – Deutlich schnellere Inferenz mit NVIDIA-/AMD-GPUs
- ⚡ **NPU-Unterstützung** – Beschleunigung durch nächste Generation von Neural Processing Units
...
- Studierende, die praktische KI-Orchestrierungsmuster lernen

**Starte jetzt mit dem Bau**: [🎙️ The AI Podcast Studio Workshop →](./WorkshopForAgentic/README.md)
...
- **Spezialpfad**: Modul 08 (8-10 Stunden)

## Was du bauen wirst

### 🎯 Kernkompetenzen
- **Edge KI Architektur**: Entwerfe lokal-fokussierte KI-Systeme mit Cloud-Integration
- **Modelloptimierung**: Quantisiere und komprimiere Modelle für Edge-Bereitstellung (85 % schnellere Leistung, 75 % kleinere Größe)
- **Multi-Plattform Bereitstellung**: Windows, mobil, eingebettete Systeme und Cloud-Edge-Hybride
- **Produktionsbetrieb**: Überwachung, Skalierung und Wartung von Edge KI im produktiven Einsatz
...
- **API-Frameworks**: Produktionsbereite Clients mit Streaming und Gesundheitsüberwachung
...
2. **⚙️ Optimierung** (Module 03-04): Bereitstellung + Quantisierungsframeworks  
3. **🚀 Produktion** (Module 05-06): SLMOps + KI-Agenten + Funktionsaufruf
4. **💻 Umsetzung** (Module 07-08): Plattform-Beispiele + Foundry Local Toolkit

Jedes Modul umfasst Theorie, praktische Übungen und produktionsfertige Codebeispiele.

## Karrierechancen

**Technische Rollen**: EdgeAI Solutions Architect • ML Engineer (Edge) • IoT KI-Entwickler • Mobile KI-Entwickler

**Branchen**: Manufacturing 4.0 • Gesundheitstechnologie • Autonome Systeme • FinTech • Unterhaltungselektronik
...
✅ **Reale Fallstudien**: Microsoft, Japan Airlines, Unternehmensimplementierungen  
✅ **Praxisbeispiele**: 50+ Beispiele, 10 umfassende Foundry Local Demos  
✅ **Leistungsfokus**: 85 % Geschwindigkeitsverbesserungen, 75 % Größenreduzierung  
✅ **Multi-Plattform**: Windows, mobil, eingebettet, Cloud-Edge-Hybride  
✅ **Produktionsbereit**: Überwachung, Skalierung, Sicherheit, Compliance-Frameworks

📖 **[Studienleitfaden verfügbar](STUDY_GUIDE.md)**: Strukturierter 20-Stunden-Lernpfad mit Zeitplanung und Selbstbewertung.

---

**EdgeAI repräsentiert die Zukunft der KI-Bereitstellung**: lokal zuerst, datenschutzfreundlich und effizient. Meistere diese Fähigkeiten, um die nächste Generation intelligenter Anwendungen zu bauen.
