...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:42:11+00:00",
...
Willkommen zu **EdgeAI für Anfänger** – Ihre umfassende Reise in die transformative Welt der Edge-Künstlichen Intelligenz. Dieser Kurs schlägt die Brücke zwischen leistungsstarken KI-Fähigkeiten und praktischen, realen Anwendungen auf Edge-Geräten, sodass Sie das Potenzial der KI direkt dort nutzen können, wo Daten generiert und Entscheidungen getroffen werden müssen.

### Was Sie lernen werden

Dieser Kurs führt Sie von den grundlegenden Konzepten bis hin zu produktionsreifen Implementierungen und behandelt:
- **Kleine Sprachmodelle (SLMs)**, die für Edge-Einsatz optimiert sind
...
Edge AI bezieht sich auf die Ausführung von KI-Algorithmen und Sprachmodellen lokal auf Hardware, nahe der Datenquelle, ohne auf Cloud-Ressourcen für die Inferenz angewiesen zu sein. Es reduziert Latenz, verbessert den Datenschutz und ermöglicht Echtzeit-Entscheidungen.

### Kernprinzipien:
- **Inferenz auf dem Gerät**: KI-Modelle laufen auf Edge-Geräten (Handys, Router, Mikrocontroller, Industrie-PCs)
...
|-------|-------|--------------|--------------|--------|-------|
| [📖 00 ](./introduction.md) | [Einführung in EdgeAI](./introduction.md) | Grundlagen & Kontext | Überblick über EdgeAI • Branchenanwendungen • Einführung in SLM • Lernziele | Anfänger | 1-2 Std. |
...
| [🧠 02](../../Module02) | [SLM-Modell Grundlagen](./Module02/README.md) | Modellfamilien & Architektur | Phi-Familie • Qwen-Familie • Gemma-Familie • BitNET • μModel • Phi-Silica | Anfänger | 4-5 Std. |
...
### 🎯 Kernkompetenzen
- **Edge AI Architektur**: Lokale KI-Systeme mit Cloud-Integration entwerfen  
- **Modelloptimierung**: Modelle für Edge-Bereitstellung quantisieren und komprimieren (85% Geschwindigkeitssteigerung, 75% Größenreduktion)  
- **Multi-Plattform-Bereitstellung**: Windows, mobile, eingebettete Systeme und Cloud-Edge-Hybridsysteme  
...
2. **⚙️ Optimierung** (Module 03-04): Bereitstellungs- + Quantisierungs-Frameworks  
...
**Portfolio-Projekte**: Multi-Agenten-Systeme • Produktions-RAG-Anwendungen • Plattformübergreifende Bereitstellung • Leistungsoptimierung  
...
✅ **Multi-Plattform**: Windows, mobile, eingebettete Systeme, Cloud-Edge-Hybrid  
✅ **Produktionsreife**: Überwachungs-, Skalierungs-, Sicherheits- und Compliance-Frameworks  

📖 **[Lernleitfaden verfügbar](STUDY_GUIDE.md)**: Strukturierter 20-Stunden-Lernpfad mit Zeitplanungsrichtlinien und Selbstbewertungstools.  
...
Falls Sie Produktfeedback haben oder auf Fehler stoßen, besuchen Sie:  
