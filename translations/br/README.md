...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:54:15+00:00",
...
Bem-vindo ao **EdgeAI para Iniciantes** – sua jornada completa no mundo transformador da Inteligência Artificial na borda. Este curso conecta as capacidades poderosas da IA com a implantação prática e real em dispositivos de borda, permitindo que você aproveite o potencial da IA diretamente onde os dados são gerados e as decisões precisam ser tomadas.
...
- **Implantação Multi-Plataforma**: Windows, dispositivos móveis, sistemas embarcados e híbridos de borda na nuvem  
- **Operações de Produção**: Monitoramento, escalabilidade e manutenção de IA de borda em produção  
...
**Projetos de Portfólio**: Sistemas multi-agentes • Aplicativos RAG em produção • Implantação multi-plataforma • Otimização de desempenho  
...
✅ **Multi-Plataforma**: Windows, dispositivos móveis, sistemas embarcados, híbridos de borda na nuvem  
