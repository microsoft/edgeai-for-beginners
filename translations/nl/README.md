...
- **Regelgevingsnaleving**: Voldoen aan data-soevereiniteitseisen
...
- **Verminderde geheugenvraag**: Efficiënt gebruik van beperkte edge-apparaatgeheugen
- **Lagere rekenkrachtbehoefte**: Geoptimaliseerd voor CPU- en edge GPU-prestaties
...
|--------|-----------|-------------|---------------------|--------|-------|
| [📖 00 ](./introduction.md) | [Introductie tot EdgeAI](./introduction.md) | Fundament & Context | EdgeAI Overzicht • Industrie Toepassingen • SLM Introductie • Leerdoelen | Beginner | 1-2 uur |
| [📚 01](../../Module01) | [EdgeAI Grondbeginselen](./Module01/README.md) | Cloud vs Edge AI vergelijking | EdgeAI Grondbeginselen • Praktijkvoorbeelden • Implementatiehandleiding • Edge Implementatie | Beginner | 3-4 uur |
