...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:38:41+00:00",
...
1. **افتح نسخة من المستودع**: انقر على [![تفرعات GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
مرحبًا بك في **EdgeAI للمبتدئين** – رحلتك الشاملة إلى عالم الذكاء الاصطناعي الحدي التحويلي. تربط هذه الدورة بين قدرات الذكاء الاصطناعي القوية والنشر العملي في العالم الحقيقي على أجهزة الحافة، مما يمكنك من استغلال إمكانات الذكاء الاصطناعي مباشرة حيث يتم توليد البيانات وحيث يجب اتخاذ القرارات.
...
- **القدرة على العمل دون اتصال**: تعمل بدون اتصال إنترنت مستمر
...
| [📚 01](../../Module01) | [أساسيات EdgeAI](./Module01/README.md) | مقارنة بين السحابة وEdge AI | أساسيات EdgeAI • دراسات حالة من العالم الحقيقي • دليل التنفيذ • نشر الحافة | مبتدئ | 3-4 ساعات |
| [🧠 02](../../Module02) | [أساسيات نموذج SLM](./Module02/README.md) | عائلات النماذج والهندسة المعمارية | عائلة Phi • عائلة Qwen • عائلة Gemma • BitNET • μModel • Phi-Silica | مبتدئ | 4-5 ساعات |
...
| [🔧 05](../../Module05) | [إدارة إنتاج SLM](./Module05/README.md) | عمليات الإنتاج | مقدمة SLMOps • تقطير النماذج • التخصيص الدقيق • النشر الإنتاجي | متقدم | 5-6 ساعات |
...
- **النشر عبر منصات متعددة**: ويندوز، الجوال، الأنظمة المدمجة، وأنظمة هجينة بين السحابة والحافة
- **عمليات الإنتاج**: المراقبة، التوسع، وصيانة الذكاء الاصطناعي على الحافة في بيئة الإنتاج
...
- **أدوات عبر المنصات**: أنماط تكامل LangChain/Semantic Kernel
...
**الأدوار التقنية**: مهندس حلول EdgeAI • مهندس تعلم آلي (على الحافة) • مطور ذكاء اصطناعي لإنترنت الأشياء • مطور ذكاء اصطناعي للجوال
...
✅ **متعدد المنصات**: ويندوز، الجوال، الأنظمة المدمجة، السحابة-الحافة الهجينة  
