...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T14:31:37+00:00",
...
1. **افتح تفرع المستودع**: انقر على [![تفرعات GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
مرحبًا بك في **EdgeAI للمبتدئين** – رحلتك الشاملة إلى عالم الذكاء الاصطناعي الحدي التحويلي. تربط هذه الدورة بين قدرات الذكاء الاصطناعي القوية والنشر العملي في العالم الحقيقي على أجهزة الحافة، مما يمكّنك من استغلال إمكانات الذكاء الاصطناعي مباشرة حيث يتم توليد البيانات ويجب اتخاذ القرارات.

### ما ستتقنه

تأخذك هذه الدورة من المفاهيم الأساسية إلى تطبيقات جاهزة للإنتاج، تغطي:
...
يمثل الذكاء الاصطناعي الحدي تحولًا جذريًا يعالج تحديات حديثة حرجة:
- **الخصوصية والأمان**: معالجة البيانات الحساسة محليًا دون التعرض للسحابة
- **الأداء في الوقت الحقيقي**: القضاء على تأخير الشبكة للتطبيقات الحرجة زمنياً
...
يشير الذكاء الاصطناعي الحدي إلى تشغيل خوارزميات الذكاء الاصطناعي ونماذج اللغة محليًا على الأجهزة، بالقرب من مكان توليد البيانات دون الاعتماد على موارد السحابة للاستدلال. يقلل من التأخير، يعزز الخصوصية، ويمكّن من اتخاذ القرارات في الوقت الحقيقي.

### المبادئ الأساسية:
- **الاستدلال على الجهاز**: تشغيل نماذج الذكاء الاصطناعي على أجهزة الحافة (الهواتف، الموجهات، المتحكمات الدقيقة، الحواسيب الصناعية)
- **القدرة على العمل دون اتصال**: يعمل بدون اتصال إنترنت مستمر
...
نماذج مثل Phi-4، Mistral-7B، وGemma هي نسخ محسنة من نماذج اللغة الكبيرة الأكبر—تم تدريبها أو تقطيرها لـ:
- **تقليل استهلاك الذاكرة**: استخدام فعال لذاكرة أجهزة الحافة المحدودة
- **انخفاض متطلبات الحوسبة**: محسنة لأداء المعالجات المركزية ووحدات معالجة الرسومات على الحافة
- **أوقات بدء تشغيل أسرع**: تهيئة سريعة لتطبيقات سريعة الاستجابة

تفتح هذه النماذج قدرات معالجة اللغة الطبيعية القوية مع تلبية قيود:
...
|--------|---------|--------------|-----------------|---------|-------|
| [📖 00 ](./introduction.md) | [مقدمة إلى EdgeAI](./introduction.md) | الأساس والسياق | نظرة عامة على EdgeAI • تطبيقات الصناعة • مقدمة عن SLM • أهداف التعلم | مبتدئ | 1-2 ساعة |
| [📚 01](../../Module01) | [أساسيات EdgeAI](./Module01/README.md) | مقارنة بين السحابة والذكاء الاصطناعي الحدي | أساسيات EdgeAI • دراسات حالة من العالم الحقيقي • دليل التنفيذ • النشر على الحافة | مبتدئ | 3-4 ساعات |
| [🧠 02](../../Module02) | [أسس نماذج SLM](./Module02/README.md) | عائلات النماذج والهندسة المعمارية | عائلة Phi • عائلة Qwen • عائلة Gemma • BitNET • μModel • Phi-Silica | مبتدئ | 4-5 ساعات |
...
| [⚙️ 04](../../Module04) | [أدوات تحسين النماذج](./Module04/README.md) | التحسين عبر المنصات | مقدمة • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • تركيب سير العمل | متوسط | 5-6 ساعات |
| [🔧 05](../../Module05) | [إنتاج SLMOps](./Module05/README.md) | عمليات الإنتاج | مقدمة SLMOps • تقطير النماذج • الضبط الدقيق • النشر الإنتاجي | متقدم | 5-6 ساعات |
| [🤖 06](../../Module06) | [وكلاء الذكاء الاصطناعي واستدعاء الوظائف](./Module06/README.md) | أطر الوكلاء وبروتوكول MCP | مقدمة الوكلاء • استدعاء الوظائف • بروتوكول سياق النموذج | متقدم | 4-5 ساعات |
| [💻 07](../../Module07) | [تنفيذ المنصة](./Module07/README.md) | عينات عبر المنصات | أدوات الذكاء الاصطناعي • Foundry Local • تطوير ويندوز | متقدم | 3-4 ساعات |
...
- [03: اكتشاف النماذج والقياس المرجعي](./Module08/samples/03/README.md)
...
- **[دليل ورشة العمل](./Workshop/Readme.md)** - أهداف التعلم الكاملة، النتائج، والتنقل في الموارد
- **عينات بايثون** (6 جلسات) - محدثة بأفضل الممارسات، معالجة الأخطاء، والتوثيق الشامل
- **دفاتر Jupyter** (8 تفاعلية) - دروس خطوة بخطوة مع مقاييس وأدوات مراقبة الأداء
- **أدلة الجلسات** - أدلة مفصلة لكل جلسة ورشة عمل بصيغة ماركداون
- **أدوات التحقق** - سكريبتات للتحقق من جودة الكود وتشغيل اختبارات أولية
...
- توجيه ذكي للنماذج مع اختيار قائم على المهام
...
### 🎯 الكفاءات الأساسية
- **هندسة الذكاء الاصطناعي الحدي**: تصميم أنظمة ذكاء اصطناعي محلية أولاً مع تكامل السحابة
- **تحسين النموذج**: تقليل دقة وضغط النماذج للنشر على الحافة (زيادة السرعة بنسبة 85%، تقليل الحجم بنسبة 75%)
- **النشر متعدد المنصات**: ويندوز، الجوال، المدمج، وأنظمة هجينة بين السحابة والحافة
- **عمليات الإنتاج**: المراقبة، التوسع، وصيانة الذكاء الاصطناعي على الحافة في الإنتاج

### 🏗️ مشاريع عملية
- **تطبيقات الدردشة المحلية Foundry**: تطبيق أصلي لويندوز 11 مع تبديل النماذج
- **أنظمة متعددة الوكلاء**: منسق مع وكلاء متخصصين لسير عمل معقد  
- **تطبيقات RAG**: معالجة المستندات محليًا مع بحث متجه
- **موجهات النماذج**: اختيار ذكي بين النماذج بناءً على تحليل المهمة
- **أطر عمل API**: عملاء جاهزون للإنتاج مع البث والمراقبة الصحية
...
2. **⚙️ التحسين** (الوحدات 03-04): النشر + أطر تقليل الدقة  
3. **🚀 الإنتاج** (الوحدات 05-06): SLMOps + وكلاء الذكاء الاصطناعي + استدعاء الدوال
4. **💻 التنفيذ** (الوحدات 07-08): عينات المنصات + مجموعة أدوات Foundry Local

كل وحدة تتضمن نظرية، تمارين عملية، وعينات كود جاهزة للإنتاج.

## تأثير على المسار المهني

**الأدوار التقنية**: مهندس حلول EdgeAI • مهندس تعلم آلي (على الحافة) • مطور AI لإنترنت الأشياء • مطور AI للجوال
...
✅ **تعلم تدريجي**: نظرية → تطبيق → نشر الإنتاج  
✅ **دراسات حالة حقيقية**: مايكروسوفت، الخطوط الجوية اليابانية، تطبيقات المؤسسات  
✅ **عينات عملية**: أكثر من 50 مثال، 10 عروض شاملة لـ Foundry Local  
✅ **تركيز على الأداء**: تحسينات سرعة بنسبة 85%، تقليل حجم بنسبة 75%  
✅ **متعدد المنصات**: ويندوز، الجوال، المدمج، هجينة السحابة والحافة  
...
**يمثل EdgeAI مستقبل نشر الذكاء الاصطناعي**: محلي أولاً، يحافظ على الخصوصية، وفعال. اتقن هذه المهارات لبناء الجيل القادم من التطبيقات الذكية.
