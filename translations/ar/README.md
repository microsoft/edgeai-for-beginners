...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T11:24:29+00:00",
...
1. **افتح تفرع المستودع**: انقر [![تفرعات GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
مرحبًا بك في **EdgeAI للمبتدئين** – رحلتك الشاملة إلى عالم الذكاء الاصطناعي الحدي التحويلي. تربط هذه الدورة بين قدرات الذكاء الاصطناعي القوية والنشر العملي في العالم الحقيقي على أجهزة الحافة، مما يمكنك من استغلال إمكانات الذكاء الاصطناعي مباشرة حيث يتم توليد البيانات ويجب اتخاذ القرارات.
...
نماذج مثل Phi-4، Mistral-7B، وGemma هي نسخ محسنة من نماذج اللغة الكبيرة—تم تدريبها أو تقطيرها لـ:
...
تفتح إمكانيات معالجة اللغة الطبيعية القوية مع تلبية قيود:
...
| [🔧 05](../../Module05) | [إنتاج SLMOps](./Module05/README.md) | عمليات الإنتاج | مقدمة SLMOps • تقطير النماذج • التخصيص الدقيق • النشر الإنتاجي | متقدم | 5-6 ساعات |
...
- **دفاتر Jupyter** (8 تفاعلية) - دروس خطوة بخطوة مع مقاييس وأداء المراقبة
...
- **النشر متعدد المنصات**: ويندوز، الجوال، الأنظمة المدمجة، وأنظمة هجينة بين السحابة والحافة
...
✅ **متعدد المنصات**: ويندوز، الجوال، المدمج، السحابة-الحافة الهجينة  
