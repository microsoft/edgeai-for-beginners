...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:43:29+00:00",
...
مرحبًا بكم في **EdgeAI للمبتدئين** – رحلتكم الشاملة إلى عالم الذكاء الاصطناعي المتقدم على الأجهزة الطرفية. هذه الدورة تربط بين قدرات الذكاء الاصطناعي القوية والتطبيق العملي في العالم الحقيقي على الأجهزة الطرفية، مما يتيح لكم استغلال إمكانيات الذكاء الاصطناعي مباشرةً حيث يتم إنشاء البيانات واتخاذ القرارات.
...
- **الكفاءة الاقتصادية**: تقليل تكاليف النطاق الترددي والحوسبة السحابية
- **العمليات المستدامة**: الحفاظ على الوظائف أثناء انقطاع الشبكة
- **الامتثال التنظيمي**: الامتثال لمتطلبات سيادة البيانات

### الذكاء الاصطناعي الطرفي

يشير الذكاء الاصطناعي الطرفي إلى تشغيل خوارزميات الذكاء الاصطناعي ونماذج اللغة محليًا على الأجهزة، بالقرب من مكان إنشاء البيانات، دون الاعتماد على موارد السحابة للاستدلال. يقلل من التأخير، يعزز الخصوصية، ويمكّن اتخاذ القرارات في الوقت الفعلي.
...
- **التأخير المنخفض**: استجابات فورية مناسبة لأنظمة الوقت الفعلي
...
| [📚 01](../../Module01) | [أساسيات EdgeAI](./Module01/README.md) | مقارنة بين السحابة وEdge AI | أساسيات EdgeAI • دراسات حالة واقعية • دليل التنفيذ • نشر Edge | مبتدئ | 3-4 ساعات |
| [🧠 02](../../Module02) | [أساسيات نموذج SLM](./Module02/README.md) | عائلات النماذج والهندسة | عائلة Phi • عائلة Qwen • عائلة Gemma • BitNET • μModel • Phi-Silica | مبتدئ | 4-5 ساعات |
...
| [🔧 05](../../Module05) | [SLMOps الإنتاجي](./Module05/README.md) | عمليات الإنتاج | مقدمة إلى SLMOps • تقليل حجم النماذج • التخصيص • نشر الإنتاج | متقدم | 5-6 ساعات |
...
**ما ستبنيه:**
- تطبيقات دردشة الذكاء الاصطناعي المحلية مع دعم البث
...
- **النشر عبر المنصات المتعددة**: أنظمة ويندوز، الأجهزة المحمولة، الأنظمة المدمجة، وأنظمة السحابة الهجينة  
- **عمليات الإنتاج**: مراقبة، توسيع، وصيانة الذكاء الاصطناعي الطرفي في بيئة الإنتاج  

### 🏗️ مشاريع عملية  
- **تطبيقات الدردشة المحلية Foundry**: تطبيق أصلي لنظام ويندوز 11 مع تبديل النماذج  
...
**الأدوار التقنية**: مهندس حلول EdgeAI • مهندس تعلم الآلة (Edge) • مطور ذكاء اصطناعي للأجهزة • مطور ذكاء اصطناعي للهواتف المحمولة  
...
✅ **دراسات حالة حقيقية**: مايكروسوفت، خطوط الطيران اليابانية، تطبيقات الشركات  
...
✅ **متعدد المنصات**: ويندوز، الأجهزة المحمولة، الأنظمة المدمجة، السحابة الهجينة  
✅ **جاهزية للإنتاج**: مراقبة، توسيع، أطر الأمان والامتثال  
