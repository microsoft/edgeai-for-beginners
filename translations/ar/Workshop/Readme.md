...
**✅ نجاح!** يجب أن ترى استجابة متدفقة حول Edge AI.
...
| 3 | [`benchmark_oss_models.py`](../../../Workshop/samples/session03/benchmark_oss_models.py) | قياس أداء متعدد النماذج | ~2-3 دقائق |
| 4 | [`model_compare.py`](../../../Workshop/samples/session04/model_compare.py) | مقارنة SLM مقابل LLM | ~45 ثانية |
...
| [QUICK_REFERENCE.md](./QUICK_REFERENCE.md) | ورقة مرجعية للأوامر وواجهة API | الحاجة إلى إجابات سريعة |
| [FOUNDRY_SDK_QUICKREF.md](./FOUNDRY_SDK_QUICKREF.md) | أنماط ومثال SDK | كتابة الكود |
...
3. ✅ الجلسة 3: قياس أداء بسيط (نموذجين فقط)
...
هذا ينفذ دورة نص/استجابة واحدة ثم يخرج.
...
- زمن استجابة الرمز الأول (البث): تعيين `BENCH_STREAM=1`
- استخدام الموارد: مراقبات النظام (مدير المهام، مراقب النشاط، `nvidia-smi`).
...
## جدول الهجرة السريع من CLI إلى SDK
