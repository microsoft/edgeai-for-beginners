...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-28T21:18:01+00:00",
...
फाउन्ड्री लोकलसँगको यात्रा सुरु गर्नुहोस् Windows 11 मा यसलाई स्थापना र कन्फिगर गरेर। CLI सेटअप गर्ने, हार्डवेयर एक्सेलेरेशन सक्षम गर्ने, र मोडेलहरू क्यास गरेर छिटो स्थानीय इनफरेन्स सिक्नुहोस्। यो व्यावहारिक सत्रले Phi, Qwen, DeepSeek, र GPT-OSS-20B जस्ता मोडेलहरू चलाउन पुन: प्रयोग गर्न सकिने CLI कमाण्डहरूको माध्यमबाट मार्गदर्शन गर्दछ।
...
- **आफ्नो पहिलो एप निर्माण गर्नुहोस्**: फाउन्ड्री लोकल Python SDK प्रयोग गर्नका लागि विद्यमान नमूनाहरू अनुकूलित गर्नुहोस्
...
foundry model list
## NOTE: हाल कुनै समर्पित `--running` फ्ल्याग छैन; कुन मोडेलहरू लोड भएका छन् हेर्नको लागि च्याट सुरु गर्नुहोस् वा सेवा लगहरू निरीक्षण गर्नुहोस्।
- Python 3.10+ स्थापना गरिएको
- Visual Studio Code Python एक्सटेन्सनसहित
- स्थापना गर्नका लागि प्रशासक अधिकारहरू
...
foundry model run gpt-oss-20b --prompt "सजिलो शब्दमा एज AI को व्याख्या गर्नुहोस्"
| चर | उद्देश्य | उदाहरण |
|----|---------|---------|
| `FOUNDRY_LOCAL_ALIAS` | मनपर्ने मोडेल उपनाम (क्याटलगले उत्कृष्ट भेरियन्ट स्वत: चयन गर्छ) | `phi-3.5-mini` |
...
यदि macOS देशी बाइनरीहरू अझ उपलब्ध छैनन् भने, तपाईं अझै:
1. Windows 11 ARM/Intel VM (Parallels / UTM) प्रयोग गर्न सक्नुहुन्छ र Windows चरणहरू पालना गर्न सक्नुहुन्छ। 
2. कन्टेनर मार्फत मोडेलहरू चलाउनुहोस् (यदि कन्टेनर इमेज प्रकाशित गरिएको छ) र `FOUNDRY_LOCAL_ENDPOINT` लाई एक्सपोज गरिएको पोर्टमा सेट गर्नुहोस्।
...
सेवा म्यानुअली सुरु गर्ने र मोडेलहरू चलाउने सट्टा, **Foundry Local Python SDK** सबै कुरा बुटस्ट्र्याप गर्न सक्छ:
...
यदि तपाईं स्पष्ट नियन्त्रण चाहनुहुन्छ भने, तपाईं अझै CLI + OpenAI क्लाइन्ट प्रयोग गर्न सक्नुहुन्छ जस्तो कि पछि देखाइएको छ।
...
### ४. स्टार्टर प्रोजेक्ट: Foundry Local को लागि 01-run-phi अनुकूलित गर्नुहोस् (५ मिनेट)

#### चरण ४.१: आधारभूत च्याट एप्लिकेसन बनाउनुहोस्

`samples/01-foundry-quickstart/chat_quickstart.py` बनाउनुहोस् (म्यानेजर प्रयोग गर्न अद्यावधिक गरिएको):
...
### समस्या १: "Foundry कमाण्ड फेला परेन"
...
| सुधार | के हो | कसरी |
|-------|-------|------|
| साझा उपयोगिता | डुप्लिकेट क्लाइन्ट/बुटस्ट्र्याप तर्क हटाउनुहोस् | `Workshop/samples/workshop_utils.py` प्रयोग गर्नुहोस् (`get_client`, `chat_once`) |
...
| पहिलो-टोकन विलम्बता | प्रतिक्रिया मेट्रिक महसुस गरियो | स्ट्रिमिङसँग बेंचमार्क स्क्रिप्ट अनुकूलित गर्नुहोस् (`BENCH_STREAM=1`) |
| अस्थायी त्रुटिहरूमा पुन: प्रयास गर्नुहोस् | चिसो सुरुमा लचिलो डेमो | `RETRY_ON_FAIL=1` (डिफल्ट) र `RETRY_BACKOFF` समायोजन गर्नुहोस् |
| स्मोक परीक्षण | मुख्य प्रवाहहरूमा छिटो स्यानिटी | कार्यशालाको अघि `python Workshop/tests/smoke.py` चलाउनुहोस् |
| मोडेल उपनाम प्रोफाइलहरू | मेसिनहरू बीच मोडेल सेट छिटो परिवर्तन गर्नुहोस् | `.env` कायम गर्नुहोस् `FOUNDRY_LOCAL_ALIAS`, `SLM_ALIAS`, `LLM_ALIAS` |
| क्यासिङ दक्षता | बहु-नमूना रनमा दोहोरिएको वार्मअपबाट बच्नुहोस् | उपयोगिता क्यास म्यानेजरहरू; स्क्रिप्टहरू/नोटबुकहरूमा पुन: प्रयोग गर्नुहोस् |
| पहिलो रन वार्मअप | p95 विलम्बता स्पाइकहरू घटाउनुहोस् | `FoundryLocalManager` सिर्जनापछि सानो प्रम्प्ट फायर गर्नुहोस् |

निर्धारणात्मक वार्म आधारभूत उदाहरण (PowerShell):
...
1. **सत्र २ अन्वेषण गर्नुहोस्**: Azure AI Foundry RAG प्रयोग गरेर AI समाधानहरू निर्माण गर्नुहोस्
2. **विभिन्न मोडेलहरू प्रयास गर्नुहोस्**: Qwen, DeepSeek, र अन्य मोडेल परिवारहरूमा प्रयोग गर्नुहोस्
3. **प्रदर्शन अनुकूलन गर्नुहोस्**: तपाईंको विशिष्ट हार्डवेयरका लागि सेटिङहरू परिमार्जन गर्नुहोस्
4. **अनुकूलित एप्लिकेसनहरू निर्माण गर्नुहोस्**: फाउन्ड्री लोकल SDK तपाईंको आफ्नै प्रोजेक्टहरूमा प्रयोग गर्नुहोस्
...
- [Foundry Local स्थापना गाइड](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/install)
...
- [Module08 Sample 03](./samples/03/README.md) - मोडेल खोज र बेंचमार्किङ
...
**पूर्वापेक्षाहरू**: Windows 11, Python 3.10+, प्रशासक पहुँच

## नमूना परिदृश्य र कार्यशाला म्यापिङ

| कार्यशाला स्क्रिप्ट / नोटबुक | परिदृश्य | लक्ष्य | उदाहरण इनपुट(हरू) | आवश्यक डेटासेट |
|-----------------------------|----------|-------|-------------------|----------------|
...
| क्विकस्टार्ट अनुकूलन कोड ब्लक | विद्यमान OpenAI स्क्रिप्टलाई Foundry Local मा माइग्रेट गर्ने डेभलपर | ड्रप-इन अनुकूलता देखाउनुहोस् | "स्थानीय इनफरेन्सका दुई फाइदाहरू दिनुहोस्।" | केवल इनलाइन प्रम्प्ट |

### परिदृश्य कथा
सुरक्षा र अनुपालन टोलीले संवेदनशील प्रोटोटाइप डाटा स्थानीय रूपमा प्रशोधन गर्न सकिन्छ कि छैन भनेर प्रमाणित गर्नुपर्छ। उनीहरूले बुटस्ट्र्याप स्क्रिप्टलाई विभिन्न प्रम्प्टहरू (गोपनीयता, विलम्बता, लागत) प्रयोग गरेर निर्धारणात्मक `temperature=0` मोडमा चलाउँछन् ताकि आधारभूत आउटपुटहरू पछि तुलना गर्नका लागि समात्न सकियोस् (सत्र ३ बेंचमार्किङ र सत्र ४ SLM बनाम LLM तुलना)।
...
यो सूची प्रयोग गरेर पुन: प्रयोग गर्न सकिने मूल्यांकन लूप बनाउन वा भविष्यको रिग्रेसन परीक्षण हार्नेसलाई बीज गर्न सकिन्छ।
