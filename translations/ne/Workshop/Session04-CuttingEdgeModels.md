...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T22:28:57+00:00",
  "source_file": "Workshop/Session04-CuttingEdgeModels.md",
  "language_code": "ne"
}
-->
# सत्र ४: अत्याधुनिक मोडेलहरूको अन्वेषण – LLMs, SLMs & उपकरणमा इन्फरेन्स

## सारांश

स्थानीय बनाम क्लाउड इन्फरेन्स परिदृश्यहरूको लागि ठूला भाषा मोडेल (LLMs) र साना भाषा मोडेल (SLMs) तुलना गर्नुहोस्। ONNX Runtime एक्सेलेरेशन, WebGPU कार्यान्वयन, र हाइब्रिड RAG अनुभवहरू प्रयोग गरेर तैनाती ढाँचाहरू सिक्नुहोस्। स्थानीय मोडेलसहितको Chainlit RAG डेमो र वैकल्पिक OpenWebUI अन्वेषण समावेश छ। तपाईं WebGPU इन्फरेन्स स्टार्टर अनुकूलन गर्नुहुनेछ र Phi बनाम GPT-OSS-20B क्षमता र लागत/प्रदर्शन व्यापार-अफहरूको मूल्याङ्कन गर्नुहुनेछ।
...
- **चलाउनुहोस्** ब्राउजर-आधारित इन्फरेन्स (गोपनीयता-संरक्षण अन्तरक्रियात्मक डेमो)
...
- `chainlit` स्थापना गरिएको (पहिले नै Module08 को `requirements.txt` मा)
- WebGPU-सक्षम ब्राउजर (Windows 11 मा Edge / Chrome को पछिल्लो संस्करण)
- Foundry Local चलिरहेको (`foundry service status`)

### क्रस-प्ल्याटफर्म नोट्स

Windows प्राथमिक लक्ष्य वातावरण रहन्छ। macOS विकासकर्ताहरूले देशी बाइनरीहरूको प्रतीक्षा गर्दा:
...
ट्र्याक गर्नुहोस्: प्रतिक्रिया गहिराई, तथ्यात्मक शुद्धता, शैलीगत समृद्धि, लेटेंसी।

GPU सक्षम गरेपछि बनाम CPU मात्रको throughput परिवर्तनहरू अवलोकन गर्नुहोस्।

### ३. ब्राउजरमा WebGPU इन्फरेन्स (६ मिनेट)

स्टार्टर `04-webgpu-inference` अनुकूलन गर्नुहोस् (सिर्जना गर्नुहोस् `samples/04-cutting-edge/webgpu_demo.html`):
...
- RAG सन्दर्भ इनलाइन समावेश गर्नुहोस् (सन्दर्भ डकहरूका लागि टेक्स्टएरिया)
...
| सन्दर्भ पालन | राम्रो | बलियो | ठूलो मोडेल अधिक विस्तृत हुन सक्छ |
...
| उच्च लेटेंसी | मोडेल मात्र लोड गरिएको | सानो प्रम्प्ट अनुक्रमसँग तातो बनाउनुहोस् |
...
| कार्यशाला कलाकृतिहरू | परिदृश्य | उद्देश्य | डाटा / प्रम्प्ट स्रोत |
|--------------------|----------|-----------|----------------------|
| `samples/session04/model_compare.py` / `notebooks/session04_model_compare.ipynb` | कार्य वास्तुकला टोलीले कार्यकारी सारांश जनरेटरको लागि SLM बनाम LLM मूल्याङ्कन गर्दै | लेटेंसी + टोकन प्रयोग डेल्टा मात्रात्मक बनाउनुहोस् | एकल `COMPARE_PROMPT` env var |
| `chainlit_app.py` (RAG डेमो) | आन्तरिक ज्ञान सहायक प्रोटोटाइप | छोटो उत्तरहरू न्यूनतम शब्दावली पुनःप्राप्तिसँग आधार बनाउनुहोस् | फाइलमा इनलाइन `DOCS` सूची |
| `webgpu_demo.html` | भविष्यवादी उपकरणमा ब्राउजर इन्फरेन्स पूर्वावलोकन | कम लेटेंसी स्थानीय राउन्डट्रिप + UX कथा देखाउनुहोस् | प्रत्यक्ष प्रयोगकर्ता प्रम्प्ट मात्र |

### परिदृश्य कथा
उत्पादन संगठनले कार्यकारी ब्रीफिङ जनरेटर चाहन्छ। हल्का SLM (phi‑4‑mini) ले सारांशहरू तयार गर्छ; ठूलो LLM (gpt‑oss‑20b) ले मात्र उच्च प्राथमिकता रिपोर्टहरू परिष्कृत गर्न सक्छ। सत्र स्क्रिप्टहरूले हाइब्रिड डिजाइनलाई न्याय दिनको लागि अनुभवजन्य लेटेंसी र टोकन मेट्रिक्स समेट्छ, जबकि Chainlit डेमोले देखाउँछ कि आधारभूत पुनःप्राप्तिले साना मोडेल उत्तरहरू तथ्यात्मक राख्छ। WebGPU अवधारणा पृष्ठले ब्राउजर एक्सेलेरेशन परिपक्व हुँदा पूर्णतया क्लाइन्ट-साइड प्रशोधनको लागि दृष्टि मार्ग प्रदान गर्दछ।
...
| WebGPU क्यासिङ | छिटो JS इनिट | पुनःसंकलन ओभरहेड घटाउनुहोस् | क्यास गरिएको शेडर कलाकृतिहरू (भविष्य Runtime क्षमता) |
...
| ऊर्जा / स्रोत नोट्स | कक्षा छलफल | व्यापार-अफ देखाउनुहोस् | OS मोनिटरहरू प्रयोग गर्नुहोस् (टास्क म्यानेजर, `nvidia-smi`) + बेंचमार्क स्क्रिप्ट आउटपुटहरू |
| लागत अनुकरण | प्रि-क्लाउड न्यायसंगतता | स्केलिङ योजना | टोकनहरूलाई TCO कथाको लागि काल्पनिक क्लाउड मूल्य निर्धारणमा म्याप गर्नुहोस् |
| लेटेंसी विघटन | बोतलनेकहरू पहिचान गर्नुहोस् | अनुकूलनहरू लक्ष्य बनाउनुहोस् | प्रम्प्ट तयारी, अनुरोध पठाउनुहोस्, पहिलो टोकन, पूर्ण समाप्ति मापन गर्नुहोस् |
