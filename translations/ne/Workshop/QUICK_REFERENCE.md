...
| ०२ | `rag_pipeline.py` | RAG इम्बेडिङसहित | ~४५ सेकेन्ड |
...
| मोडेल | आकार | उत्तम प्रयोगको लागि | गति |
|-------|------|---------------------|------|
...
1. **क्लाइन्ट क्यास गर्नुहोस्**: `workshop_utils` ले तपाईंको लागि क्यास गर्छ
...
5. **कम max_tokens सेट गर्नुहोस्**: छिटो प्रतिक्रिया प्राप्त गर्न ढिलाइ कम गर्छ
...
**छिटो सहयोग**: `samples` डाइरेक्टरीबाट `--help` प्रयोग गरेर कुनै पनि नमूना चलाउनुहोस् वा डकस्ट्रिङ जाँच गर्नुहोस्:
```bash
...
**सबै नमूनाहरू अक्टोबर २०२५ मा Foundry Local SDK उत्तम अभ्यासहरूसँग अद्यावधिक गरिएका छन्** ✨
