...
### 🏗️ Progetti Pratici
- **App di Chat Locali Foundry**: Applicazione nativa Windows 11 con cambio modello
- **Sistemi Multi-Agente**: Coordinatore con agenti specialisti per flussi di lavoro complessi  
- **Applicazioni RAG**: Elaborazione locale di documenti con ricerca vettoriale
...
📖 **[Guida di Studio Disponibile](STUDY_GUIDE.md)**: Percorso di apprendimento strutturato di 20 ore con indicazioni sui tempi e strumenti di autovalutazione.
