...
1. **Fork do Repositório**: Clique em [![Forks do GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
Bem-vindo ao **EdgeAI para Iniciantes** – sua jornada abrangente no mundo transformador da Inteligência Artificial na Borda. Este curso preenche a lacuna entre as poderosas capacidades da IA e a implantação prática e real em dispositivos de borda, capacitando você a aproveitar o potencial da IA diretamente onde os dados são gerados e as decisões precisam ser tomadas.

### O Que Você Vai Dominar

Este curso o leva dos conceitos fundamentais até implementações prontas para produção, abrangendo:
- **Pequenos Modelos de Linguagem (SLMs)** otimizados para implantação na borda
- **Otimização considerando hardware** em diversas plataformas
...
Edge AI representa uma mudança de paradigma que aborda desafios críticos modernos:
- **Privacidade e Segurança**: Processa dados sensíveis localmente sem exposição à nuvem
- **Desempenho em Tempo Real**: Elimina latência de rede para aplicações críticas no tempo
...
Edge AI refere-se à execução de algoritmos de IA e modelos de linguagem localmente no hardware, próximo ao local onde os dados são gerados, sem depender de recursos da nuvem para inferência. Isso reduz a latência, melhora a privacidade e permite tomada de decisões em tempo real.

### Princípios Básicos:
- **Inferência no dispositivo**: Modelos de IA executam em dispositivos de borda (telefones, roteadores, microcontroladores, PCs industriais)
...
- **Redução do uso de memória**: Uso eficiente da memória limitada do dispositivo de borda
- **Menor demanda de processamento**: Otimizado para desempenho em CPU e GPU de borda
- **Tempos de inicialização mais rápidos**: Inicialização rápida para aplicações responsivas

Eles desbloqueiam poderosas capacidades de PNL atendendo às restrições de:
- **Sistemas embarcados**: Dispositivos IoT e controladores industriais
- **Dispositivos móveis**: Smartphones e tablets com funcionalidades offline
- **Dispositivos IoT**: Sensores e dispositivos inteligentes com recursos limitados
- **Servidores de borda**: Unidades de processamento locais com recursos GPU limitados
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [Introdução ao EdgeAI](./introduction.md) | Fundamentos e Contexto | Visão Geral do EdgeAI • Aplicações na Indústria • Introdução a SLM • Objetivos de Aprendizagem | Iniciante | 1-2 hrs |
| [📚 01](../../Module01) | [Fundamentos do EdgeAI](./Module01/README.md) | Comparação Nuvem vs Edge AI | Fundamentos do EdgeAI • Estudos de Caso Reais • Guia de Implementação • Implantação na Borda | Iniciante | 3-4 hrs |
| [🧠 02](../../Module02) | [Fundamentos de Modelos SLM](./Module02/README.md) | Famílias e Arquitetura de Modelos | Família Phi • Família Qwen • Família Gemma • BitNET • μModel • Phi-Silica | Iniciante | 4-5 hrs |
| [🚀 03](../../Module03) | [Prática de Implantação SLM](./Module03/README.md) | Implantação Local e na Nuvem | Aprendizagem Avançada • Ambiente Local • Implantação na Nuvem | Intermediário | 4-5 hrs |
| [⚙️ 04](../../Module04) | [Kit de Ferramentas para Otimização de Modelos](./Module04/README.md) | Otimização Multiplataforma | Introdução • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Síntese de Fluxo de Trabalho | Intermediário | 5-6 hrs |
| [🔧 05](../../Module05) | [Produção SLMOps](./Module05/README.md) | Operações em Produção | Introdução ao SLMOps • Destilação de Modelos • Fine-tuning • Implantação em Produção | Avançado | 5-6 hrs |
| [🤖 06](../../Module06) | [Agentes de IA & Chamada de Funções](./Module06/README.md) | Frameworks de Agentes & MCP | Introdução a Agentes • Chamada de Funções • Protocolo de Contexto de Modelo | Avançado | 4-5 hrs |
| [💻 07](../../Module07) | [Implementação de Plataforma](./Module07/README.md) | Exemplos Multiplataforma | Kit de Ferramentas AI • Foundry Local • Desenvolvimento Windows | Avançado | 3-4 hrs |
| [🏭 08](../../Module08) | [Kit de Ferramentas Foundry Local](./Module08/README.md) | Exemplos prontos para produção | Aplicações de amostra (veja detalhes abaixo) | Especialista | 8-10 hrs |

### 🏭 **Módulo 08: Aplicações de Amostra**

- [01: Introdução rápida ao REST Chat](./Module08/samples/01/README.md)
- [02: Integração com SDK OpenAI](./Module08/samples/02/README.md)
...
- [07: Cliente API Direta](./Module08/samples/07/README.md)
...
Material abrangente de workshop prático com implementações prontas para produção:
...
- **Guias de Sessão** - Guias markdown detalhados para cada sessão do workshop
...
Construa um pipeline de produção de podcast alimentado por IA do zero! Este workshop imersivo ensina você a criar um sistema multi-agente completo que transforma ideias em episódios profissionais de podcast.
**[🎬 Inicie o Workshop do Estúdio de Podcast com IA](./WorkshopForAgentic/README.md)**

**Sua Missão**: Lance "Future Bytes" — um podcast de tecnologia inteiramente alimentado por agentes de IA que você mesmo construirá. Sem dependências na nuvem, sem custos de API — tudo roda localmente na sua máquina.
...
- **🎯 Pipeline Completo de Produção** - Da seleção do tema até a saída final do áudio do podcast
- **💻 Implantação 100% Local** - Usa Ollama e modelos locais (Qwen-3-8B) para privacidade e controle totais
- **🎤 Integração Texto-para-Fala** - Transforme roteiros em conversas naturais com múltiplos locutores
- **✋ Fluxos de Trabalho com Participação Humana** - Portões de aprovação garantem qualidade enquanto mantêm automação

**Jornada de Aprendizado em Três Atos:**

| Ato | Foco | Habilidades-Chave | Duração |
|-----|-------|------------|----------|
| **[Ato 1: Conheça Seus Assistentes de IA](./WorkshopForAgentic/md/01.BuildAIAgentWithSLM.md)** | Construa seu primeiro agente de IA | Integração de ferramentas • Pesquisa web • Resolução de problemas • Raciocínio agente | 2-3 hrs |
...
| **[Ato 3: Dê Vida ao Seu Podcast](./WorkshopForAgentic/md/03.Multi-SpeakerPodcastGenerationWithVibeVoice.md)** | Gere o áudio do podcast | Texto-para-fala • Síntese com múltiplos locutores • Áudio de longa duração • Automação completa | 2-3 hrs |

**Tecnologias Utilizadas:**
- **Microsoft Agent Framework** - Orquestração e coordenação de múltiplos agentes
- **Ollama** - Runtime de modelo de IA local (sem necessidade de nuvem)
- **Qwen-3-8B** - Modelo de linguagem open-source otimizado para tarefas agentivas
- **APIs Texto-Para-Fala** - Síntese de voz natural para geração de podcasts

**Suporte de Hardware:**
- ✅ **Modo CPU** - Funciona em qualquer computador moderno (recomendado 8GB+ de RAM)
...
**Comece a Construir**: [🎙️ Workshop do Estúdio de Podcast com IA →](./WorkshopForAgentic/README.md)
...
- **Arquitetura Edge AI**: Projete sistemas de IA com prioridade local e integração com nuvem
- **Otimização de Modelos**: Quantize e comprima modelos para implantação de borda (85% mais rápido, 75% menor)
- **Implantação Multi-Plataforma**: Windows, mobile, embarcados e sistemas híbridos nuvem-borda
- **Operações de Produção**: Monitoramento, escalonamento e manutenção de IA na borda em produção

### 🏗️ Projetos Práticos
- **Apps Locais Foundry Chat**: Aplicativo nativo Windows 11 com troca de modelos
...
- **Roteadores de Modelos**: Seleção inteligente entre modelos com análise de tarefa
...
**Caminho Recomendado de Aprendizado** (20-30 horas no total):

0. **📖 Introdução** ([Introduction.md](./introduction.md)): Fundamentos EdgeAI + contexto industrial + framework de aprendizado  
1. **📚 Fundamentos** (Módulos 01-02): Conceitos EdgeAI + famílias de modelos SLM  
2. **⚙️ Otimização** (Módulos 03-04): Frameworks de implantação + quantização  
...
**Papeis Técnicos**: Arquiteto de Soluções EdgeAI • Engenheiro ML (Edge) • Desenvolvedor AI para IoT • Desenvolvedor AI Mobile

**Setores da Indústria**: Manufatura 4.0 • Tecnologia em Saúde • Sistemas Autônomos • FinTech • Eletrônicos de Consumo

**Projetos para Portfólio**: Sistemas multi-agente • Apps RAG em produção • Implantação cross-platform • Otimização de desempenho
...
✅ **Exemplos Práticos**: 50+ exemplos, 10 demonstrações completas Foundry Local  
✅ **Foco em Performance**: Melhoria de 85% em velocidade, redução de 75% no tamanho  
✅ **Multi-Plataforma**: Windows, mobile, embarcados, híbrido nuvem-borda  
✅ **Pronto para Produção**: Monitoramento, escalonamento, segurança, compliance

📖 **[Guia de Estudo Disponível](STUDY_GUIDE.md)**: Caminho estruturado de aprendizado de 20 horas com orientação de tempo e ferramentas de autoavaliação.

---

**EdgeAI representa o futuro da implantação de IA**: local-primeiro, preservação de privacidade e eficiente. Domine essas habilidades para construir a próxima geração de aplicativos inteligentes.
...
Se você ficar preso ou tiver alguma dúvida sobre como criar aplicativos de IA, entre em:
