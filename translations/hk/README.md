...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T08:34:31+00:00",
...
歡迎來到 **EdgeAI 初學者指南** — 您全面探索邊緣人工智能變革世界的旅程。本課程架起強大 AI 能力與邊緣設備實際部署之間的橋樑，使您能直接在數據產生和決策需要發生的地方，發揮 AI 的潛力。
...
Edge AI 指在硬件本地運行 AI 演算法和語言模型，靠近數據產生地點，無需依賴雲端資源進行推理。它降低延遲、增強隱私，並實現實時決策。
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [EdgeAI 介紹](./introduction.md) | 基礎與背景 | EdgeAI 概述 • 行業應用 • SLM 介紹 • 學習目標 | 初學者 | 1-2 小時 |
| [📚 01](../../Module01) | [EdgeAI 基礎](./Module01/README.md) | 雲端與邊緣 AI 比較 | EdgeAI 基礎 • 實際案例研究 • 實作指南 • 邊緣部署 | 初學者 | 3-4 小時 |
...
| [🤖 06](../../Module06) | [AI 代理與函數調用](./Module06/README.md) | 代理框架與 MCP | 代理介紹 • 函數調用 • 模型上下文協議 | 高階 | 4-5 小時 |
