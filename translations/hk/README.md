...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:31:33+00:00",
...
**如需支援其他語言，請參考 [此處](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**

## 簡介

歡迎來到 **EdgeAI 初學者指南**——一個全面探索邊緣人工智能世界的旅程。本課程將強大的 AI 能力與實際應用部署於邊緣設備相結合，幫助您直接在數據生成及決策需要的地方發揮 AI 的潛力。
...
邊緣 AI 是指在硬件上本地運行 AI 算法及語言模型，靠近數據生成的地方進行推理，而不依賴雲端資源。它能減少延遲、提升隱私並支持實時決策。

### 核心原則：
- **設備端推理**：AI 模型在邊緣設備（如手機、路由器、微控制器、工業 PC）上運行
- **離線能力**：無需持續的網絡連接即可運作
- **低延遲**：即時響應，適合實時系統
- **數據主權**：將敏感數據保留在本地，提升安全性及合規性

### 小型語言模型 (SLMs)

SLMs 如 Phi-4、Mistral-7B 和 Gemma 是大型 LLM 的優化版本，經過訓練或蒸餾以達到：
- **減少內存佔用**：有效利用邊緣設備有限的內存
- **降低計算需求**：針對 CPU 和邊緣 GPU 性能進行優化
- **更快啟動時間**：快速初始化，適合響應式應用
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [邊緣 AI 簡介](./introduction.md) | 基礎及背景 | 邊緣 AI 概述 • 行業應用 • SLM 簡介 • 學習目標 | 初學者 | 1-2 小時 |
| [📚 01](../../Module01) | [邊緣 AI 基礎](./Module01/README.md) | 雲端與邊緣 AI 比較 | 邊緣 AI 基礎 • 真實案例研究 • 實施指南 • 邊緣部署 | 初學者 | 3-4 小時 |
| [🧠 02](../../Module02) | [SLM 模型基礎](./Module02/README.md) | 模型家族及架構 | Phi 家族 • Qwen 家族 • Gemma 家族 • BitNET • μModel • Phi-Silica | 初學者 | 4-5 小時 |
| [🚀 03](../../Module03) | [SLM 部署實踐](./Module03/README.md) | 本地及雲端部署 | 高級學習 • 本地環境 • 雲端部署 | 中級 | 4-5 小時 |
...
| [🤖 06](../../Module06) | [AI 代理及功能調用](./Module06/README.md) | 代理框架及 MCP | 代理簡介 • 功能調用 • 模型上下文協議 | 高級 | 4-5 小時 |
| [💻 07](../../Module07) | [平台實施](./Module07/README.md) | 跨平台範例 | AI 工具包 • Foundry Local • Windows 開發 | 高級 | 3-4 小時 |
| [🏭 08](../../Module08) | [Foundry Local 工具包](./Module08/README.md) | 生產級範例 | 範例應用（詳情見下方） | 專家 | 8-10 小時 |

### 🏭 **模組 08：範例應用**

- [01: REST 聊天快速入門](./Module08/samples/01/README.md)
- [02: OpenAI SDK 整合](./Module08/samples/02/README.md)
- [03: 模型探索及基準測試](./Module08/samples/03/README.md)
...
- **[工作坊指南](./Workshop/Readme.md)** - 完整的學習目標、成果及資源導航
- **Python 範例**（6 場次） - 更新最佳實踐、錯誤處理及全面文檔
- **Jupyter 筆記本**（8 個互動式） - 分步教程，包含基準測試及性能監控
- **場次指南** - 每場工作坊的詳細 Markdown 指南
- **驗證工具** - 用於檢查代碼質量及執行煙霧測試的腳本
...
### 🎯 核心能力
- **邊緣 AI 架構**：設計本地優先的 AI 系統，並結合雲端整合
- **模型優化**：量化及壓縮模型以進行邊緣部署（提升速度 85%，減少大小 75%）
- **多平台部署**：Windows、移動設備、嵌入式及雲端-邊緣混合系統
- **生產運作**：監控、擴展及維護生產中的邊緣AI

### 🏗️ 實用項目
- **Foundry本地聊天應用程式**：Windows 11原生應用程式，支援模型切換
- **多代理系統**：協調器與專家代理，用於複雜工作流程
- **RAG應用程式**：本地文件處理，結合向量搜索
- **模型路由器**：根據任務分析智能選擇模型
...
1. **📚 基礎**（模組01-02）：邊緣AI概念 + SLM模型系列
2. **⚙️ 優化**（模組03-04）：部署 + 量化框架
3. **🚀 生產**（模組05-06）：SLMOps + AI代理 + 函數調用
4. **💻 實施**（模組07-08）：平台範例 + Foundry本地工具包

每個模組包括理論、實踐練習及生產級代碼範例。

## 職業影響

**技術職位**：邊緣AI解決方案架構師 • 邊緣ML工程師 • IoT AI開發者 • 移動AI開發者

**行業領域**：製造業4.0 • 醫療科技 • 自動化系統 • 金融科技 • 消費電子

**作品集項目**：多代理系統 • 生產級RAG應用程式 • 跨平台部署 • 性能優化
...
**邊緣AI代表AI部署的未來**：本地優先、保護隱私及高效。掌握這些技能，打造下一代智能應用程式。
...
**免責聲明**：  
此文件已使用人工智能翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 翻譯。我們致力於提供準確的翻譯，但請注意，自動翻譯可能包含錯誤或不準確之處。應以原文文件為權威來源。如涉及關鍵資訊，建議尋求專業人工翻譯。我們對因使用此翻譯而引起的任何誤解或誤釋概不負責。
