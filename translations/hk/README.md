...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:47:01+00:00",
...
歡迎來到 **初學者的邊緣人工智能課程**——這是一個全面的旅程，帶您進入邊緣人工智能的變革世界。本課程將強大的人工智能能力與邊緣設備上的實際部署相結合，幫助您直接在數據生成和需要做出決策的地方發揮人工智能的潛力。
...
邊緣人工智能指的是在硬件上本地運行人工智能算法和語言模型，靠近數據生成的地方，而不依賴雲端資源進行推理。它能降低延遲、增強隱私並支持實時決策。

### 核心原則：
- **設備上的推理**：人工智能模型在邊緣設備（手機、路由器、微控制器、工業PC）上運行
- **離線能力**：無需持續的互聯網連接即可運行
- **低延遲**：即時響應，適合實時系統
...
- **多平台部署**：Windows、移動端、嵌入式及雲端邊緣混合系統  
...
1. **📚 基礎**（模塊01-02）：邊緣AI概念 + SLM模型系列  
2. **⚙️ 優化**（模塊03-04）：部署 + 量化框架  
3. **🚀 生產**（模塊05-06）：SLMOps + AI代理 + 函數調用  
4. **💻 實施**（模塊07-08）：平台示例 + Foundry本地工具包  

每個模塊包含理論、實操練習及生產級代碼示例。  
...
**邊緣AI代表了AI部署的未來**：本地優先、保護隱私、高效。掌握這些技能，打造下一代智能應用。  
...
如果遇到困難或有關於構建AI應用的問題，請加入：  

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)  

如果有產品反饋或在構建過程中遇到錯誤，請訪問：  
