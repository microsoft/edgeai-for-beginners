...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:41:13+00:00",
...
[![درخواست‌های pull GitHub](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
1. **شاخه‌گیری مخزن**: کلیک کنید [![شاخه‌های GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
2. **کلون کردن مخزن**:   `git clone https://github.com/microsoft/edgeai-for-beginners.git`
3. [**به Discord Azure AI Foundry بپیوندید و با کارشناسان و توسعه‌دهندگان هم‌سطح ملاقات کنید**](https://discord.com/invite/ByRwuEEgH4)
...
**اگر مایلید زبان‌های ترجمه بیشتری پشتیبانی شوند، فهرست آن‌ها در [اینجا](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) آمده است**
## مقدمه

به **EdgeAI برای مبتدی‌ها** خوش آمدید – سفر جامع شما به دنیای تحول‌آفرین هوش مصنوعی لبه‌ای. این دوره فاصله بین قابلیت‌های قدرتمند هوش مصنوعی و استقرار عملی و واقعی روی دستگاه‌های لبه‌ای را پر می‌کند و به شما امکان می‌دهد پتانسیل هوش مصنوعی را مستقیماً در جایی که داده تولید می‌شود و تصمیم‌گیری باید انجام شود، به کار بگیرید.

### چه مهارت‌هایی کسب خواهید کرد

این دوره شما را از مفاهیم پایه تا پیاده‌سازی‌های آماده تولید همراهی می‌کند، شامل:
- **مدل‌های زبان کوچک (SLM)** بهینه‌شده برای استقرار لبه‌ای
- **بهینه‌سازی آگاه از سخت‌افزار** در پلتفرم‌های متنوع
- **استنتاج در زمان واقعی** با قابلیت‌های حفظ حریم خصوصی
- **استراتژی‌های استقرار تولید** برای برنامه‌های سازمانی

### چرا EdgeAI اهمیت دارد

هوش مصنوعی لبه‌ای نمایانگر یک تغییر پارادایم است که به چالش‌های حیاتی مدرن پاسخ می‌دهد:
- **حریم خصوصی و امنیت**: پردازش داده‌های حساس به صورت محلی بدون افشای ابری
...
هوش مصنوعی لبه‌ای به اجرای الگوریتم‌ها و مدل‌های زبان هوش مصنوعی به صورت محلی روی سخت‌افزار، نزدیک به جایی که داده تولید می‌شود، بدون وابستگی به منابع ابری برای استنتاج اشاره دارد. این روش تأخیر را کاهش می‌دهد، حریم خصوصی را افزایش می‌دهد و امکان تصمیم‌گیری در زمان واقعی را فراهم می‌کند.

### اصول اصلی:
- **استنتاج روی دستگاه**: مدل‌های هوش مصنوعی روی دستگاه‌های لبه‌ای (تلفن‌ها، روترها، میکروکنترلرها، کامپیوترهای صنعتی) اجرا می‌شوند
- **قابلیت آفلاین**: عملکرد بدون اتصال مداوم به اینترنت
- **تاخیر کم**: پاسخ‌های فوری مناسب سیستم‌های زمان واقعی
- **حاکمیت داده**: نگهداری داده‌های حساس به صورت محلی، افزایش امنیت و انطباق

### مدل‌های زبان کوچک (SLM)

مدل‌های زبان کوچک مانند Phi-4، Mistral-7B و Gemma نسخه‌های بهینه‌شده مدل‌های بزرگ‌تر LLM هستند که برای:
...
آن‌ها قابلیت‌های قدرتمند پردازش زبان طبیعی را در حالی فراهم می‌کنند که محدودیت‌های:
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [مقدمه‌ای بر EdgeAI](./introduction.md) | پایه و زمینه | مرور کلی EdgeAI • کاربردهای صنعتی • معرفی SLM • اهداف یادگیری | مبتدی | ۱-۲ ساعت |
| [📚 01](../../Module01) | [مبانی EdgeAI](./Module01/README.md) | مقایسه هوش مصنوعی ابری و لبه‌ای | مبانی EdgeAI • مطالعات موردی دنیای واقعی • راهنمای پیاده‌سازی • استقرار لبه‌ای | مبتدی | ۳-۴ ساعت |
...
| [⚙️ 04](../../Module04) | [جعبه‌ابزار بهینه‌سازی مدل](./Module04/README.md) | بهینه‌سازی چندپلتفرمی | معرفی • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • ترکیب جریان کاری | متوسط | ۵-۶ ساعت |
| [🔧 05](../../Module05) | [عملیات تولید SLMOps](./Module05/README.md) | عملیات تولید | معرفی SLMOps • تقطیر مدل • تنظیم دقیق • استقرار تولید | پیشرفته | ۵-۶ ساعت |
| [🤖 06](../../Module06) | [عامل‌های هوش مصنوعی و فراخوانی تابع](./Module06/README.md) | چارچوب‌های عامل و MCP | معرفی عامل • فراخوانی تابع • پروتکل زمینه مدل | پیشرفته | ۴-۵ ساعت |
...
- **نمونه‌های پایتون** (۶ جلسه) - به‌روزرسانی شده با بهترین شیوه‌ها، مدیریت خطا و مستندسازی جامع
- **دفترچه‌های Jupyter** (۸ تعاملی) - آموزش گام به گام با بنچمارک‌ها و نظارت بر عملکرد
...
**آنچه خواهید ساخت:**
- برنامه‌های چت هوش مصنوعی محلی با پشتیبانی از پخش زنده
...
- **مسیر خبره**: ماژول ۰۸ (۸-۱۰ ساعت)

## آنچه خواهید ساخت

### 🎯 مهارت‌های اصلی
- **معماری هوش مصنوعی لبه‌ای**: طراحی سیستم‌های هوش مصنوعی با اولویت محلی و ادغام ابری
- **بهینه‌سازی مدل**: کمّی‌سازی و فشرده‌سازی مدل‌ها برای استقرار در لبه (افزایش سرعت ۸۵٪، کاهش اندازه ۷۵٪)  
- **استقرار چندسکویی**: ویندوز، موبایل، تعبیه‌شده و سیستم‌های ترکیبی ابر-لبه  
- **عملیات تولید**: نظارت، مقیاس‌بندی و نگهداری هوش مصنوعی لبه در تولید  

### 🏗️ پروژه‌های عملی  
- **برنامه‌های چت محلی Foundry**: برنامه بومی ویندوز ۱۱ با قابلیت تغییر مدل  
...
**مسیر یادگیری پیشنهادی** (۲۰-۳۰ ساعت مجموع):  

0. **📖 مقدمه** ([Introduction.md](./introduction.md)): پایه‌های EdgeAI + زمینه صنعتی + چارچوب یادگیری  
1. **📚 پایه‌ها** (ماژول‌های ۰۱-۰۲): مفاهیم EdgeAI + خانواده مدل‌های SLM  
2. **⚙️ بهینه‌سازی** (ماژول‌های ۰۳-۰۴): استقرار + چارچوب‌های کمّی‌سازی  
3. **🚀 تولید** (ماژول‌های ۰۵-۰۶): SLMOps + عوامل هوش مصنوعی + فراخوانی تابع  
4. **💻 پیاده‌سازی** (ماژول‌های ۰۷-۰۸): نمونه‌های سکویی + جعبه‌ابزار Foundry Local  

هر ماژول شامل نظریه، تمرین‌های عملی و نمونه‌های کد آماده تولید است.  

## تأثیر شغلی  

**نقش‌های فنی**: معمار راه‌حل‌های EdgeAI • مهندس یادگیری ماشین (لبه) • توسعه‌دهنده هوش مصنوعی اینترنت اشیا • توسعه‌دهنده هوش مصنوعی موبایل  

**بخش‌های صنعتی**: تولید ۴.۰ • فناوری بهداشت و درمان • سیستم‌های خودران • فناوری مالی • الکترونیک مصرفی  

**پروژه‌های نمونه‌کار**: سیستم‌های چندعامله • برنامه‌های تولیدی RAG • استقرار چندسکویی • بهینه‌سازی عملکرد  
...
✅ **یادگیری تدریجی**: نظریه → عمل → استقرار در تولید  
...
✅ **آماده تولید**: نظارت، مقیاس‌بندی، امنیت، چارچوب‌های انطباق  

📖 **[راهنمای مطالعه موجود](STUDY_GUIDE.md)**: مسیر یادگیری ساختاریافته ۲۰ ساعته با راهنمای تخصیص زمان و ابزارهای خودارزیابی.  

---  

**EdgeAI نمایانگر آینده استقرار هوش مصنوعی است**: اولویت محلی، حفظ حریم خصوصی و کارآمد. این مهارت‌ها را بیاموزید تا نسل بعدی برنامه‌های هوشمند را بسازید.  
