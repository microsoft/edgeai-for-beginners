...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:26:45+00:00",
...
1. **انشعاب دادن مخزن**: کلیک کنید [![انشعابات GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
- [09: سیستم پیشرفته چندعامل](./Module08/samples/09/README.md)
...
- **نمونه‌های پایتون** (6 جلسه) - به‌روزرسانی شده با بهترین شیوه‌ها، مدیریت خطا و مستندسازی جامع
...
- **استقرار چندپلتفرمی**: ویندوز، موبایل، جاسازی‌شده و سیستم‌های ترکیبی لبه-ابری
...
0. **📖 مقدمه** ([Introduction.md](./introduction.md)): مبانی EdgeAI + زمینه صنعتی + چارچوب یادگیری  
1. **📚 مبانی** (ماژول‌های ۰۱-۰۲): مفاهیم EdgeAI + خانواده‌های مدل SLM  
2. **⚙️ بهینه‌سازی** (ماژول‌های ۰۳-۰۴): استقرار + چارچوب‌های کوانتایزیشن  
...
**نقش‌های فنی**: معمار راه‌حل‌های EdgeAI • مهندس یادگیری ماشین (لبه) • توسعه‌دهنده IoT AI • توسعه‌دهنده موبایل AI  
...
✅ **یادگیری تدریجی**: تئوری → تمرین → استقرار تولید  
...
📖 **[راهنمای مطالعه موجود است](STUDY_GUIDE.md)**: مسیر یادگیری ساختاریافته ۲۰ ساعته با راهنمای تخصیص زمان و ابزارهای ارزیابی خود.
...
اگر در ساخت اپلیکیشن‌های هوش مصنوعی گیر کردید یا سوالی داشتید، به اینجا بپیوندید:
