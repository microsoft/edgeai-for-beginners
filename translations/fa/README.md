...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T11:26:49+00:00",
...
هوش مصنوعی لبه‌ای به اجرای الگوریتم‌ها و مدل‌های زبان هوش مصنوعی به صورت محلی روی سخت‌افزار، نزدیک به جایی که داده تولید می‌شود، بدون وابستگی به منابع ابری برای استنتاج اشاره دارد. این کار تأخیر را کاهش می‌دهد، حریم خصوصی را افزایش می‌دهد و امکان تصمیم‌گیری در زمان واقعی را فراهم می‌کند.
...
- **حاکمیت داده**: نگهداری داده‌های حساس به صورت محلی، بهبود امنیت و انطباق
...
آن‌ها قابلیت‌های قدرتمند پردازش زبان طبیعی را باز می‌کنند در حالی که محدودیت‌های زیر را رعایت می‌کنند:
...
| [📚 01](../../Module01) | [مبانی EdgeAI](./Module01/README.md) | مقایسه هوش مصنوعی ابری و لبه‌ای | مبانی EdgeAI • مطالعات موردی واقعی • راهنمای پیاده‌سازی • استقرار لبه‌ای | مبتدی | ۳-۴ ساعت |
...
**پروژه‌های نمونه‌کار**: سیستم‌های چندعاملی • برنامه‌های تولیدی RAG • استقرار چندسکویی • بهینه‌سازی عملکرد  
...
اگر بازخورد محصول یا خطا هنگام ساخت دارید، مراجعه کنید به:  
