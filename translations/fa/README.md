...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T16:44:06+00:00",
...
**اگر مایل به اضافه کردن زبان‌های ترجمه بیشتری هستید، زبان‌های پشتیبانی شده [اینجا](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) فهرست شده‌اند.**
...
- **مدل‌های زبان کوچک (SLMs)** بهینه‌شده برای پیاده‌سازی در لبه
- **بهینه‌سازی مبتنی بر سخت‌افزار** در پلتفرم‌های مختلف
- **استنتاج بلادرنگ** با قابلیت‌های حفظ حریم خصوصی
- **استراتژی‌های پیاده‌سازی تولید** برای برنامه‌های سازمانی
...
هوش مصنوعی لبه به اجرای الگوریتم‌های هوش مصنوعی و مدل‌های زبان به صورت محلی بر روی سخت‌افزار، نزدیک به جایی که داده‌ها تولید می‌شوند، بدون وابستگی به منابع ابری برای استنتاج اشاره دارد. این امر تأخیر را کاهش می‌دهد، حریم خصوصی را افزایش می‌دهد و تصمیم‌گیری بلادرنگ را ممکن می‌سازد.

### اصول اصلی:
- **استنتاج در دستگاه**: مدل‌های هوش مصنوعی بر روی دستگاه‌های لبه (تلفن‌ها، روترها، میکروکنترلرها، کامپیوترهای صنعتی) اجرا می‌شوند
...
- **کامپیوترهای شخصی**: سناریوهای پیاده‌سازی دسکتاپ و لپ‌تاپ
...
| [🤖 06](../../Module06) | [عامل‌های هوش مصنوعی و فراخوانی توابع](./Module06/README.md) | چارچوب‌های عامل و MCP | مقدمه عامل • فراخوانی توابع • پروتکل زمینه مدل | پیشرفته | 4-5 ساعت |
...
- [06: مسیریاب ابزار مدل‌ها](./Module08/samples/06/README.md)
...
- **راهنماهای جلسه** - راهنماهای دقیق در قالب Markdown برای هر جلسه کارگاه
...
- **بهینه‌سازی مدل**: کمینه‌سازی و فشرده‌سازی مدل‌ها برای پیاده‌سازی در لبه (85% افزایش سرعت، 75% کاهش اندازه)
- **استقرار چند پلتفرمی**: ویندوز، موبایل، سیستم‌های جاسازی‌شده و ترکیبی از لبه ابری  
...
- **سیستم‌های چند عاملی**: هماهنگ‌کننده با عوامل تخصصی برای جریان‌های کاری پیچیده  
...
- **ابزارهای چند پلتفرمی**: الگوهای یکپارچه‌سازی LangChain/Semantic Kernel  
...
**مسیر یادگیری پیشنهادی** (مجموعاً 20-30 ساعت):  
...
**پروژه‌های نمونه کار**: سیستم‌های چند عاملی • اپلیکیشن‌های RAG تولیدی • استقرار چند پلتفرمی • بهینه‌سازی عملکرد  
...
✅ **چند پلتفرمی**: ویندوز، موبایل، جاسازی‌شده، ترکیبی لبه ابری  
