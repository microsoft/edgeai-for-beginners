...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T18:19:08+00:00",
...
1. **Haru repositooriumist**: Klõpsa [![GitHubi harud](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
Tere tulemast **EdgeAI algajatele** – teie põhjalik teekond Edge tehisintellekti muutlikku maailma. See kursus ühendab võimsad tehisintellekti võimalused ja praktilise, reaalse maailma rakendamise servaseadmetel, andes teile võimaluse kasutada tehisintellekti potentsiaali otse seal, kus andmeid luuakse ja otsuseid tehakse.
...
- **Kulutõhusus**: Vähenda ribalaiuse ja pilvearvutuse kulusid
- **Töökindlus**: Säilita funktsionaalsus võrgu katkestuste ajal
- **Regulatiivne vastavus**: Vasta andmesuveräänsuse nõuetele

### Edge AI

Edge AI tähendab tehisintellekti algoritmide ja keelemudelite käitamist kohapeal riistvaral, lähedal andmete loomise kohale, ilma et oleks vaja pilveressursse järeldamiseks. See vähendab viivitust, parandab privaatsust ja võimaldab reaalajas otsuste tegemist.
...
- **Võrguühenduseta võimekus**: Funktsioneerib ilma püsiva internetiühenduseta
- **Madal viivitus**: Kohesed vastused reaalajas süsteemidele
- **Andmesuveräänsus**: Hoiab tundlikud andmed kohapeal, parandades turvalisust ja vastavust

### Väikesed keelemudelid (SLM)

SLM-id nagu Phi-4, Mistral-7B ja Gemma on optimeeritud versioonid suurematest LLM-idest – treenitud või destilleeritud:
- **Väiksem mälumaht**: Efektiivne piiratud servaseadme mälu kasutamine
...
| [🤖 06](../../Module06) | [AI agendid ja funktsioonikutsed](./Module06/README.md) | Agendiraamistikud ja MCP | Agendi tutvustus • Funktsioonikutsed • Mudeli kontekstiprotokoll | Edasijõudnud | 4-5 tundi |
...
- **Jupyteri märkmikud** (8 interaktiivset) - Samm-sammult juhendid võrdlusuuringute ja jõudluse jälgimisega
- **Sessioonijuhendid** - Üksikasjalikud markdown-juhendid iga töötoa sessiooni jaoks
- **Valideerimistööriistad** - Skriptid koodi kvaliteedi kontrollimiseks ja suitsutestide läbiviimiseks

**Mida te ehitate:**
- Kohalikud AI vestlusrakendused voogedastuse toega
- RAG torustikud kvaliteedi hindamisega (RAGAS)
- Multi-mudeli võrdlus- ja võrdlustööriistad
...
- **API raamistikud**: Tootmiskliendid voogedastuse ja tervise jälgimisega
...
**Tehnilised rollid**: Serva AI lahenduste arhitekt • ML insener (serva) • IoT AI arendaja • Mobiili AI arendaja
...
✅ **Progressiivne õppimine**: Teooria → Praktika → Tootmiskõlblik juurutamine  
...
📖 **[Õpijuhend saadaval](STUDY_GUIDE.md)**: Struktureeritud 20-tunnine õpitee koos aja jaotamise juhiste ja enesehindamise tööriistadega.

---

**Serva AI esindab AI juurutamise tulevikku**: kohalik-keskne, privaatsust säilitav ja tõhus. Valda need oskused, et luua järgmise põlvkonna intelligentsed rakendused.

## Muud kursused

Meie meeskond toodab ka teisi kursusi! Vaata:

### Azure / Serv / MCP / Agendid
...
Kui sul on tootetagasisidet või vigu ehitamisel, külasta:
