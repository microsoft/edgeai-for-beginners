...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T17:21:25+00:00",
...
[![GitHub పుల్-రిక్వెస్టులు](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
1. **రిపోజిటరీని ఫోర్క్ చేయండి**: క్లిక్ చేయండి [![GitHub forks](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
...
**EdgeAI for Beginners** కు స్వాగతం – ఎడ్జ్ ఆర్టిఫిషియల్ ఇంటెలిజెన్స్ యొక్క మార్పిడి ప్రపంచంలో మీ సమగ్ర ప్రయాణం. ఈ కోర్సు శక్తివంతమైన AI సామర్థ్యాలు మరియు ఎడ్జ్ పరికరాలపై ప్రాక్టికల్, వాస్తవ ప్రపంచ అమలును కలిపి, డేటా ఉత్పత్తి అయ్యే మరియు నిర్ణయాలు తీసుకోవాల్సిన చోట AI శక్తిని నేరుగా ఉపయోగించడానికి మీకు శక్తిని ఇస్తుంది.

### మీరు నేర్చుకునేది

ఈ కోర్సు మౌలిక సూత్రాల నుండి ప్రొడక్షన్-రెడీ అమలుల వరకు తీసుకువెళ్తుంది, కవర్ చేస్తుంది:
- **ఎడ్జ్ అమలుకు ఆప్టిమైజ్ చేసిన చిన్న భాషా మోడల్స్ (SLMs)**
- **విభిన్న ప్లాట్‌ఫారమ్‌లపై హార్డ్‌వేర్-అవేర్ ఆప్టిమైజేషన్**
- **ప్రైవసీ-ప్రొటెక్టెడ్ రియల్-టైమ్ ఇన్ఫరెన్స్**
...
- **స్థిరమైన ఆపరేషన్లు**: నెట్‌వర్క్ అవుటేజీల సమయంలో ఫంక్షనాలిటీని నిలుపుకోండి
- **నియంత్రణ అనుగుణత**: డేటా సార్వభౌమత్వ అవసరాలను తీర్చండి

### ఎడ్జ్ AI

ఎడ్జ్ AI అనగా AI అల్గోరిథమ్స్ మరియు భాషా మోడల్స్‌ను హార్డ్‌వేర్‌పై స్థానికంగా, డేటా ఉత్పత్తి అయ్యే దగ్గర నడపడం, ఇన్ఫరెన్స్ కోసం క్లౌడ్ వనరులపై ఆధారపడకుండా ఉండటం. ఇది లేటెన్సీని తగ్గిస్తుంది, గోప్యతను పెంచుతుంది, మరియు రియల్-టైమ్ నిర్ణయాలను సాధ్యమవుతుంది.
...
Phi-4, Mistral-7B, మరియు Gemma వంటి SLMs పెద్ద LLMs యొక్క ఆప్టిమైజ్ చేసిన వెర్షన్లు—శిక్షణ లేదా డిస్టిల్లేషన్ చేయబడ్డవి:
- **తక్కువ మెమరీ ఫుట్‌ప్రింట్**: పరిమిత ఎడ్జ్ పరికర మెమరీని సమర్థవంతంగా ఉపయోగించడం
...
- **పర్సనల్ కంప్యూటర్లు**: డెస్క్‌టాప్ మరియు ల్యాప్‌టాప్ అమలులు
...
| [📚 01](../../Module01) | [EdgeAI ప్రాథమికాలు](./Module01/README.md) | క్లౌడ్ vs ఎడ్జ్ AI తులన | EdgeAI ప్రాథమికాలు • వాస్తవ ప్రపంచ కేస్ స్టడీస్ • అమలు మార్గదర్శకం • ఎడ్జ్ డిప్లాయ్‌మెంట్ | ప్రారంభికుడు | 3-4 గంటలు |
...
| [🚀 03](../../Module03) | [SLM డిప్లాయ్‌మెంట్ ప్రాక్టీస్](./Module03/README.md) | స్థానిక & క్లౌడ్ డిప్లాయ్‌మెంట్ | అధునాతన నేర్చుకోవడం • స్థానిక వాతావరణం • క్లౌడ్ డిప్లాయ్‌మెంట్ | మధ్యస్థాయి | 4-5 గంటలు |
| [⚙️ 04](../../Module04) | [మోడల్ ఆప్టిమైజేషన్ టూల్‌కిట్](./Module04/README.md) | క్రాస్-ప్లాట్‌ఫారమ్ ఆప్టిమైజేషన్ | పరిచయం • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • వర్క్‌ఫ్లో సింథసిస్ | మధ్యస్థాయి | 5-6 గంటలు |
| [🔧 05](../../Module05) | [SLMOps ప్రొడక్షన్](./Module05/README.md) | ప్రొడక్షన్ ఆపరేషన్లు | SLMOps పరిచయం • మోడల్ డిస్టిల్లేషన్ • ఫైన్-ట్యూనింగ్ • ప్రొడక్షన్ డిప్లాయ్‌మెంట్ | అధునాతన | 5-6 గంటలు |
| [🤖 06](../../Module06) | [AI ఏజెంట్స్ & ఫంక్షన్ కాలింగ్](./Module06/README.md) | ఏజెంట్ ఫ్రేమ్‌వర్క్స్ & MCP | ఏజెంట్ పరిచయం • ఫంక్షన్ కాలింగ్ • మోడల్ కాంటెక్స్ట్ ప్రోటోకాల్ | అధునాతన | 4-5 గంటలు |
...
| [🏭 08](../../Module08) | [Foundry Local టూల్‌కిట్](./Module08/README.md) | ప్రొడక్షన్-రెడీ నమూనాలు | నమూనా అప్లికేషన్లు (కింద వివరాలు చూడండి) | నిపుణుడు | 8-10 గంటలు |
...
ప్రొడక్షన్-రెడీ అమలులతో సమగ్ర హ్యాండ్స్-ఆన్ వర్క్‌షాప్ మెటీరియల్స్:

- **[వర్క్‌షాప్ గైడ్](./Workshop/Readme.md)** - పూర్తి నేర్చుకునే లక్ష్యాలు, ఫలితాలు, మరియు వనరు నావిగేషన్
- **Python నమూనాలు** (6 సెషన్లు) - ఉత్తమ పద్ధతులు, లోపాల నిర్వహణ, మరియు సమగ్ర డాక్యుమెంటేషన్‌తో నవీకరించబడ్డాయి
- **Jupyter నోట్‌బుక్స్** (8 ఇంటరాక్టివ్) - బెంచ్‌మార్క్స్ మరియు పనితీరు మానిటరింగ్‌తో దశల వారీ ట్యుటోరియల్స్
...
- RAG పైప్లైన్లు నాణ్యత మూల్యాంకనంతో (RAGAS)
...
- **మధ్యస్థాయి పాత్**: మాడ్యూల్స్ 03-04 (9-11 గంటలు)
...
- **బహుళ-ప్లాట్‌ఫారమ్ డిప్లాయ్‌మెంట్**: విండోస్, మొబైల్, ఎంబెడ్డెడ్, మరియు క్లౌడ్-ఎడ్జ్ హైబ్రిడ్ సిస్టమ్స్
...
**సిఫార్సు చేసిన అభ్యాస మార్గం** (మొత్తం 20-30 గంటలు):
...
**పరిశ్రమ విభాగాలు**: మాన్యుఫ్యాక్చరింగ్ 4.0 • హెల్త్‌కేర్ టెక్ • ఆటోనమస్ సిస్టమ్స్ • ఫిన్‌టెక్ • కన్స్యూమర్ ఎలక్ట్రానిక్స్
...
✅ **ప్రగతిశీల అభ్యాసం**: సిద్ధాంతం → ప్రాక్టీస్ → ప్రొడక్షన్ డిప్లాయ్‌మెంట్  
...
✅ **బహుళ-ప్లాట్‌ఫారమ్**: విండోస్, మొబైల్, ఎంబెడ్డెడ్, క్లౌడ్-ఎడ్జ్ హైబ్రిడ్  
✅ **ప్రొడక్షన్ రెడీ**: మానిటరింగ్, స్కేలింగ్, భద్రత, అనుగుణత ఫ్రేమ్‌వర్క్స్

📖 **[అభ్యాస గైడ్ అందుబాటులో ఉంది](STUDY_GUIDE.md)**: సమయ కేటాయింపు మార్గదర్శకత్వం మరియు స్వీయ-మూల్యాంకన సాధనాలతో 20 గంటల నిర్మిత అభ్యాస మార్గం.
